...
public abstract class a0 {
    ...
    public static final Uri f16836a = new Uri.Builder().scheme("content").authority("com.google.android.gms.chimera").build();
    ...
    */
    public static android.content.Intent a(android.content.Context r5, fa.h0 r6) {
        /*
            java.lang.String r0 = "ServiceBindIntentUtils"
            java.lang.String r1 = r6.f16867a
            r2 = 0
            if (r1 != 0) goto L11
        ...
        L11:
            ...
            android.net.Uri r4 = fa.a0.f16836a     // Catch: java.lang.IllegalArgumentException -> L35 android.os.RemoteException -> L37
        ...
        La5:
            ...
            android.content.Intent r5 = new android.content.Intent
            r5.<init>(r1)
            java.lang.String r6 = r6.f16868b
            android.content.Intent r5 = r5.setPackage(r6)
            return r5
        Lb3:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: fa.a(android.content.Context, fa.h0):android.content.Intent");
    }
}
