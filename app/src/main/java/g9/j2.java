...
public final class j2 extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        Bundle bundle = null;
        try {
            bundle = na.a(context).b(128, context.getPackageName()).metaData;
        } catch (PackageManager.NameNotFoundException e) {
            l9.i.d("Failed to load metadata: Package name not found.", e);
        } catch (NullPointerException e8) {
            l9.i.d("Failed to load metadata: Null pointer exception.", e8);
        }
        if (bundle == null) {
            l9.i.c("Metadata was null.");
        } else {
            try {
                ...
                try {
                    ...
                    if (str != null) {
                        if (str.matches("^ca-app-pub-[0-9]{16}~[0-9]{10}$")) {
                            l9.i.a("Publisher provided Google AdMob App ID in manifest: ".concat(str));
                        } else {
                            x.o("\n\n******************************************************************************\n* Invalid application ID. Follow instructions here:                          *\n* https://goo.gle/admob-android-update-manifest                              *\n* to find your app ID.                                                       *\n* Google Ad Manager publishers should follow instructions here:              *\n* https://goo.gle/ad-manager-android-update-manifest.                        *\n******************************************************************************\n\n");
                            return;
                        }
                    } else if (!TextUtils.isEmpty(str2)) {
                        l9.i.a("The Google Mobile Ads SDK is integrated by ".concat(String.valueOf(str2)));
                    } else {
        ...
        if (bundle != null) {
            ...
            if (z3) {
                l9.i.a("com.google.android.gms.ads.flag.OPTIMIZE_INITIALIZATION is enabled");
            }
            if (z9) {
                l9.i.a("com.google.android.gms.ads.flag.OPTIMIZE_AD_LOADING is enabled");
            }
        }
