...
public abstract class y {
    ...
    public static List f19729b;

    /* renamed from: a, reason: collision with root package name */
    public static final HashMap f19728a = new HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final Object f19730c = new Object();

    public static List a(String str) {
        ArrayList arrayList;
        Object obj = f19730c;
        synchronized (obj) {
            HashMap hashMap = f19728a;
            ...
            try {
                synchronized (obj) {
                    try {
                        if (f19729b == null) {
                            f19729b = Arrays.asList(new MediaCodecList(0).getCodecInfos());
                        }
                        arrayList = new ArrayList();
                        for (MediaCodecInfo mediaCodecInfo : f19729b) {
