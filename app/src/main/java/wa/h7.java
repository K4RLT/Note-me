...
public enum h7 implements b {
    ...
    /* JADX INFO: Fake field, exist only in values array */
    MODEL_UPDATE(FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    /* JADX INFO: Fake field, exist only in values array */
    MODEL_UPDATE(FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS),
    /* JADX INFO: Fake field, exist only in values array */
