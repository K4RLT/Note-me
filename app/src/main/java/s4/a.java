...
public final class a implements Interpolator {
    ...
    public final float getInterpolation(float f10) {
        ...
        float f11 = this.f24909a;
        float u9 = g3.a.u(min, f11, f10, f11);
        float[] fArr = f24908b;
        float f12 = fArr[min];
        return g3.a.x(fArr[min + 1], f12, u9, f12);
    }
}
