...
public enum bb implements t {
    ...
    CLOUD_LOGO_CLOSE(93),
    CLOUD_SAFE_SEARCH_CREATE(FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION),
    ...
    CUSTOM_MODEL_RUN(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH),
    CUSTOM_MODEL_CREATE(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT),
    CUSTOM_MODEL_CLOSE(FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION),
    CUSTOM_MODEL_LOAD(FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS),
