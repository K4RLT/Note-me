...
public abstract class f7 {
        ...
        while (it.hasNext()) {
            ...
            if (z3) {
                if (z3) {
                    ...
                    x.n("key must be repeating");
                    return null;
                }
            } else {
                hashMap.remove(d6Var);
                hashMap2.put(d6Var, e);
            }
        }
        return u6Var;
    }
    ...
    */
    ...
    public static Uri h(Context context, q2 q2Var, tr trVar) {
        ...
        int y10 = trVar.y();
        Uri.Builder buildUpon = a(context, q2Var).buildUpon().appendPath("links").build().buildUpon();
        int i = y10 - 1;
        if (i != 0) {
            if (i != 1) {
                str = "public_3p";
