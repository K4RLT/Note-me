...
public final class ll0 implements qn0 {
    ...
    public ll0(Context context, wx wxVar, aq0 aq0Var, a aVar) {
        this.f8057a = 6;
        this.f8059c = context;
        this.f8060d = wxVar;
        this.f8058b = aq0Var;
    ...
    public static final c b(c cVar, float f10) {
        ...
        return c.b((int) Math.ceil(cVar.f18874a / f10), (int) Math.ceil(cVar.f18875b / f10), (int) Math.ceil(cVar.f18876c / f10), (int) Math.ceil(cVar.f18877d / f10));
    }
