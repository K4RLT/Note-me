...
public final /* synthetic */ class ma0 implements Runnable {
    ...
    public ma0(h hVar, n nVar, boolean z3, int i) {
        hVar.getClass();
        nVar.getClass();
        this.f8293x = hVar;
        this.f8294y = nVar;
    ...
    public final void run() {
        ...
        switch (this.f8290u) {
            ...
            default:
                ...
                h hVar = (h) this.f8293x;
                n nVar = (n) this.f8294y;
                if (z9) {
                    int i11 = this.f8292w;
                    hVar.getClass();
                    ...
                    synchronized (hVar.f1746k) {
                        try {
                            if (hVar.f1742f.get(str2) != null) {
                                q.d().a(h.f1737l, "Ignored stopWork. WorkerWrapper " + str2 + " is in foreground");
                            } else {
                                Set set = (Set) hVar.f1744h.get(str2);
                                if (set != null && set.contains(nVar)) {
                                    d2 = h.d(str2, hVar.b(str2), i12);
                                }
                            }
                            d2 = false;
                        } finally {
                ...
                q.d().a(q.f("StopWorkRunnable"), "StopWorkRunnable for " + ((n) this.f8294y).f1759a.f18928a + "; Processor.stopWork = " + d2);
                return;
        }
    }
