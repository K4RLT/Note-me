...
public final class t81 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f11270u) {
            ...
            case 1:
                if (!(((b6.v) this.f11272w).K.f19962u instanceof l6.a)) {
                    try {
                        ((ac.b) this.f11271v).get();
                        a6.q.d().a(b6.v.M, "Starting work for " + ((b6.v) this.f11272w).f1790x.f18946c);
                        b6.v vVar = (b6.v) this.f11272w;
                        vVar.K.m(vVar.f1791y.startWork());
                        return;
                    } catch (Throwable th2) {
                        ((b6.v) this.f11272w).K.l(th2);
                        return;
                    }
                }
                return;
            case 2:
                ba.n nVar = (ba.n) this.f11271v;
                int i10 = ((ba.o) this.f11272w).f3151a;
                synchronized (nVar) {
                    ba.o oVar = (ba.o) nVar.f3149y.get(i10);
                    if (oVar != null) {
                        Log.w("MessengerIpcClient", "Timing out request: " + i10);
                        nVar.f3149y.remove(i10);
                        oVar.b(new ba.p("Timed out waiting for response", (Throwable) null));
                        nVar.c();
                    }
                }
                return;
            case 3:
                ...
                if (!future.isDone() && !future.isCancelled()) {
                    ...
                    future.cancel(true);
                    com.google.android.gms.internal.play_billing.t.h("BillingClient", "Async task is taking too long, cancel it!");
                    if (runnable != null) {
                        runnable.run();
                        return;
                    }
            ...
            case 4:
                try {
                    ((c7.c) ((com.google.android.gms.internal.mlkit_vision_digital_ink.iw) this.f11271v).f14490w).A.u((c7.f) this.f11272w);
                    return;
                } catch (Throwable th3) {
                    com.google.android.gms.internal.play_billing.t.i("BillingClient", "Exception calling onBillingSetupFinished.", th3);
                    return;
                }
            case 5:
                j6.s sVar = (j6.s) this.f11271v;
            ...
            case 8:
                ...
                try {
                    ...
                    k9.a0.k("loadJavascriptEngine > After createJavascriptEngine");
                    k9.a0.k("loadJavascriptEngine > Before setting new engine loaded listener");
                    ...
                    k9.a0.k("loadJavascriptEngine > Before registering GmsgHandler for /jsLoaded");
                    obj.l("/jsLoaded", new wq(drVar, currentTimeMillis, crVar, obj));
                    k6.i iVar = new k6.i(i, (boolean) (objArr2 == true ? 1 : 0));
                    xq xqVar = new xq(drVar, obj, iVar);
                    iVar.f19569v = xqVar;
                    k9.a0.k("loadJavascriptEngine > Before registering GmsgHandler for /requestReload");
                    ...
                    k9.a0.k("loadJavascriptEngine > javascriptPath: ".concat(String.valueOf(str3)));
                    if (str3.endsWith(".js")) {
                        k9.a0.k("loadJavascriptEngine > Before newEngine.loadJavascript");
                        k9.a0.k("loadJavascript on adWebView from path: ".concat(str3));
                        uq.k(new tq(obj, "<!DOCTYPE html><html><head><script src=\"" + str3 + "\"></script></head><body></body></html>", objArr == true ? 1 : 0));
                        k9.a0.k("loadJavascriptEngine > After newEngine.loadJavascript");
                    } else if (str3.startsWith("<html>")) {
                        k9.a0.k("loadJavascriptEngine > Before newEngine.loadHtml");
                        k9.a0.k("loadHtml on adWebView from html");
                        uq.k(new t81((Object) obj, i11, str3));
                        k9.a0.k("loadJavascriptEngine > After newEngine.loadHtml");
                    } else {
                        k9.a0.k("loadJavascriptEngine > Before newEngine.loadHtmlWrapper");
                        k9.a0.k("loadHtmlWrapper on adWebView from path: ".concat(str3));
                        uq.k(new com.google.android.gms.internal.mlkit_vision_digital_ink.ra((Object) obj, i11, str3));
                        k9.a0.k("loadJavascriptEngine > After newEngine.loadHtmlWrapper");
                    }
                    k9.a0.k("loadJavascriptEngine > Before calling ADMOB_UI_HANDLER.postDelayed");
                    k9.f0.f19676l.postDelayed(new zq(drVar, crVar, obj, arrayList, currentTimeMillis, 0), ((Integer) g9.r.e.f17698c.a(sl.e)).intValue());
                    return;
                } catch (Throwable th4) {
                    int i12 = k9.a0.f19634b;
                    l9.i.d("Error creating webview.", th4);
                    nl nlVar = sl.C8;
                    g9.r rVar = g9.r.e;
                    if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
                        ...
                        f9.k.C.f16817h.e("SdkJavascriptFactory.loadJavascriptEngine", th4);
                        crVar.j();
                        return;
                    } else {
                        f9.k.C.f16817h.d("SdkJavascriptFactory.loadJavascriptEngine", th4);
                        crVar.j();
                        return;
                    }
                }
            ...
            case 13:
                ...
                fa.y.d("Adapters must be initialized on the main thread.");
                HashMap hashMap = f9.k.C.f16817h.g().n().f8473c;
                if (!hashMap.isEmpty()) {
                    if (runnable2 != null) {
                        try {
                            runnable2.run();
                            ...
                            l9.i.g("Could not initialize rewarded ads.", th5);
                            return;
                        }
                    }
                    if (((vr) ((AtomicReference) p20Var.f9328w.f9099a.f6874x).get()) != null) {
                        ...
                        for (Map.Entry entry : hashMap2.entrySet()) {
                            ...
                            try {
                                ...
                                if (a10 != null) {
                                    ...
                                    if (!a11) {
                                        try {
                                            if (xrVar.I()) {
                                                try {
                                                    xrVar.R3(new oa.b(p20Var.f9326u), (aj0) a10.f6408c, (List) entry.getValue());
                                ...
                                String o10 = p.a.o(new StringBuilder(String.valueOf(str6).length() + 56), "Failed to initialize rewarded video mediation adapter \"", str6, "\"");
            ...
            case 14:
                ...
                String o11 = p.a.o(new StringBuilder(obj2.length() + 31), "Calling AFMA_updateActiveView(", obj2, ")");
            ...
            case 15:
                try {
                    ...
                    f9.k.C.f16817h.e("EventEmitter.notify", th6);
                    k9.a0.l("Event emitter exception.", th6);
                    return;
                }
            case 16:
            ...
            case gl.zzm /* 21 */:
                ...
                u00 d2 = h00Var3.d();
                g9.w2 w2Var = aq0Var2.f4578a;
                if (w2Var != null && d2 != null) {
                    d2.w4(w2Var);
                }
                if (((Boolean) g9.r.e.f17698c.a(sl.Q1)).booleanValue() && !h00Var3.isAttachedToWindow()) {
                    h00Var3.onPause();
                    h00Var3.k1();
                    return;
                }
                return;
            case 22:
                ((dl0) ((zd1) ((k60) ((p8) this.f11271v).f9423z).f7669d).f13144x).x((g9.y1) this.f11272w);
                return;
            case 23:
                ((fp0) ((p8) this.f11271v).f9423z).f6147d.x((g9.y1) this.f11272w);
                return;
            case 24:
                ...
                try {
                    try {
                        ...
                        try {
                            la.b.e(inputStream, autoCloseOutputStream, false);
            ...
            case 26:
                ...
                at0Var.k(((Long) g9.r.e.f17698c.a(sl.f10692d0)).longValue());
                return;
            case 27:
    ...
    public t81(b6.v vVar, l6.j jVar) {
        this.f11270u = 1;
        this.f11272w = vVar;
        this.f11271v = jVar;
    }
