...
public final class ng extends wg {
    ...
    */
    public final void a() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.ng.a():void");
    }
    ...
    public final String b() {
        try {
            ...
            g9.r rVar = g9.r.e;
            byte[] a10 = fg.a((String) rVar.f17698c.a(nlVar));
            ArrayList arrayList = new ArrayList();
            arrayList.add(certificateFactory.generateCertificate(new ByteArrayInputStream(a10)));
            if (!Build.TYPE.equals("user")) {
                arrayList.add(certificateFactory.generateCertificate(new ByteArrayInputStream(fg.a((String) rVar.f17698c.a(sl.f10868o3)))));
            }
