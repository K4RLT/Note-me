...
public final class s5 implements h, da, go, ct, uq, qa {
                        ...
                        try {
                            ...
                            if (nextEntry != null) {
                                ...
                                if (nextEntry.isDirectory()) {
                                    ...
                                    try {
                                        p8.a(zipInputStream, outputStream2);
                                        outputStream2.close();
                                    } finally {
                                    }
                                }
    ...
    public ya i(da daVar, Executor executor) {
        return ((j6.c) ((s5) this.f14961v).f14961v).p(g2.a(daVar), executor);
    }
    ...
    public s5(j6.c cVar, com.google.android.gms.internal.ads.xe xeVar) {
        this.f14960u = 9;
        this.f14961v = xeVar;
