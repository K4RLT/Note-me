...
public final class ac0 {
    ...
    public ac0(Context context, tb0 tb0Var, of ofVar, a aVar, l lVar, jj jjVar, wx wxVar, aq0 aq0Var, fc0 fc0Var, gd0 gd0Var, ScheduledExecutorService scheduledExecutorService, be0 be0Var, xs0 xs0Var, rh0 rh0Var, vc0 vc0Var, wh0 wh0Var, cq0 cq0Var, zd0 zd0Var, me0 me0Var, b60 b60Var) {
        this.f4439a = context;
        this.f4440b = tb0Var;
        this.f4441c = ofVar;
        this.f4442d = aVar;
    ...
    public static final k2 f(JSONObject jSONObject) {
        if (jSONObject != null) {
            String optString = jSONObject.optString("reason");
            String optString2 = jSONObject.optString("ping_url");
            if (!TextUtils.isEmpty(optString) && !TextUtils.isEmpty(optString2)) {
                return new k2(optString, optString2);
            }
            return null;
        }
        return null;
    ...
    public final b a(JSONArray jSONArray, boolean z3, boolean z9, int i) {
        int i10;
        if (jSONArray != null && jSONArray.length() > 0) {
            ...
            if (((Boolean) r.e.f17698c.a(sl.Q2)).booleanValue()) {
                a.u(k.C.f16819k, this.f4454r, wd0.f(i));
            }
    ...
    public final b b(JSONObject jSONObject, boolean z3, int i) {
        double d2;
        b d02;
        if (jSONObject == null) {
            return v81.f11836v;
        ...
        if (!z3) {
            if (hashMap2 != null) {
                ...
                if (((Boolean) rVar2.f17698c.a(sl.f10682c7)).booleanValue() && optString != null && optString.startsWith("data:")) {
                        ...
                        public final /* synthetic */ Object call() {
                            ...
                            if (indexOf != -1) {
                                if (str2.substring(0, indexOf).endsWith(";base64")) {
                                    ...
                                    x.n("Bad data URL: only image media is supported");
                                    return null;
                                }
                                x.n("Bad data URL: only base64 is supported");
                                return null;
                            }
                            x.n("Bad data URL: no ',' found for base64 data");
                            return null;
                        }
                    }, executor);
                } else {
                    ...
                    yx yxVar = new yx();
                    r.f19717a.u(new q(optString, yxVar));
    ...
    */
    public final com.google.android.gms.internal.ads.b81 d(org.json.JSONObject r12, com.google.android.gms.internal.ads.qp0 r13, com.google.android.gms.internal.ads.sp0 r14, a r15, com.google.android.gms.internal.ads.mw r16) {
        /*
            r11 = this;
        ...
        L54:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.ac0.d(org.json.JSONObject, com.google.android.gms.internal.ads.qp0, com.google.android.gms.internal.ads.sp0, a, com.google.android.gms.internal.ads.mw):com.google.android.gms.internal.ads.b81");
    }

    public final p81 e(String str, boolean z3, b bVar) {
        if (((Boolean) r.e.f17698c.a(sl.R2)).booleanValue()) {
