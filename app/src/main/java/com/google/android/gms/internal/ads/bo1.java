    ...
    */
    ...
    public static Field z(Class cls, String str) {
        try {
            ...
            a.t(sb2, "Field ", str, " for ", name);
            a.k(a.k(sb2, " not found. Known fields are ", arrays), e);
            return null;
        }
    }
    ...
    public final void A(Object obj, int i, Object obj2) {
        ...
        StringBuilder sb2 = new StringBuilder(a.d(i10, 38) + obj3.length());
    ...
    public final void B(Object obj, int i, Object obj2) {
        ...
        int i11 = iArr[i];
        String obj3 = obj2.toString();
        StringBuilder sb2 = new StringBuilder(a.d(i11, 38) + obj3.length());
        sb2.append("Source subfield ");
        sb2.append(i11);
        sb2.append(" is present but null: ");
        sb2.append(obj3);
