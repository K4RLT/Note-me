...
public final /* synthetic */ class ou1 implements Runnable {
    ...
    /* JADX WARN: Type inference failed for: r0v127, types: [x1, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r0v2, types: [n, k1] */
    /* JADX WARN: Type inference failed for: r10v0, types: [z, g0] */
    /*
    ...
    */
    ...
    private final void b() {
        p pVar;
        h hVar = ((a) this.f9239w).f18318u.f1776f;
        ...
        if (pVar != null && pVar.b()) {
            synchronized (((a) this.f9239w).f18320w) {
                ((a) this.f9239w).f18323z.put(y8.a(pVar), pVar);
                a aVar = (a) this.f9239w;
                ((a) this.f9239w).A.put(y8.a(pVar), j.a(aVar.B, pVar, ((b) aVar.f18319v).f20614b, aVar));
            }
        }
    }
    ...
    private final void c() {
        try {
            ...
            synchronized (((k) this.f9239w).f19153v) {
                ((k) this.f9239w).f19154w = 1;
                throw e;
            }
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x005d, code lost:
        ...
        k.f19151z.log(java.util.logging.Level.SEVERE, "Exception while executing runnable " + ((java.lang.Runnable) r10.f9238v), (java.lang.Throwable) r3);
     */
    ...
    */
    public void e() {
        ...
        L2:
            ...
            k r2 = (k) r2     // Catch: java.lang.Throwable -> L58
            ...
            k r0 = (k) r0     // Catch: java.lang.Throwable -> L20
        ...
        L2c:
            ...
            k r4 = (k) r4     // Catch: java.lang.Throwable -> L20
        ...
        L5c:
            r3 = move-exception
            java.util.logging.Logger r4 = k.f19151z     // Catch: java.lang.Throwable -> L5a
    ...
    /* JADX WARN: Type inference failed for: r3v15, types: [c] */
    /* JADX WARN: Type inference failed for: r7v15 */
    /* JADX WARN: Type inference failed for: r7v16 */
    /* JADX WARN: Type inference failed for: r7v6, types: [i, java.lang.Object] */
    ...
    public String toString() {
        ...
        switch (this.f9237u) {
            case 5:
                ...
                if (runnable != null) {
                    return a.k("SequentialExecutorWorker{running=", runnable.toString(), "}");
                }
                ...
                return a.k("SequentialExecutorWorker{state=", str, "}");
            case 20:
