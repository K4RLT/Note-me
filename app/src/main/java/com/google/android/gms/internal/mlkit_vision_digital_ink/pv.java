...
public final class pv implements wv {
    ...
    public final ya b(n4 n4Var) {
        ...
        int i = g2.f14354a;
        return n5.p(a10, new f2(b(), 0, f2Var), ia.f14473u);
    }
    ...
    public final ya c(ls lsVar) {
        ...
        int i10 = g2.f14354a;
        return n5.p(b10, new f2(b(), 0, mvVar), ia.f14473u);
    }
    ...
    public final ya d(av avVar, int i) {
        ...
        if (i <= avVar.f14040u) {
            ...
            if (ordinal != 1) {
                if (ordinal != 2) {
                    u9 = n5.l(new UnsupportedOperationException(a.k("Upgrade to version ", a10.name(), "not supported!")));
                } else {
                    final int i12 = 0;
            ...
            int i13 = g2.f14354a;
            return n5.q(u9, new r0(b(), 3, q0Var), executor);
        }
    ...
    public final ya j() {
        ...
        if (z3) {
            ...
            if (i < i10) {
                ...
                new Exception(a.h("Downgraded file key from ", String.valueOf(q10), " to ", String.valueOf(a10), "."));
                gn.p(context, a10);
