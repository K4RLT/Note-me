...
public final class nl {
    ...
    public nl(int i, Object obj, Object obj2, String str) {
        ...
        this.f8750c = obj;
        this.f8751d = obj2;
        ((ArrayList) r.e.f17696a.f6872v).add(this);
    }
    ...
    public static void h() {
        Object obj = null;
        ((ArrayList) r.e.f17696a.f6873w).add(new nl(1, 4, obj, obj, "gads:sdk_core_constants:experiment_id"));
    }

    public static void i() {
        Object obj = null;
        ((ArrayList) r.e.f17696a.f6874x).add(new nl(1, 4, obj, obj, "gads:sdk_core_constants_service:experiment_id"));
    }
