...
public class d6 {
    ...
    public d6(String str, Class cls, boolean z3, boolean z9) {
        if (!str.isEmpty()) {
            ...
            if ((charAt >= 'a' && charAt <= 'z') || (charAt >= 'A' && charAt <= 'Z')) {
                for (int i = 1; i < str.length(); i++) {
                    ...
                    if ((charAt2 < 'a' || charAt2 > 'z') && ((charAt2 < 'A' || charAt2 > 'Z') && ((charAt2 < '0' || charAt2 > '9') && charAt2 != '_'))) {
                        x.n("identifier must contain only ASCII letters, digits or underscore: ".concat(str));
                        throw null;
                    }
                }
                this.f14184a = str;
            ...
            x.n("identifier must start with an ASCII letter: ".concat(str));
            throw null;
        }
        x.n("identifier must not be empty");
        throw null;
    }
    ...
    public final String toString() {
        ...
        sb2.append(name);
        sb2.append("/");
        return a.l(sb2, this.f14184a, "[", name2, "]");
    }
}
