...
public final class g00 extends WebChromeClient {
    ...
    public final void onCloseWindow(WebView webView) {
        if (!(webView instanceof h00)) {
            int i = a0.f19634b;
            i.f("Tried to close a WebView that wasn't an AdWebView.");
            return;
        }
        d z02 = ((h00) webView).z0();
        if (z02 == null) {
            int i10 = a0.f19634b;
            i.f("Tried to close an AdWebView not associated with an overlay.");
        } else {
            z02.l();
        }
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        a.t(sb2, "JS: ", message, " (", sourceId);
        String j10 = a.j(sb2, ":", lineNumber, ")");
    ...
    public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
        ...
        if (callback != null) {
            f0 f0Var = k.C.f16813c;
            q00 q00Var = this.f6235a;
            if (f0.c(q00Var.getContext(), "android.permission.ACCESS_FINE_LOCATION") || f0.c(q00Var.getContext(), "android.permission.ACCESS_COARSE_LOCATION")) {
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (((Boolean) rVar.f17698c.a(sl.Oe)).booleanValue()) {
                int i = a0.f19634b;
                i.a("AdWebChromeClient.onGeolocationPermissionsShowPrompt()");
            }
        }
    }
    ...
    public final void onHideCustomView() {
        d z02 = this.f6235a.f9696u.z0();
        if (z02 == null) {
            int i = a0.f19634b;
            i.f("Could not get ad overlay when hiding custom view.");
        } else {
            z02.y();
        }
    }
    ...
    public final void onShowCustomView(View view, int i, WebChromeClient.CustomViewCallback customViewCallback) {
        ...
        if (z02 == null) {
            int i10 = a0.f19634b;
            i.f("Could not get ad overlay when showing custom view.");
