...
public final class k4 {
    ...
    public k4(com.google.android.gms.internal.ads.d dVar, String str, Object obj, int i10) {
        ...
        x.n("Must pass a valid SharedPreferences file name or ContentProvider URI");
        throw null;
    }
                    ...
                    if (this.f13802d < i10) {
                        ...
                        if (z3Var != null) {
                            ...
                            if (bVar.b()) {
                                ...
                                d4Var.getClass();
                                if (uri != null) {
                                    r0Var = (r0) d4Var.f13685a.get(uri.toString());
                                } else {
                                    r0Var = null;
                                }
                                if (r0Var != null) {
    ...
    public final Object b(z3 z3Var) {
        ...
        if (!this.f13799a.f5229u) {
            ...
            synchronized (e4.class) {
                try {
                    if (e4.f13726x == null) {
                        if (wa.a(context, "com.google.android.providers.gsf.permission.READ_GSERVICES") == 0) {
