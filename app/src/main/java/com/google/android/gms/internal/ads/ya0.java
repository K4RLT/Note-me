        ...
        if (i != 1) {
                    ...
                    try {
                        if (this.f12833y != null) {
                            ...
                            if (!(z12 instanceof View)) {
                                int i10 = a0.f19634b;
                                i.f("Calling NativeAdViewHolderNonagonDelegate.setClickConfirmingView with wrong wrapped object");
                            }
                            na0 na0Var = this.f12833y;
                            View view = (View) z12;
                            synchronized (na0Var) {
            ...
            synchronized (this) {
                ...
                if (!(z13 instanceof na0)) {
                    int i11 = a0.f19634b;
                    i.f("Not an instance of InternalNativeAd. This is most likely a transient error");
                } else {
                    ...
                    if (na0Var4.f8618p.b()) {
                        ...
                        int i12 = a0.f19634b;
                        i.c("Your account must be enabled to use this feature. Talk to your account manager to request this feature for your account.");
                    }
                }
            }
        }
