...
public final class cj extends b {
    ...
    */
    public cj(android.content.Context r11, android.os.Looper r12, b r13, c r14, int r15) {
        /*
            r10 = this;
            r10.S = r15
            switch(r15) {
        ...
        L27:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.cj.<init>(android.content.Context, android.os.Looper, b, c, int):void");
    }

    public boolean A() {
        int i;
        d[] j10 = j();
        if (((Boolean) r.e.f17698c.a(sl.f11010x2)).booleanValue()) {
            if (j10 != null) {
                i = j10.length;
            } else {
                i = 0;
    ...
    public /* synthetic */ cj(Context context, Looper looper, int i, b bVar, c cVar) {
