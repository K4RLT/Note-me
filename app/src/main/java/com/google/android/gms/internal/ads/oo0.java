...
public final class oo0 {
    ...
    public oo0(Context context, Executor executor, c3 c3Var, y10 y10Var, yk0 yk0Var, al0 al0Var, zp0 zp0Var, i80 i80Var) {
        this.f9172a = context;
        ...
        this.e = al0Var;
        this.f9180k = zp0Var;
        this.f9178h = new x70((ScheduledExecutorService) y10Var.f12713d.zzb(), (a) y10Var.f12716f.zzb(), (be0) y10Var.f12728m.zzb());
        this.i = y10Var.c();
    ...
    public final boolean a(z2 z2Var, String str, an1 an1Var, el0 el0Var) {
        ...
        if (str == null) {
            int i10 = a0.f19634b;
            i.c("Ad unit ID should not be null for banner ad.");
        ...
        if (b10) {
            ...
            if (booleanValue2 && zp0Var.f13227b.E) {
                ...
                if (booleanValue3) {
                    ...
                    l lVar = new l(x70Var, i11, i80Var);
                    int i12 = 16;
            ...
            try {
                ...
                if (hr0Var != null && hr0Var.f6877w.isDone()) {
                    try {
                        ...
                        e = e;
                        e();
                        a0.l("Error occurred while refreshing the ad. Making a new ad request.", e);
                        this.f9182m = true;
                        this.f9178h.E();
                    ...
                    a0.k("Show timer went off but there is an ongoing ad request.");
                    this.f9182m = true;
                } else {
                    a0.k("No ad request was in progress or an ad was cached when show timer went off. Hence requesting a new ad.");
                    this.f9182m = true;
                    this.f9178h.E();
                }
            } catch (Throwable th) {
    ...
    public final boolean d() {
        ...
        return f0.r(view, powerManager, keyguardManager);
    }

    public final void e() {
        this.f9181l = null;
        y1 y1Var = this.f9183n;
        this.f9183n = null;
        if (((Boolean) r.e.f17698c.a(sl.f10891p9)).booleanValue() && y1Var != null) {
            this.f9173b.execute(new a(this, 21, y1Var));
        }
        el0 el0Var = this.f9184o;
        if (el0Var != null) {
            el0Var.mo201zza();
