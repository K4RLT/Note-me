...
public abstract class an1 implements q2 {
    ...
    */
    ...
    public static Object c(int i) {
        ...
        x.n(a.f(i, "must be power of 2 between 2^1 and 2^30: ", new StringBuilder(String.valueOf(i).length() + 41)));
        return null;
    }
        ...
        synchronized (G) {
            try {
                ...
                if (oVar == null || ((oVar.k() && !E.l()) || (z3 && E.k()))) {
                    try {
                        x90 x90Var = F;
                        y.i(x90Var, "the appSetIdClient shouldn't be null");
                        E = x90Var.a();
