...
public final class ur0 implements Runnable {
    ...
    public final synchronized void a(rr0 rr0Var) {
        try {
            if (((Boolean) rm.f10240c.p()).booleanValue()) {
                ...
                this.B = xx.f12654d.schedule(this, ((Integer) g9.r.e.f17698c.a(sl.W9)).intValue(), TimeUnit.MILLISECONDS);
            }
        } catch (Throwable th) {
            throw th;
        }
    ...
    public final synchronized void f(g9.y1 y1Var) {
        if (((Boolean) rm.f10240c.p()).booleanValue()) {
            this.A = y1Var;
        }
    }
