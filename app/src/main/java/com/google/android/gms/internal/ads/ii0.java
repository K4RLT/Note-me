...
public final class ii0 {
    ...
    public final void a(qp0 qp0Var) {
        ...
        if (indexOf >= 0 && indexOf < map.size()) {
            this.f7147f = (g9.e3) list.get(indexOf);
            while (true) {
                indexOf++;
                if (indexOf < list.size()) {
                    g9.e3 e3Var = (g9.e3) list.get(indexOf);
                    e3Var.f17628v = 0L;
                    e3Var.f17629w = null;
                } else {
                    return;
    ...
    public final synchronized void b(qp0 qp0Var, int i) {
        ...
        g9.e3 e3Var = new g9.e3(qp0Var.E, 0L, null, bundle, qp0Var.F, qp0Var.G, qp0Var.H, qp0Var.I);
        try {
            this.f7143a.add(i, e3Var);
        } catch (IndexOutOfBoundsException e) {
            f9.k.C.f16817h.d("AdapterResponseInfoCollector.addAdapterResponseInfoEntryAtLocation", e);
        }
        this.f7144b.put(d2, e3Var);
    }

    public final void c(qp0 qp0Var, long j10, g9.y1 y1Var, boolean z3) {
        String d2 = d(qp0Var);
        Map map = this.f7144b;
        if (map.containsKey(d2)) {
            if (this.e == null) {
            ...
            g9.e3 e3Var = (g9.e3) map.get(d2);
            e3Var.f17628v = j10;
            e3Var.f17629w = y1Var;
            if (((Boolean) g9.r.e.f17698c.a(sl.G7)).booleanValue() && z3) {
                this.f7147f = e3Var;
            }
        }
    }
