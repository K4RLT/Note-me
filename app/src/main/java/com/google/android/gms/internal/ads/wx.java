...
public class wx extends AbstractExecutorService implements AutoCloseable, ExecutorService {
    ...
    public final b f(Runnable runnable) {
    ...
    public final b j(Callable callable) {
    ...
    public String toString() {
        switch (this.f12362u) {
            case 1:
                ...
                return a.l(new StringBuilder(String.valueOf(obj).length() + 1 + valueOf.length() + 1), obj, "[", valueOf, "]");
            default:
