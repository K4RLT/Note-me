    ...
    public final void run() {
        switch (this.f10446u) {
            case 0:
                ...
                ku1Var.p(t3, 1018, new b8.u4(t3, i, j10));
                return;
            default:
                final tc.c cVar = (tc.c) this.f10449x;
                int i10 = this.f10447v;
                final long j11 = this.f10448w;
                synchronized (cVar) {
                    final int i11 = i10 - 1;
                    final ib.o c10 = ((rd.f) cVar.f25699w).c(3 - i11);
                    final ib.o b10 = ((rd.b) cVar.f25700x).b();
                    wa.h8.g(c10, b10).h((ScheduledExecutorService) cVar.f25702z, new ib.a() { // from class: rd.a
                        @Override // ib.a
                        public final Object g(o oVar) {
                            ...
                            int i12 = i11;
                            if (!oVar2.l()) {
                                return h8.d(new bc.i("Failed to auto-fetch config update.", oVar2.i()));
                            }
                            if (!oVar3.l()) {
                                return h8.d(new bc.i("Failed to get activated config for auto-fetch", oVar3.i()));
                            }
                            e eVar = (e) oVar2.j();
                            c cVar3 = (c) oVar3.j();
                            ...
                            JSONObject jSONObject5 = c.a(new JSONObject(jSONObject2.toString())).f24691b;
                            HashMap b11 = cVar3.b();
                            HashMap b12 = cVar5.b();
