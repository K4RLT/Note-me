    ...
    public final ac.b l(Object obj) {
        ...
        switch (this.f5310a) {
            ...
            case 1:
                ...
                f9.a aVar = (f9.a) this.f5312c;
                mw mwVar = (mw) this.f5313d;
                h00 a10 = fc0Var.f6012c.a(g9.c3.a(), null, null);
                fj fjVar = new fj(a10);
                fc0Var.a(a10, aVar, mwVar);
                a10.j0().B = new hx0(17, fjVar);
                a10.loadUrl((String) g9.r.e.f17698c.a(sl.F4));
                return fjVar;
            case 2:
            ...
            case 3:
                ...
                if (((Boolean) qlVar.a(nlVar)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var2, "rendering-webview-creation-start");
                }
                ...
                a11.e1(qp0Var.W);
                if (((Boolean) qlVar.a(nlVar)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var2, "rendering-webview-creation-end");
                }
                yx yxVar2 = new yx();
                ...
                z10 z10Var = new z10(b20Var.f4676c, b20Var.f4677d, hq0Var, new com.google.android.gms.internal.measurement.e4(6, new ni0(aVar2, yxVar2, qp0Var, a11, aq0Var, z3, opVar4, li0Var.f8044h, li0Var.f8045j), a11, false), new b8.u4(qp0Var.f9925a0, 2));
                if (((Boolean) qlVar.a(nlVar)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var2, "rendering-ad-component-creation-end");
                }
            ...
            case 4:
                ...
                nl nlVar2 = sl.M2;
                ql qlVar2 = g9.r.e.f17698c;
                if (((Boolean) qlVar2.a(nlVar2)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var3, "rendering-webview-creation-start");
                }
                Context context = si0Var.f10618b;
                g9.c3 t3 = xy.t(context, qp0Var2.f9960u);
                ...
                if (((Boolean) qlVar2.a(sl.W8)).booleanValue() && qp0Var2.f9936g0) {
                    ...
                    id0Var = new id0(context, a12.U(), (k9.g) si0Var.f10621f.apply(qp0Var2));
                }
                if (((Boolean) qlVar2.a(nlVar2)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var3, "rendering-webview-creation-end");
                }
                ...
                if (((Boolean) qlVar2.a(nlVar2)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var3, "rendering-ad-component-creation-end");
                }
            ...
            case 7:
                ...
                nl nlVar3 = sl.M2;
                ql qlVar3 = g9.r.e.f17698c;
                if (((Boolean) qlVar3.a(nlVar3)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var4, "rendering-webview-creation-start");
                }
                ...
                if (((Boolean) qlVar3.a(nlVar3)).booleanValue()) {
                    zd0Var = zd0Var4;
                    a5.a.u(f9.k.C.f16819k, zd0Var, "rendering-ad-component-creation-end");
                } else {
                    zd0Var = zd0Var4;
                }
                final int i11 = 2;
            ...
            case 8:
                ...
                if (i12 > 1) {
                    ...
                    if (((Boolean) g9.r.e.f17698c.a(sl.N2)).booleanValue()) {
            ...
            default:
                ...
                nl nlVar4 = sl.M2;
                ql qlVar4 = g9.r.e.f17698c;
                if (((Boolean) qlVar4.a(nlVar4)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var5, "rendering-webview-creation-start");
                }
                ...
                yxVar4.b(j20Var);
                if (((Boolean) qlVar4.a(nlVar4)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, zd0Var6, "rendering-ad-component-creation-end");
                }
