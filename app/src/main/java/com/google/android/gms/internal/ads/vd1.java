...
public final class vd1 {
    ...
    public /* synthetic */ vd1(j6.e eVar) {
    ...
    public final Object a(xy xyVar, Class cls) {
        ...
        throw new GeneralSecurityException(p.a.o(new StringBuilder(ud1Var2.length() + FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH), "No PrimitiveConstructor for ", ud1Var2, " available, see https://developers.google.com/tink/faq/registration_errors"));
    }
}
