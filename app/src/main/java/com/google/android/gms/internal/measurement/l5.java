...
public final class l5 extends j {
    ...
    public final n e(n nVar, List list) {
        ...
        switch (this.f13834w) {
            case 0:
                f(3, this.f13784u, list);
                String b10 = ((e) nVar.f18939w).k(nVar, (n) list.get(0)).b();
                n nVar2 = (n) list.get(1);
                e eVar = (e) nVar.f18939w;
                long a10 = (long) a(eVar.k(nVar, nVar2).a().doubleValue());
                ...
                for (String str2 : hashMap.keySet()) {
                    ...
                    hashMap2.put(str2, a(str2, obj, hashMap.get(str2)));
                }
                ((ArrayList) eVar2.f24677x).add(new c(b10, a10, hashMap2));
                return n.f13848h;
            case 1:
                f(2, "getValue", list);
                n k4 = ((e) nVar.f18939w).k(nVar, (n) list.get(0));
                n k10 = ((e) nVar.f18939w).k(nVar, (n) list.get(1));
                String b11 = k4.b();
            ...
            case 3:
                f(3, this.f13784u, list);
                ((e) nVar.f18939w).k(nVar, (n) list.get(0)).b();
                n nVar3 = (n) list.get(1);
                e eVar3 = (e) nVar.f18939w;
                    ...
                    if (k12 instanceof m) {
                        ...
                        if (hashMap4.containsKey("type")) {
                            ...
                            if (hashMap4.containsKey("priority")) {
                                i = j(mVar.o("priority").a().doubleValue());
                            } else {
                                i = AdError.NETWORK_ERROR_CODE;
                            }
                            c cVar = (c) this.f13835x;
                            o oVar = (o) k11;
                            cVar.getClass();
                            if ("create".equals(b12)) {
                                ...
                                x.o(a.k("Unknown callback type: ", b12));
                            }
                        ...
                        x.n("Undefined rule type");
                    } else {
                        x.n("Invalid callback params");
                    }
                } else {
                    x.n("Invalid callback type");
                }
                return null;
            default:
                try {
                    return d(((eb.v0) this.f13835x).call());
