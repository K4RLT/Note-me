    ...
    */
    public static java.lang.String a(com.google.android.gms.internal.ads.wp0 r6) {
        ...
        L45:
            ...
            java.lang.String r2 = a.f(r3, r0, r1)
            goto L5c
        L5b:
            r2 = r0
        L5c:
    ...
    public final b l(Object obj) {
        ...
        if (((Boolean) rVar.f17698c.a(sl.K2)).booleanValue()) {
            a.u(k.C.f16819k, uj0Var.f11652m, "rendering-start");
        }
        String a10 = a(wp0Var);
        ii0 ii0Var = uj0Var.i;
        ...
        if (((Boolean) rVar.f17698c.a(sl.v4)).booleanValue() && !TextUtils.isEmpty(str)) {
            ...
            synchronized (ii0Var) {
                ...
                if (map.containsKey(str)) {
                    e3 e3Var = (e3) map.get(str);
                    List list2 = ii0Var.f7143a;
                    int indexOf = list2.indexOf(e3Var);
                    try {
                        list2.remove(indexOf);
                    } catch (IndexOutOfBoundsException e) {
                        k.C.f16817h.d("AdapterResponseInfoCollector.replaceAdapterResponseInfoEntry", e);
                    }
