...
public final class nf implements lf {
    ...
    public static dg n(Context context, boolean z3) {
        if (Q == null) {
            synchronized (R) {
                try {
                    if (Q == null) {
                        dg a10 = a(context, z3, Y);
                        if (a10.f5429n) {
                            try {
                                if (((Boolean) r.e.f17698c.a(sl.f10774i4)).booleanValue()) {
                            ...
                            if (((Boolean) r.e.f17698c.a(sl.m4)).booleanValue()) {
    ...
    public static final void r(List list) {
        ...
        if (Q != null && (executorService = Q.f5419b) != null && !list.isEmpty()) {
            try {
                executorService.invokeAll(list, ((Long) r.e.f17698c.a(sl.f10934s3)).longValue(), TimeUnit.MILLISECONDS);
    ...
    public final synchronized void a(int i, int i10, int i11) {
        try {
            if (this.f8682u != null) {
                if (((Boolean) r.e.f17698c.a(sl.f10885p3)).booleanValue()) {
                    m();
                } else {
                    this.f8682u.recycle();
                }
    ...
    public final void e(StackTraceElement[] stackTraceElementArr) {
        g9 g9Var;
        if (((Boolean) r.e.f17698c.a(sl.C3)).booleanValue() && (g9Var = this.N) != null) {
    ...
    public final String f(Context context) {
        ...
        x.o("The caller must not be called from the UI thread.");
        return null;
    }

    @Override // com.google.android.gms.internal.ads.lf
    public final void g(View view) {
        if (!((Boolean) r.e.f17698c.a(sl.f10979v3)).booleanValue()) {
            return;
        }
        if (this.P == null) {
            dg dgVar = Q;
            ...
            synchronized (this) {
                try {
                    ...
                    if (this.f8684w > 0) {
                        ...
                        if (z10) {
                            long b10 = b(this.D, displayMetrics);
                            z11.b();
                            ((fe) z11.f4845v).L(b10);
                            long b11 = b(this.I - this.G, this.M);
                            z11.b();
                            ((fe) z11.f4845v).M(b11);
                            long b12 = b(this.J - this.H, this.M);
                            z11.b();
                            ((fe) z11.f4845v).N(b12);
                            long b13 = b(this.G, this.M);
                            z11.b();
                            ((fe) z11.f4845v).Q(b13);
                            long b14 = b(this.H, this.M);
                            z11.b();
                            ((fe) z11.f4845v).R(b14);
                            if (this.L && (motionEvent = this.f8682u) != null) {
                                long b15 = b(((this.G - this.I) + motionEvent.getRawX()) - this.f8682u.getX(), this.M);
                                if (b15 != 0) {
                                    z11.b();
                                    ((fe) z11.f4845v).O(b15);
                                }
                                long b16 = b(((this.H - this.J) + this.f8682u.getRawY()) - this.f8682u.getY(), this.M);
                                if (b16 != 0) {
                                    z11.b();
                                    ((fe) z11.f4845v).P(b16);
                                }
