...
public abstract class sl implements c {
    ...
    public sl(Context context, n nVar, a aVar) {
        na oaVar;
        this.f14976d = nVar;
        this.e = aVar;
        ab b10 = b(Executors.newCachedThreadPool());
        this.f14974b = b10;
    ...
    public final o a(b bVar, b bVar2) {
        ...
        return hVar.f18363a.h(abVar, new e(this, bVar, bVar2, b10));
    }
}