...
public final class f8 {
    ...
    public static Integer a(String str) {
        ...
        try {
            ...
            x21.K("SsaStyle", p.a.o(new StringBuilder(String.valueOf(str).length() + 36), "Failed to parse color expression: '", str, "'"), e);
            return null;
        }
    }
    ...
    public static boolean b(String str) {
        try {
            ...
            x21.K("SsaStyle", p.a.o(new StringBuilder(String.valueOf(str).length() + 33), "Failed to parse boolean value: '", str, "'"), e);
            return false;
        }
    }
}
