...
public class b4 implements r0 {
    ...
    public static void e(Runnable runnable, Executor executor) {
        try {
            ...
            f15385y.logp(Level.SEVERE, "com.android.billingclient.util.concurrent.AbstractResolvableFuture", "executeListener", a.l("RuntimeException while executing runnable ", String.valueOf(runnable), " with executor ", String.valueOf(executor)), (Throwable) e);
        }
    }
