                ...
                if (((Boolean) r.e.f17698c.a(sl.W8)).booleanValue() && qp0Var.f9936g0) {
                    try {
                        ...
                        if (h02 != null) {
                            ...
                            int i10 = a0.f19634b;
                            i.c("getInterscrollerAd should not be null after loadInterscrollerAd loaded ad.");
                    ...
                    try {
                        view = (View) b.z1(((iq0) obj2).f7192a.b());
                    } finally {
                    }
                }
                d20 d20Var = (d20) obj;
    ...
    public final void b(wp0 wp0Var, qp0 qp0Var, gi0 gi0Var) {
        ...
        switch (this.f9128a) {
            case 0:
                ...
                try {
                    iq0Var.f7192a.P2(new b(context), aq0Var.f4581d, jSONObject, asVar);
                    return;
                } finally {
                }
            case 1:
                ...
                if (z9) {
                    ...
                    hVar.f31989d = true;
                    hVar.e = i;
                    t3 = new c3(context2, hVar);
                } else {
                    if (((Boolean) r.e.f17698c.a(sl.W8)).booleanValue() && z3) {
                        h hVar2 = new h(i10, i);
                        hVar2.f31990f = true;
                        hVar2.f31991g = i;
                        t3 = new c3(context2, hVar2);
                    } else {
                ...
                if (((Boolean) r.e.f17698c.a(sl.W8)).booleanValue() && z3) {
                    iq0 iq0Var2 = (iq0) obj;
                    try {
                        iq0Var2.f7192a.S1(new b(context2), c3Var2, aq0Var2.f4581d, jSONObject2.toString(), g9.i(up0Var), (as) iInterface);
                        return;
                    } finally {
                    }
                }
                iq0 iq0Var3 = (iq0) obj;
                try {
                    iq0Var3.f7192a.L0(new b(context2), c3Var2, aq0Var2.f4581d, jSONObject2.toString(), g9.i(up0Var), (as) iInterface);
                    return;
                } finally {
                }
            default:
                ...
                String i11 = g9.i(qp0Var.f9956s);
                Context context3 = this.f9129b;
                as asVar2 = (as) gi0Var.f6408c;
                rn rnVar = aq0Var3.f4585j;
                ArrayList arrayList = aq0Var3.f4584h;
                try {
                    iq0Var4.f7192a.Z1(new b(context3), aq0Var3.f4581d, jSONObject3, i11, asVar2, rnVar, arrayList);
                    return;
                } finally {
                }
        }
