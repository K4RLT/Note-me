...
public final class eh0 extends ph implements wu {
    ...
    public final void A4(ac.b bVar, av avVar, dv dvVar) {
    ...
    public final void X1(dv dvVar, av avVar) {
        Bundle bundle;
        if (((Boolean) g9.r.e.f17698c.a(sl.J2)).booleanValue() && (bundle = dvVar.G) != null) {
    ...
    /* JADX WARN: Type inference failed for: r0v16, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    /* JADX WARN: Type inference failed for: r2v12, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    /* JADX WARN: Type inference failed for: r2v8, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    /* JADX WARN: Type inference failed for: r3v20, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    /* JADX WARN: Type inference failed for: r5v2, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    /* JADX WARN: Type inference failed for: r6v9, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    public final hr0 v4(dv dvVar, int i) {
        ...
        y10Var.getClass();
        b2.f1 f1Var = new b2.f1(y10Var.f12709b, new c7.x(dvVar, i, 6));
        lr a11 = b10.a("google.afma.response.normalize", ch0.f5087d, fp.f6139w);
        Object obj = null;
        if (!((Boolean) dn.f5463a.p()).booleanValue()) {
            String str = dvVar.D;
            if (str != null && !str.isEmpty()) {
                k9.a0.k("Request contained a PoolKey but split request is disabled.");
            }
            B4 = null;
        } else {
            B4 = B4(dvVar.B);
            if (B4 == null) {
                k9.a0.k("Request contained a PoolKey but no matching parameters were found.");
            }
        }
        if (B4 == null) {
        ...
        if (B4 == null) {
            ...
            ?? e81Var3 = new e81(u10, true, false);
            e81Var3.J = new m81(e81Var3, klVar, wxVar3);
            e81Var3.x();
            ?? e81Var4 = new e81(u10, true, false);
    ...
    /* JADX WARN: Type inference failed for: r7v1, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    /* JADX WARN: Type inference failed for: r9v1, types: [com.google.android.gms.internal.ads.n81, ac.b, com.google.android.gms.internal.ads.e81] */
    public final ac.b w4(final dv dvVar, int i) {
        if (!((Boolean) dn.f5463a.p()).booleanValue()) {
    ...
    public final ac.b x4(String str) {
        if (!((Boolean) dn.f5463a.p()).booleanValue()) {
            return ed1.A(new Exception("Split request is disabled."));
        }
    ...
    public final void y0(String str) {
        ...
        if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
            ...
            if (!str2.isEmpty()) {
                mf b10 = mf.b(new a31(','));
                k9.a0.k("AdRequestServiceImpl: Preconnecting");
                ...
                do {
                    ...
                    if (o31Var.hasNext()) {
                        ...
                        hashMap.put("User-Agent", f9.k.C.f16813c.E(context, str));
                        try {
    ...
    public final ac.b y4(dv dvVar, int i) {
        tw twVar = f9.k.C.f16826r;
        l9.a a10 = l9.a.a();
        vr0 vr0Var = this.f5692z;
        Context context = this.f5687u;
