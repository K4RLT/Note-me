...
public final class k10 {
    ...
    public eb.u b() {
        return new eb.u((String) this.f7599b, new eb.t(new Bundle((Bundle) this.e)), (String) this.f7600c, this.f7601d);
    }
    ...
    public String toString() {
        switch (this.f7598a) {
            case 2:
                ...
                StringBuilder q10 = p.a.q("origin=", str, ",name=", str2, ",params=");
                q10.append(valueOf);
                return q10.toString();
            default:
