...
public final class j6 extends m {
    ...
    public final n n(String str, n nVar, ArrayList arrayList) {
        ...
        switch (c10) {
            case 0:
                f(0, "getEventName", arrayList);
                return new p(((c) eVar.f24676w).f13664a);
            case 1:
                f(0, "getTimestamp", arrayList);
                return new g(Double.valueOf(((c) eVar.f24676w).f13665b));
            case 2:
                f(1, "getParamValue", arrayList);
                String b10 = ((e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).b();
                ...
                return d(obj);
            case 3:
                f(0, "getParams", arrayList);
                HashMap hashMap2 = ((c) eVar.f24676w).f13666c;
                m mVar = new m();
                for (String str2 : hashMap2.keySet()) {
                    mVar.g(str2, d(hashMap2.get(str2)));
                }
                return mVar;
            case 4:
                f(2, "setParamValue", arrayList);
                String b11 = ((e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).b();
                n k3 = ((e) nVar.f18939w).k(nVar, (n) arrayList.get(1));
                ...
                hashMap3.put(b11, a(b11, hashMap3.get(b11), d2));
                return k3;
            case 5:
                f(1, "setEventName", arrayList);
                n k4 = ((e) nVar.f18939w).k(nVar, (n) arrayList.get(0));
                if (!n.f13848h.equals(k4) && !i.equals(k4)) {
                    ((c) eVar.f24676w).f13664a = k4.b();
                    return new p(k4.b());
                }
                x.n("Illegal event name");
                return null;
            default:
