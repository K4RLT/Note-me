...
public final class hz implements Runnable {
    ...
    public hz(FirebaseMessaging firebaseMessaging, long j10) {
        this.f6931u = 2;
        this.f6935y = new ThreadPoolExecutor(0, 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new a("firebase-iid-executor"));
                ...
                try {
                    try {
                        ...
                        if (!firebaseMessaging.i.l()) {
                            ...
                            if (!o.j().l(firebaseMessaging.f15599b)) {
                                return;
                            }
                        } else if (o.j().k(firebaseMessaging.f15599b) && !a()) {
                            hg hgVar = new hg(12);
                            hgVar.f6806b = this;
                            hgVar.a();
                            if (!o.j().l(firebaseMessaging.f15599b)) {
    ...
    public hz(n nVar, long j10, Throwable th, Thread thread) {
        this.f6931u = 3;
        this.f6935y = nVar;
        this.f6932v = j10;
        this.f6933w = th;
