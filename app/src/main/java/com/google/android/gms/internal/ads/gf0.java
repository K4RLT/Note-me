...
public final class gf0 implements v60, a80, m70 {
    ...
    public static JSONObject c(g9.y1 y1Var) {
        JSONObject c10;
    ...
    public final void C(z40 z40Var) {
        ...
        if (nf0Var.f()) {
            ...
            if (((Boolean) g9.r.e.f17698c.a(sl.Ia)).booleanValue()) {
    ...
    public final JSONObject b(p60 p60Var) {
        ...
        if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                int i = k9.a0.f19634b;
                l9.i.a("Bidding data: ".concat(valueOf));
        ...
        JSONArray jSONArray = new JSONArray();
        for (g9.e3 e3Var : p60Var.f9416y) {
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("adapterClassName", e3Var.f17627u);
            jSONObject2.put("latencyMillis", e3Var.f17628v);
            if (((Boolean) g9.r.e.f17698c.a(sl.Ca)).booleanValue()) {
                jSONObject2.put("credentials", g9.p.f17688g.f17689a.m(e3Var.f17630x));
            }
            g9.y1 y1Var = e3Var.f17629w;
            if (y1Var == null) {
                c10 = null;
            } else {
                c10 = c(y1Var);
