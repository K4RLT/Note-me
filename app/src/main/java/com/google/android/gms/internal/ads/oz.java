...
public final class oz extends jz implements my {
    ...
    public static final String o(String str) {
        return "cache:".concat(String.valueOf(d.d(str, "MD5")));
    }
        ...
        try {
            ...
            while (true) {
                                ...
                                if (z9) {
                                    ...
                                    if (V1 > 0) {
                                        ...
                                        if (r22 >= 0) {
                                            ...
                                            str4 = str;
                                            try {
                                                d.f20036b.post(new hz(ozVar, str4, o10, (long) r42));
                                                return true;
                                            } catch (Throwable th4) {
                                                th = th4;
                                                r42 = o10;
                ...
                try {
                    ...
                    String l10 = a.l(new StringBuilder(String.valueOf(o10).length() + 34 + String.valueOf(message).length()), "Failed to preload url ", o10, " Exception: ", message);
                    int i12 = a0.f19634b;
                    i.f(l10);
    ...
    public final boolean f(String str, String[] strArr, bz bzVar) {
        ...
        try {
            ...
            this.D = -1L;
            f0.f19676l.postDelayed(new f(21, this), 0L);
            return true;
        } catch (Exception e) {
            String message = e.getMessage();
    ...
    public final void u() {
        int i = a0.f19634b;
        i.f("Precache onRenderedFirstFrame");
    }
    ...
    public final void x(IOException iOException) {
        int i = a0.f19634b;
        i.g("Precache exception", iOException);
        k.C.f16817h.e("VideoStreamExoPlayerCache.onException", iOException);
    }

    @Override // com.google.android.gms.internal.ads.my
    public final void y(Exception exc, String str) {
        int i = a0.f19634b;
        i.g("Precache error", exc);
        k.C.f16817h.e("VideoStreamExoPlayerCache.onError", exc);
    }
}