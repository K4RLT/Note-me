...
public final class s00 extends WebView implements DownloadListener, ViewTreeObserver.OnGlobalLayoutListener, h00 {
    ...
    public s00(d10 d10Var, x0 x0Var, String str, boolean z3, of ofVar, hm hmVar, a aVar, g gVar, l lVar, jj jjVar, qp0 qp0Var, sp0 sp0Var, cq0 cq0Var) {
        super(d10Var);
        sp0 sp0Var2;
        String str2;
        this.F = false;
        ...
        this.D = qp0Var;
        this.E = sp0Var;
        this.m0 = new z(d10Var.f5247a, this, this);
        this.f10437v0 = false;
        setBackgroundColor(0);
        if (((Boolean) r.e.f17698c.a(sl.f10656ad)).booleanValue()) {
        ...
        try {
            ...
            int i = a0.f19634b;
            i.d("Unable to enable Javascript.", e);
        }
        ...
        a(context, new xe(settings, 23, context));
        ...
        this.f10421f0 = null;
        if (a.f3894w == null) {
            a.f3894w = new a(4, false);
        }
        a aVar2 = a.f3894w;
        aVar2.getClass();
        a0.k("Updating user agent.");
    ...
    public final void B0() {
        a0.k("Cannot add text view to inner AdWebView");
    }
    ...
    public final synchronized void D0(String str, String str2) {
        ...
        try {
            try {
                if (!o0()) {
                    String str4 = (String) r.e.f17698c.a(sl.f11024y0);
                    ...
                    try {
                        ...
                        int i = a0.f19634b;
                        i.g("Unable to build MRAID_ENV", e);
                        str3 = null;
                    }
                ...
                int i10 = a0.f19634b;
                i.f("#004 The webview is destroyed. Ignoring action.");
            } catch (Throwable th3) {
                th = th3;
                th = th;
                throw th;
    ...
    public final synchronized void E() {
        try {
            f0.f19676l.post(new r00(this, 1));
        } catch (Throwable th) {
            k.C.f16817h.d("AdWebViewImpl.loadUrlUnsafe", th);
            int i = a0.f19634b;
            i.g("Could not call loadUrl in destroy(). ", th);
        }
    }
    ...
    public final synchronized void F() {
        try {
            ...
            if (qp0Var != null && qp0Var.m0) {
                int i = a0.f19634b;
                i.a("Disabling hardware acceleration on an overlay.");
                synchronized (this) {
                    try {
                        if (!this.Q) {
                            setLayerType(1, null);
            ...
            if (!this.P && !this.L.b()) {
                int i10 = a0.f19634b;
                i.a("Enabling hardware acceleration on an AdView.");
                synchronized (this) {
                    try {
                        if (this.Q) {
                            setLayerType(0, null);
            ...
            int i11 = a0.f19634b;
            i.a("Enabling hardware acceleration on an overlay.");
            synchronized (this) {
                try {
                    if (this.Q) {
                        setLayerType(0, null);
    ...
    public final synchronized void G() {
        if (!this.l0) {
            this.l0 = true;
            k.C.f16817h.f9640k.decrementAndGet();
        }
    }
    ...
    public final void J0(int i, boolean z3, boolean z9) {
        ...
        m mVar = x00Var.f12395z;
        f90 f90Var3 = f90Var;
        c cVar = x00Var.O;
        a aVar3 = q00Var.f9696u.f10440y;
        if (z11) {
            f90Var2 = f90Var3;
        } else {
            f90Var2 = x00Var.E;
    ...
    public final synchronized void U0(u00 u00Var) {
        if (this.U != null) {
            int i = a0.f19634b;
            i.c("Attempt to create multiple AdWebViewVideoControllers.");
        } else {
            this.U = u00Var;
        }
    }
    ...
    @Override // com.google.android.gms.internal.ads.h00
    public final synchronized void Y0(d dVar) {
        this.I = dVar;
    }
    ...
    public final void c(String str, JSONObject jSONObject) {
        ...
        StringBuilder q10 = a.q("(window.AFMA_ReceiveMessage || function() {})('", str, "',", jSONObject.toString(), ");");
        String sb2 = q10.toString();
        int i = a0.f19634b;
        i.a("Dispatching AFMA event: ".concat(sb2));
        w(q10.toString());
    }
    ...
    */
    public final synchronized void destroy() {
        /*
            r5 = this;
            monitor-enter(r5)
            l r0 = r5.f10424i0     // Catch: java.lang.Throwable -> L59
            if (r0 != 0) goto L6
            goto L1b
        L6:
            ...
            k r1 = k.C     // Catch: java.lang.Throwable -> L59
            com.google.android.gms.internal.ads.px r1 = r1.f16817h     // Catch: java.lang.Throwable -> L59
            com.google.android.gms.internal.consent_sdk.c r1 = a()     // Catch: java.lang.Throwable -> L59
            if (r1 == 0) goto L1b
        ...
        L1b:
            z r0 = r5.m0     // Catch: java.lang.Throwable -> L59
            r1 = 0
        ...
        L28:
            ...
            if (r4 == 0) goto L4a
            java.lang.Object r4 = e     // Catch: java.lang.Throwable -> L59
        ...
        L4a:
            d r0 = r5.I     // Catch: java.lang.Throwable -> L59
            if (r0 == 0) goto L5b
            l()     // Catch: java.lang.Throwable -> L59
            d r0 = r5.I     // Catch: java.lang.Throwable -> L59
            f0()     // Catch: java.lang.Throwable -> L59
        ...
        L5b:
            ...
            return
        L74:
            k r0 = k.C     // Catch: java.lang.Throwable -> L59
            ...
            r r1 = r.e     // Catch: java.lang.Throwable -> L59
            com.google.android.gms.internal.ads.ql r1 = r1.f17698c     // Catch: java.lang.Throwable -> L59
            java.lang.Object r0 = a(r0)     // Catch: java.lang.Throwable -> L59
            ...
            a0.k(r0)     // Catch: java.lang.Throwable -> L59
    ...
    public final synchronized void evaluateJavascript(String str, ValueCallback valueCallback) {
        if (o0()) {
            int i = a0.f19634b;
            i.i(null, "#004 The webview is destroyed. Ignoring action.");
        ...
        if (((Boolean) r.e.f17698c.a(sl.f10782ic)).booleanValue() && Looper.getMainLooper().getThread() != Thread.currentThread()) {
    ...
    public final void l1() {
        ...
        hashMap.put("device_volume", String.valueOf(a.b(getContext())));
        b("volume", hashMap);
    }
    ...
    public final synchronized void loadUrl(String str) {
        if (!o0()) {
            try {
                f0.f19676l.post(new a(this, 10, str));
                return;
            } catch (Throwable th) {
                k.C.f16817h.d("AdWebViewImpl.loadUrl", th);
                int i = a0.f19634b;
                i.g("Could not call loadUrl. ", th);
                return;
            }
        }
        int i10 = a0.f19634b;
    ...
    public final synchronized void m1(boolean z3) {
        ...
        try {
            ...
            F();
            if (z3 != z9) {
                if (((Boolean) r.e.f17698c.a(sl.f11040z0)).booleanValue()) {
                    if (!this.L.b()) {
                    }
                }
                if (true != z3) {
                ...
                try {
                    ...
                    int i = a0.f19634b;
                    i.d("Error occurred while dispatching state change.", e);
                }
            }
        } catch (Throwable th) {
            throw th;
    ...
    */
    public final void onDetachedFromWindow() {
        /*
            ...
            r1 = 0
            if (r0 != 0) goto L38
            z r0 = r4.m0     // Catch: java.lang.Throwable -> L36
        ...
        L13:
            ...
            if (r3 == 0) goto L38
            java.lang.Object r3 = e     // Catch: java.lang.Throwable -> L36
    ...
    public final void onDownloadStart(String str, String str2, String str3, String str4, long j10) {
        try {
            ...
            if (((Boolean) r.e.f17698c.a(sl.f11003wc)).booleanValue() && getContext() != null) {
                intent.setPackage(getContext().getPackageName());
            }
            f0 f0Var = k.C.f16813c;
            f0.s(getContext(), intent);
        } catch (ActivityNotFoundException e) {
            String l10 = a.l(new StringBuilder(String.valueOf(str).length() + 51 + String.valueOf(str4).length()), "Couldn't find an Activity to view url/mimetype: ", str, " / ", str4);
            int i = a0.f19634b;
            i.a(l10);
            k.C.f16817h.d("AdWebViewImpl.onDownloadStart: ".concat(String.valueOf(str)), e);
        }
    }
    ...
    */
    ...
    public final void onPause() {
        if (!o0()) {
            try {
                super.onPause();
                if (((Boolean) r.e.f17698c.a(sl.ae)).booleanValue() && ee.a("MUTE_AUDIO")) {
                    int i = a0.f19634b;
                    i.a("Muting webview");
                    int i10 = b.f30913a;
                    if (k.f31930h.b()) {
                        ((WebViewProviderBoundaryInterface) b.b(this).f25315v).setAudioMuted(true);
                        return;
                    }
                    throw k.a();
                }
                ...
                int i11 = a0.f19634b;
                i.d("Could not pause webview.", e);
                if (((Boolean) r.e.f17698c.a(sl.f10704de)).booleanValue()) {
                    k.C.f16817h.d("AdWebViewImpl.onPause", e);
                }
            }
        }
    }
    ...
    public final void onResume() {
        if (!o0()) {
            try {
                ...
                if (((Boolean) r.e.f17698c.a(sl.ae)).booleanValue() && ee.a("MUTE_AUDIO")) {
                    int i = a0.f19634b;
                    i.a("Unmuting webview");
                    int i10 = b.f30913a;
                    if (k.f31930h.b()) {
                        ((WebViewProviderBoundaryInterface) b.b(this).f25315v).setAudioMuted(false);
                        return;
                    }
                    throw k.a();
                }
                ...
                int i11 = a0.f19634b;
                i.d("Could not resume webview.", e);
                if (((Boolean) r.e.f17698c.a(sl.f10704de)).booleanValue()) {
                    k.C.f16817h.d("AdWebViewImpl.onResume", e);
                }
            }
        }
    }
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L3d:
            ...
            if (r0 == 0) goto L48
            s(r8)     // Catch: java.lang.Throwable -> L46
            goto L48
        L46:
            r8 = move-exception
            goto L4a
    ...
    public final void p(String str, String str2) {
        w(a.l(new StringBuilder(a.v(str, 1, String.valueOf(str2).length()) + 2), str, "(", str2, ");"));
    }
    ...
    public final synchronized void r() {
        a0.k("Destroying WebView!");
        G();
        f0.f19676l.post(new r00(this, 0));
    }
    ...
    public final synchronized void s() {
        ...
        if (hc0Var != null) {
            f0.f19676l.post(new e40(8, hc0Var));
        }
    }
    ...
    public final void stopLoading() {
        ...
        try {
            ...
            int i = a0.f19634b;
            i.d("Could not stop loading webview.", e);
        }
    }
    ...
    */
    public final void w(java.lang.String r4) {
        /*
            ...
            if (r0 != 0) goto L30
            monitor-enter(r3)
            k r0 = k.C     // Catch: java.lang.Throwable -> L22
        ...
        L46:
            ...
            goto L51
        L48:
            int r4 = a0.f19634b     // Catch: java.lang.Throwable -> L46
            java.lang.String r4 = "#004 The webview is destroyed. Ignoring action."
            i.f(r4)     // Catch: java.lang.Throwable -> L46
            monitor-exit(r3)
            goto L6f
        L51:
        ...
        L65:
            ...
            goto L70
        L67:
            int r4 = a0.f19634b     // Catch: java.lang.Throwable -> L65
            java.lang.String r4 = "#004 The webview is destroyed. Ignoring action."
            i.f(r4)     // Catch: java.lang.Throwable -> L65
            monitor-exit(r3)
        L6f:
            return
        L70:
    ...
    @Override // com.google.android.gms.internal.ads.h00
    public final synchronized void w0(d dVar) {
        this.f10426k0 = dVar;
    }
    ...
    public final synchronized void y0(int i, boolean z3) {
        ...
        if (dVar != null) {
            ...
            if (z3) {
                ...
                if (((Boolean) r.e.f17698c.a(sl.f10900q1)).booleanValue() && Build.VERSION.SDK_INT >= 31 && window != null) {
    ...
    @Override // com.google.android.gms.internal.ads.h00
    public final synchronized d z0() {
        return this.I;
    }
}
