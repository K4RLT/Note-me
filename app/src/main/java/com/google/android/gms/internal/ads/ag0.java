...
public final class ag0 {
    ...
    public ag0(Context context, a aVar, wx wxVar) {
        this.f4492a = context;
        this.f4493b = aVar;
        this.f4494c = wxVar;
    }
    ...
    public static final String c(String str) {
        String str2 = new String(Base64.decode((String) r.e.f17698c.a(sl.Uf), 10), StandardCharsets.UTF_8);
    ...
    public final String b() {
        ...
        if (aVar.f20032x) {
            ...
            try {
                str = (String) new JSONObject(c((String) r.e.f17698c.a(sl.Sf))).get(Integer.toString(aVar.f20031w));
            } catch (ClassCastException | IllegalArgumentException | NullPointerException | JSONException e) {
                if (((Boolean) r.e.f17698c.a(sl.Rf)).booleanValue()) {
                    k.C.f16817h.d("SdkIE", e);
                }
                str = null;
            }
        }
        if (!TextUtils.isEmpty(str)) {
            try {
                str2 = c((String) r.e.f17698c.a(sl.Tf));
            } catch (IllegalArgumentException e8) {
                if (((Boolean) r.e.f17698c.a(sl.Rf)).booleanValue()) {
                    k.C.f16817h.d("SdkIE", e8);
                }
            }
