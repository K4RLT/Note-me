...
public final class c {
    ...
    public static void g(com.google.android.gms.internal.mlkit_vision_digital_ink.c r28, com.google.android.gms.internal.mlkit_vision_digital_ink.ox r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_vision_digital_ink.g(com.google.android.gms.internal.mlkit_vision_digital_ink.c, com.google.android.gms.internal.mlkit_vision_digital_ink.ox):void");
    }
    ...
    public final synchronized HttpURLConnection c(String str, String str2) {
        ...
        if (u6.a(this.f14130a, "android.permission.INTERNET") == 0) {
    ...
    public final synchronized boolean k(nx nxVar) {
        ...
        try {
            ...
            if (u6.a(this.f14130a, "android.permission.ACCESS_NETWORK_STATE") == 0) {
                z3 = true;
            } else {
                z3 = false;
            }
    ...
    public final void m(File file, String str, s5 s5Var, com.google.android.gms.internal.ads.l3 l3Var, File file2) {
        ...
        if (l3Var == null) {
            ...
            int i = l3Var.f7926c;
            Log.d("DownloadCompleteHandler", a.l("Failed to download file ", name, " due to ", gn.c(i)), th2);
            int i10 = jr.f14529v;
