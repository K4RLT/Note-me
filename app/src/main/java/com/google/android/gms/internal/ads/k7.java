                ...
                while (true) {
                    ...
                    if (i19 < K3) {
                        ...
                        for (int i27 = 0; i27 < Y05; i27++) {
                            if (iVar.Y0(16) != 0) {
                                throw a(null, "placeholder of time domain transforms not zeroed out");
                            }
                        }
                        int i28 = 1;
                        int Y06 = iVar.Y0(6) + 1;
                            ...
                            if (i29 < Y06) {
                                ...
                                if (Y07 != 0) {
                                    if (Y07 == i28) {
                                        ...
                                        StringBuilder sb4 = new StringBuilder(a.d(Y07, 41));
                                ...
                                while (i42 < Y013) {
                                    if (iVar.Y0(16) <= 2) {
                                        ...
                                        throw a(null, "residueType greater than 2 is not decodable");
                                    }
                                }
                                ...
                                for (int i47 = 0; i47 < Y016; i47++) {
                                    int Y017 = iVar.Y0(16);
                                    if (Y017 != 0) {
                                        StringBuilder sb5 = new StringBuilder(a.d(Y017, 41));
                                        ...
                                        if (iVar.Y0(2) == 0) {
                                            ...
                                            throw a(null, "to reserved bits must be zero after mapping coupling steps");
                                        }
                                    }
                                }
                                ...
                                if (iVar.V0()) {
                                    ...
                                    throw a(null, "framing bit after modes not set as expected");
                                }
                            }
                        }
                    }
