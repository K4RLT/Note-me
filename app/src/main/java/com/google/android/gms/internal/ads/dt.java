...
public final class dt extends ph implements zs {
    ...
    public static final Bundle w4(String str) {
        i.f("Server parameters: ".concat(String.valueOf(str)));
        try {
    ...
    public static final boolean x4(z2 z2Var) {
        if (!z2Var.f17726z) {
    ...
    public static final String y4(z2 z2Var, String str) {
        String str2 = z2Var.O;
        try {
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [d, y] */
    @Override // com.google.android.gms.internal.ads.zs
    public final void C0(String str, String str2, z2 z2Var, a aVar, xs xsVar, as asVar) {
        try {
            try {
                ...
                int i10 = z2Var.N;
                y4(z2Var, str2);
                rtbAdapter.loadRtbRewardedInterstitialAd(new d(context, str, w42, i, i10, this.f5493y), zd1Var);
            } catch (Throwable th) {
                th = th;
                Throwable th2 = th;
                i.d("Adapter failed to render rewarded interstitial ad.", th2);
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [d, y] */
    @Override // com.google.android.gms.internal.ads.zs
    public final void F2(String str, String str2, z2 z2Var, a aVar, xs xsVar, as asVar) {
        try {
            try {
                zd1 zd1Var = new zd1(this, xsVar, asVar, 8, false);
                RtbAdapter rtbAdapter = this.f5489u;
                ...
                int i10 = z2Var.N;
                y4(z2Var, str2);
                rtbAdapter.loadRtbRewardedAd(new d(context, str, w42, i, i10, this.f5493y), zd1Var);
            } catch (Throwable th) {
                th = th;
                Throwable th2 = th;
                i.d("Adapter failed to render rewarded ad.", th2);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x0035, code lost:
        ...
        if (((java.lang.Boolean) r.e.f17698c.a(com.google.android.gms.internal.ads.sl.f10861nd)).booleanValue() != false) goto L29;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x0066, code lost:
        ...
        new java.util.ArrayList().add(new o(r7));
        r7 = (android.content.Context) b.z1(r4);
        new h(r8.f17589u, r8.f17593y, r8.f17590v);
        r9.collectSignals(new a(r7), r6);
     */
    ...
    */
    public final void N0(a r4, java.lang.String r5, android.os.Bundle r6, android.os.Bundle r7, c3 r8, com.google.android.gms.internal.ads.bt r9) {
        /*
            r3 = this;
            ...
            o r0 = new o     // Catch: java.lang.Throwable -> L38
        ...
        L1d:
            ...
            r r1 = r.e     // Catch: java.lang.Throwable -> L38
            com.google.android.gms.internal.ads.ql r1 = r1.f17698c     // Catch: java.lang.Throwable -> L38
            java.lang.Object r5 = a(r5)     // Catch: java.lang.Throwable -> L38
        ...
        L66:
            ...
            a r5 = new a     // Catch: java.lang.Throwable -> L38
            java.lang.Object r7 = b.z1(r4)     // Catch: java.lang.Throwable -> L38
            ...
            h r2 = new h     // Catch: java.lang.Throwable -> L38
        ...
        L93:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.dt.N0(a, java.lang.String, android.os.Bundle, android.os.Bundle, c3, com.google.android.gms.internal.ads.bt):void");
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v1, types: [d, r] */
    @Override // com.google.android.gms.internal.ads.zs
    public final void Q2(String str, String str2, z2 z2Var, a aVar, ts tsVar, as asVar) {
        try {
            try {
                ...
                int i10 = z2Var.N;
                y4(z2Var, str2);
                rtbAdapter.loadRtbInterstitialAd(new d(context, str, w42, i, i10, this.f5493y), zd1Var);
            } catch (Throwable th) {
                th = th;
                Throwable th2 = th;
                i.d("Adapter failed to render interstitial ad.", th2);
    ...
    @Override // com.google.android.gms.internal.ads.zs
    public final void U0(String str, String str2, z2 z2Var, a aVar, rs rsVar, as asVar, c3 c3Var) {
        try {
            e eVar = new e(this, rsVar, asVar);
            RtbAdapter rtbAdapter = this.f5489u;
            Context context = (Context) b.z1(aVar);
            Bundle w42 = w4(str2);
            v4(z2Var);
            ...
            int i10 = z2Var.N;
            y4(z2Var, str2);
            rtbAdapter.loadRtbBannerAd(new m(context, str, w42, i, i10, new h(c3Var.f17589u, c3Var.f17593y, c3Var.f17590v), this.f5493y), eVar);
        } catch (Throwable th) {
            i.d("Adapter failed to render banner ad.", th);
    ...
    @Override // com.google.android.gms.internal.ads.zs
    public final ft b() {
        r versionInfo = this.f5489u.getVersionInfo();
    ...
    @Override // com.google.android.gms.internal.ads.zs
    public final ft e() {
        r sDKVersionInfo = this.f5489u.getSDKVersionInfo();
        return new ft(sDKVersionInfo.f32000a, sDKVersionInfo.f32001b, sDKVersionInfo.f32002c);
    }

    @Override // com.google.android.gms.internal.ads.zs
    public final void j4(String str, String str2, z2 z2Var, b bVar, hj0 hj0Var, as asVar) {
        p4(str, str2, z2Var, bVar, hj0Var, asVar, null);
    }

    @Override // com.google.android.gms.internal.ads.zs
    public final void m2(String str, String str2, z2 z2Var, a aVar, rs rsVar, as asVar, c3 c3Var) {
        try {
            RtbAdapter rtbAdapter = this.f5489u;
            w4(str2);
            v4(z2Var);
            x4(z2Var);
            y4(z2Var, str2);
            new h(c3Var.f17589u, c3Var.f17593y, c3Var.f17590v);
            try {
                rsVar.r(new y1(7, rtbAdapter.getClass().getSimpleName().concat(" does not support interscroller ads."), "com.google.android.gms.ads", null, null));
            } catch (RemoteException e) {
                i.d("", e);
            }
        } catch (Throwable th) {
            i.d("Adapter failed to render interscroller ad.", th);
    ...
    @Override // com.google.android.gms.internal.ads.zs
    public final void p4(String str, String str2, z2 z2Var, a aVar, vs vsVar, as asVar, rn rnVar) {
        RtbAdapter rtbAdapter = this.f5489u;
        try {
            l lVar = new l(this, vsVar, asVar);
            Context context = (Context) b.z1(aVar);
            Bundle w42 = w4(str2);
            v4(z2Var);
            x4(z2Var);
            ...
            int i10 = z2Var.N;
            y4(z2Var, str2);
            rtbAdapter.loadRtbNativeAdMapper(new u(context, str, w42, i, i10, this.f5493y, rnVar), lVar);
        } catch (Throwable th) {
            i.d("Adapter failed to render native ad.", th);
            xy.w(aVar, th, "adapter.loadRtbNativeAdMapper");
            String message = th.getMessage();
            if (!TextUtils.isEmpty(message) && message.equals("Method is not found")) {
                try {
                    s sVar = new s(this, vsVar, asVar);
                    Context context2 = (Context) b.z1(aVar);
                    Bundle w43 = w4(str2);
                    v4(z2Var);
                    x4(z2Var);
                    int i11 = z2Var.A;
                    int i12 = z2Var.N;
                    y4(z2Var, str2);
                    rtbAdapter.loadRtbNativeAd(new u(context2, str, w43, i11, i12, this.f5493y, rnVar), sVar);
                    return;
                } catch (Throwable th2) {
                    i.d("Adapter failed to render native ad.", th2);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v1, types: [d, j] */
    @Override // com.google.android.gms.internal.ads.zs
    public final void q3(String str, String str2, z2 z2Var, a aVar, ps psVar, as asVar) {
        try {
            ...
            int i10 = z2Var.N;
            y4(z2Var, str2);
            rtbAdapter.loadRtbAppOpenAd(new d(context, str, w42, i, i10, this.f5493y), hq0Var);
        } catch (Throwable th) {
            i.d("Adapter failed to render app open ad.", th);
                            ...
                            if (i != 11) {
                                switch (i) {
                                    ...
                                    case 16:
                                        ...
                                        z2 z2Var3 = (z2) qh.b(parcel, z2.CREATOR);
                                    ...
                                    case 18:
                                        ...
                                        z2 z2Var4 = (z2) qh.b(parcel, z2.CREATOR);
                                    ...
                                    case 20:
                                        ...
                                        z2 z2Var5 = (z2) qh.b(parcel, z2.CREATOR);
                                    ...
                                    case gl.zzm /* 21 */:
                                        ...
                                        z2 z2Var6 = (z2) qh.b(parcel, z2.CREATOR);
                                    ...
                                    case 22:
                                        ...
                                        z2 z2Var7 = (z2) qh.b(parcel, z2.CREATOR);
                                    ...
                                    case 23:
                                        ...
                                        z2 z2Var8 = (z2) qh.b(parcel, z2.CREATOR);
    ...
    public final Bundle v4(z2 z2Var) {
        Bundle bundle;
