...
public abstract class dk1 {
    ...
    public static aj1 g(int i) {
        ...
        if (i10 != 2) {
            if (i10 != 3) {
                ...
                if (i != 1) {
                    throw new GeneralSecurityException(a5.a.f(i10, "Unable to parse EllipticCurveType: ", new StringBuilder(String.valueOf(i10).length() + 35)));
                }
                ln1.a();
                throw null;
            }
    ...
    public static w91 h(int i) {
        ...
        if (i10 != 1) {
            ...
            if (i != 1) {
                throw new GeneralSecurityException(a5.a.f(i10, "Unable to parse EcdsaSignatureEncoding: ", new StringBuilder(String.valueOf(i10).length() + 40)));
            }
            ln1.a();
            throw null;
        }
