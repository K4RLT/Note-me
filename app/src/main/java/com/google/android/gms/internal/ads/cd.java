    ...
    static {
        ...
        while (a10.hasNext()) {
            ...
            if (((Long) entry2.getValue()).longValue() > -1 || ((Long) entry2.getValue()).longValue() < -82) {
                throw new ab.b(nc.a("DkWkogARIjm8VAqEzyEdNWdUqAjIW8EtmA==").concat(String.valueOf(entry2.getValue())), 2);
            }
        }
        ...
        while (a11.hasNext()) {
            ...
            if (!hashMap.containsKey(l10)) {
                ...
                String a12 = nc.a("H16u7wATM3S4Tl6egTYIeX5f+xfdXtsmmA==");
                String a13 = nc.a("cQk=");
                String a14 = nc.a("a0ivq0U=");
                sb2.append(a12);
