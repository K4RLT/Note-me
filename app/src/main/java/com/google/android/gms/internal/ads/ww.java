...
public final class ww {
    ...
    public static final boolean g(Context context) {
        ...
        if (!((Boolean) qlVar.a(nlVar)).booleanValue() || d.a(context, ModuleDescriptor.MODULE_ID) < ((Integer) qlVar2.a(sl.U0)).intValue()) {
            return false;
        }
            ...
            if (!((Boolean) rVar.f17698c.a(sl.W0)).booleanValue()) {
                ...
                if (atomicInteger.get() == -1) {
                    ...
                    if (fVar.c(context, 12451000) == 0 || ((c10 = fVar.c(context, 12451000)) != 0 && c10 != 2)) {
                        ...
                        int i = a0.f19634b;
                        i.f("Google Play Service is out of date, the Google Mobile Ads SDK will not integrate with Firebase. Admob/Firebase integration requires updated Google Play Service.");
                        atomicInteger.set(0);
                    }
                }
                if (atomicInteger.get() == 1) {
    ...
    public final void h(Context context, String str, String str2, Bundle bundle) {
        if (a(context)) {
            ...
            try {
                ...
                int i = a0.f19634b;
                i.d("Invalid event ID: ".concat(valueOf), e);
            }
            if ("_ac".equals(str)) {
                bundle2.putInt("_r", 1);
            }
    ...
    public final void l(String str, boolean z3) {
        ...
        if (!atomicBoolean.get()) {
            String o10 = a.o(new StringBuilder(str.length() + 30), "Invoke Firebase method ", str, " error.");
            int i = a0.f19634b;
            i.f(o10);
            if (z3) {
                i.f("The Google Mobile Ads SDK will not integrate with Firebase. Admob/Firebase integration requires the latest Firebase SDK jar, but Firebase SDK is either missing or out of date");
