    ...
    public final ya l(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                int i11 = g2.f14354a;
                return n5.q(g8, new r0(q1.b(), i10, ruVar), tuVar.f15033h);
            case 1:
                f9 g10 = tuVar.g(tuVar.f15029c.f(fsVar));
                ru ruVar2 = new ru(tuVar, hxVar, 5);
                int i12 = g2.f14354a;
                return n5.q(g10, new r0(q1.b(), i10, ruVar2), tuVar.f15033h);
            default:
                f9 g11 = tuVar.g(tuVar.f15029c.a(fsVar));
                ru ruVar3 = new ru(tuVar, hxVar, 0);
                int i13 = g2.f14354a;
                return n5.q(g11, new r0(q1.b(), i10, ruVar3), tuVar.f15033h);
        }
    }
}
