...
public final class lb {
    ...
    public final synchronized void b(String str) {
        ...
        if (j10 > 0) {
            ...
            b("(%-4d ms) %s", Long.valueOf(j10), str);
            ...
            while (i < size) {
                ...
                b("(+%-4d) [%2d] %s", Long.valueOf(j12 - j11), Long.valueOf(kbVar.f7703b), kbVar.f7702a);
                j11 = j12;
            }
        }
    }
    ...
    public final void finalize() {
        if (!this.f8002b) {
            ...
            c("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
        }
    }
}
