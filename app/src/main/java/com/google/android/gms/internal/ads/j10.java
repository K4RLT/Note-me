...
public final class j10 implements lf {
    ...
    public j10(Context context, a aVar) {
        int i;
        boolean z3;
        jk0 jk0Var;
        this.f7280u = context;
    ...
    public final void a(int i, int i10, int i11) {
        ...
        long j10 = i11;
        MotionEvent obtain = MotionEvent.obtain(0L, j10, 0, d.b(context, i), d.p(context.getResources().getDisplayMetrics(), i10), 0);
        jk0 jk0Var = this.f7281v;
        jk0Var.L(obtain);
        obtain.recycle();
        MotionEvent obtain2 = MotionEvent.obtain(0L, j10, 2, d.p(context.getResources().getDisplayMetrics(), i), d.p(context.getResources().getDisplayMetrics(), i10), 0);
        jk0Var.L(obtain2);
        obtain2.recycle();
        MotionEvent obtain3 = MotionEvent.obtain(0L, j10, 1, d.p(context.getResources().getDisplayMetrics(), i), d.p(context.getResources().getDisplayMetrics(), i10), 0);
        jk0Var.L(obtain3);
        obtain3.recycle();
    }
