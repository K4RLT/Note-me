...
public final class xr0 extends dn1 {
    private static final xr0 zzaL;
    private static volatile fo1 zzaM;
    private int zzC;
    private int zzE;
    private int zzF;
    private int zzI;
    ...
    public final void J(AbstractCollection abstractCollection) {
        ...
        if (!((dm1) jn1Var).f5462u) {
            this.zzH = dn1.k(jn1Var);
        }
        cm1.e(abstractCollection, this.zzH);
    }
    ...
    public final /* synthetic */ void V(hp1 hp1Var) {
        this.zzay = hp1Var;
        this.zza |= 256;
    }
