            ...
            default:
                ...
                if (cookieManager != null) {
                    if (((String) hashMap.get("clear")) != null) {
                        String str2 = (String) g9.r.e.f17698c.a(sl.f10978v1);
                        String cookie = cookieManager.getCookie(str2);
                        if (cookie != null) {
                            List n10 = mf.b(new a31(';')).n(cookie);
                            for (int i = 0; i < n10.size(); i++) {
                                ...
                                if (o31Var.hasNext()) {
                                    cookieManager.setCookie(str2, String.valueOf((String) o31Var.next()).concat(String.valueOf((String) g9.r.e.f17698c.a(sl.f10740g1))));
                                } else {
                    ...
                    if (!TextUtils.isEmpty(str4)) {
                        cookieManager.setCookie((String) g9.r.e.f17698c.a(sl.f10978v1), str4);
                        return;
                    }
                    return;
                }
