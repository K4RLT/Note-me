    ...
    public v91 c(zd1 zd1Var) {
        ...
        switch (this.f6009u) {
            case 4:
                ...
                q.x.n("Wrong type URL in call to AesCtrHmacAeadProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var.z())));
                return null;
            case 8:
                nd1 nd1Var2 = pb1.f9457a;
                ...
                q.x.n("Wrong type URL in call to AesEaxProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var2.z())));
                return null;
            case 12:
                nd1 nd1Var3 = sb1.f10585a;
                ...
                q.x.n("Wrong type URL in call to AesGcmProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var3.z())));
                return null;
            case 16:
                nd1 nd1Var4 = ub1.f11609a;
                ...
                q.x.n("Wrong type URL in call to AesGcmSivProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var4.z())));
                return null;
            case 20:
                nd1 nd1Var5 = wb1.f12210a;
                ...
                q.x.n("Wrong type URL in call to ChaCha20Poly1305ProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var5.z())));
                return null;
            case 24:
                nd1 nd1Var6 = fc1.f6019a;
                ...
                q.x.n("Wrong type URL in call to XAesGcmProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var6.z())));
                return null;
            default:
                nd1 nd1Var7 = ic1.f7103a;
                ...
                q.x.n("Wrong type URL in call to XChaCha20Poly1305ProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var7.z())));
                return null;
        }
    }
    ...
    public xy d(yd1 yd1Var) {
        ...
        switch (this.f6009u) {
            case 0:
                ...
                q.x.n("Wrong type URL in call to LegacyKmsEnvelopeAeadProtoSerialization.parseKey");
                return null;
            case 6:
                nd1 nd1Var2 = ob1.f9084a;
                ...
                q.x.n("Wrong type URL in call to AesCtrHmacAeadProtoSerialization.parseKey");
                return null;
            case 10:
                nd1 nd1Var3 = pb1.f9457a;
                ...
                q.x.n("Wrong type URL in call to AesEaxProtoSerialization.parseKey");
                return null;
            case 14:
                nd1 nd1Var4 = sb1.f10585a;
                ...
                q.x.n("Wrong type URL in call to AesGcmProtoSerialization.parseKey");
                return null;
            case 18:
                nd1 nd1Var5 = ub1.f11609a;
                ...
                q.x.n("Wrong type URL in call to AesGcmSivProtoSerialization.parseKey");
                return null;
            case 22:
                nd1 nd1Var6 = wb1.f12210a;
                ...
                q.x.n("Wrong type URL in call to ChaCha20Poly1305ProtoSerialization.parseKey");
                return null;
            default:
                nd1 nd1Var7 = fc1.f6019a;
                ...
                q.x.n("Wrong type URL in call to XAesGcmProtoSerialization.parseKey");
                return null;
        }
    }
