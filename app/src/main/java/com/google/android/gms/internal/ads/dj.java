...
public final class dj extends a {
    ...
    public static dj a(Uri uri) {
        ...
        try {
            ...
            e = e;
            int i10 = a0.f19634b;
            i.g("Unable to parse Uri into cache offering.", e);
            return null;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        e7.e(parcel, 2, this.f5436u);
        e7.j(parcel, 3, 8);
        parcel.writeLong(this.f5437v);
        e7.e(parcel, 4, this.f5438w);
        e7.e(parcel, 5, this.f5439x);
        e7.e(parcel, 6, this.f5440y);
        e7.a(parcel, 7, this.f5441z);
        e7.j(parcel, 8, 4);
        parcel.writeInt(this.A ? 1 : 0);
        long j10 = this.B;
        e7.j(parcel, 9, 8);
        parcel.writeLong(j10);
        e7.e(parcel, 10, this.C);
        int i10 = this.D;
        e7.j(parcel, 11, 4);
        parcel.writeInt(i10);
        e7.l(parcel, k3);
