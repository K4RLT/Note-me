...
public final class lz0 implements iz0 {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ int f8191a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ hf f8192b;

    public /* synthetic */ lz0(hf hfVar, int i) {
        this.f8191a = i;
        this.f8192b = hfVar;
    }

    private final void b(byte[] bArr, byte[] bArr2) {
        hf hfVar = this.f8192b;
        int i = ~hfVar.B;
        hfVar.B = i;
    ...
    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type update terminated with stack overflow, arg: (r66v11 Object I:Object[int, boolean, short, byte, char]), method size: 2827
    ...
    private final void c(byte[] r93, byte[] r94) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.lz0.c(byte[], byte[]):void");
    }

    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type update terminated with stack overflow, arg: (r2v56 Object I:Object[int, boolean]), method size: 2844
        	at jadx.core.utils.ErrorsCounter.addError(ErrorsCounter.java:59)
        	at jadx.core.utils.ErrorsCounter.error(ErrorsCounter.java:31)
        	at jadx.core.dex.attributes.nodes.NotificationAttrNode.addError(NotificationAttrNode.java:19)
        	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.visit(TypeInferenceVisitor.java:77)
    ...
    public final void a(byte[] r108, byte[] r109) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.lz0.a(byte[], byte[]):void");
    }
}