    ...
    public final b l(Object obj) {
        ...
        switch (this.f12440a) {
            case 0:
                ...
                if (((Boolean) r.e.f17698c.a(sl.Pb)).booleanValue()) {
                    k.C.f16817h.f("GetTopicsApiWithRecordObservationActionHandlerUnsampled", th);
                } else {
                    k.C.f16817h.e("GetTopicsApiWithRecordObservationActionHandler", th);
                }
                b51 b51Var = d51.f5314v;
                return ed1.e(new b(y51.f12781y));
            case 1:
                a0.l("Error during loading assets.", (Exception) obj);
                return v81.f11836v;
            case 2:
