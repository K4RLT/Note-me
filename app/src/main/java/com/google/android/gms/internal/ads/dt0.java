...
public final class dt0 {
    ...
    public dt0(String str, ClientApi clientApi, Context context, int i, hq0 hq0Var, t2 t2Var, ScheduledExecutorService scheduledExecutorService, fr0 fr0Var, et0 et0Var, a aVar, at0 at0Var) {
        Queue priorityQueue;
        this.f5503l = str;
        ...
        if (((Boolean) r.e.f17698c.a(sl.f10739g0)).booleanValue()) {
        ...
        this.f5509r = aVar;
        hq0 hq0Var2 = new hq0(t2Var.f17702u, 19, b.a(((t2) atomicReference.get()).f17703v));
        hq0Var2.f6874x = str;
    ...
    public final void a(final int i) {
        ...
        y.b(z3);
        t2 t2Var = (t2) this.e.getAndUpdate(new UnaryOperator() { // from class: com.google.android.gms.internal.ads.ot0
            ...
            public final Object apply(Object obj) {
                ...
                int i12 = i11;
                z2 z2Var = t2Var2.f17704w;
                return new t2(t2Var2.f17702u, t2Var2.f17703v, z2Var, i12, t2Var2.f17706y);
            }
        });
        b a10 = b.a(t2Var.f17703v);
        ...
        synchronized (queue) {
            try {
                size = queue.size();
                if (queue.size() > i) {
                    if (((Boolean) r.e.f17698c.a(sl.B)).booleanValue()) {
        ...
        if (bl0Var != null && a10 != null) {
            ...
            String str = ((t2) this.e.get()).f17702u;
            s a11 = ((be0) bl0Var.f4819v).a();
    ...
    public final void b(z2 z2Var) {
        if (((Boolean) r.e.f17698c.a(sl.G)).booleanValue()) {
    ...
    public final void c(y1 y1Var) {
        String lowerCase;
        if (this.f5507p.get()) {
            f0.f19676l.post(new a(this, y1Var));
        }
        ...
        int i10 = ((t2) atomicReference.get()).f17703v;
        String str = ((t2) atomicReference.get()).f17702u;
        ...
        String str2 = ((t2) atomicReference.get()).f17702u;
        b q10 = q();
        bl0 bl0Var = this.f5508q;
        this.f5509r.getClass();
        long currentTimeMillis = System.currentTimeMillis();
    ...
    public final void f() {
        if (this.f5507p.get()) {
            f0.f19676l.post(new mt0(this, 1));
        }
    ...
    /* JADX WARN: Type inference failed for: r3v5, types: [z, com.google.android.gms.internal.ads.gt0, a0] */
    ...
    public final q71 h(Context context) {
        ...
        switch (this.f5511t) {
            case 0:
                ...
                c3 b10 = c3.b();
                AtomicReference atomicReference = this.e;
                no0 no0Var = (no0) this.f5494a.s4(bVar, b10, ((t2) atomicReference.get()).f17702u, vrVar, this.f5496c);
                if (no0Var == null) {
                    return ed1.A(new bt0());
                }
                Object obj = new Object();
                try {
                    b(((t2) atomicReference.get()).f17704w);
                    at0 at0Var = this.f5498f;
                    if (at0Var != null) {
                        nl nlVar = sl.Y;
                        r rVar = r.e;
                    ...
                    m mVar = new m(this, 8, (Object) obj);
                    String str = t2Var.f17702u;
                    pi piVar = new pi();
                    piVar.f9527w = mVar;
                    piVar.f9526v = str;
                    no0Var.q4(piVar);
                    no0Var.n1(((t2) atomicReference.get()).f17704w);
                    return obj;
                } catch (RemoteException e) {
                    i.g("Failed to load app open ad.", e);
                    return ed1.A(new bt0());
                }
            case 1:
                ...
                cl0 cl0Var = (cl0) this.f5494a.F3(bVar2, c3Var, ((t2) atomicReference2.get()).f17702u, vrVar2, this.f5496c);
                if (cl0Var == 0) {
                    return ed1.A(new bt0());
                }
                Object obj2 = new Object();
                try {
                    b(((t2) atomicReference2.get()).f17704w);
                    ...
                    z2 z2Var = ((t2) atomicReference2.get()).f17704w;
                    m mVar2 = new m(this, 8, (Object) obj2);
                    String str2 = ((t2) atomicReference2.get()).f17702u;
                    z zVar = new z();
                    zVar.f6447u = cl0Var;
                    zVar.f6448v = mVar2;
                    zVar.f6449w = str2;
                    ...
                    i.g("Failed to load interstitial ad.", e8);
                    return ed1.A(new bt0());
                }
            default:
                ...
                if (vrVar3 == null) {
                    ...
                    mp0 mp0Var = (mp0) this.f5494a.O2(bVar3, ((t2) atomicReference3.get()).f17702u, vrVar3, this.f5496c);
                    if (mp0Var == 0) {
                        A = ed1.A(new bt0());
                    } else {
                        Object obj3 = new Object();
                        try {
                            b(((t2) atomicReference3.get()).f17704w);
                            ...
                            if (at0Var3 != null) {
                                ...
                                if (((Boolean) rVar3.f17698c.a(nlVar3)).booleanValue()) {
                                    ...
                                    try {
                                        ...
                                        z2 z2Var2 = ((t2) atomicReference3.get()).f17704w;
                                        m mVar3 = new m(this, 8, (Object) obj3);
                                        String str3 = ((t2) atomicReference3.get()).f17702u;
                                        cw cwVar = new cw();
                            ...
                            z2 z2Var22 = ((t2) atomicReference3.get()).f17704w;
                            m mVar32 = new m(this, 8, (Object) obj3);
                            String str32 = ((t2) atomicReference3.get()).f17702u;
                            cw cwVar2 = new cw();
    ...
    public final long i() {
        switch (this.f5511t) {
            case 0:
                return ((Long) r.e.f17698c.a(sl.X)).longValue();
            case 1:
                return ((Long) r.e.f17698c.a(sl.V)).longValue();
            default:
                return ((Long) r.e.f17698c.a(sl.W)).longValue();
        }
    }

    public final /* bridge */ v1 j(Object obj) {
        switch (this.f5511t) {
            case 0:
                try {
                    return ((ti) obj).e();
                    ...
                    int i = a0.f19634b;
                    i.b("Failed to get response info for the app open ad.", e);
                    return null;
                }
            case 1:
                try {
                    ...
                    int i10 = a0.f19634b;
                    i.b("Failed to get response info for  the interstitial ad.", e8);
                    return null;
                }
            default:
                try {
                    ...
                    int i11 = a0.f19634b;
                    i.b("Failed to get response info for the rewarded ad.", e10);
                    return null;
                }
        }
    }
    ...
    public final void k() {
        ...
        if (this.f5499g.get() && t() < ((t2) this.e.get()).f17705x) {
    ...
    public final b q() {
        return b.a(((t2) this.e.get()).f17703v);
    }

    public final String r() {
        return ((t2) this.e.get()).f17702u;
    }

    public final int s() {
        return ((t2) this.e.get()).f17705x;
    }
    ...
    public final void w() {
        q71 h3;
        Activity j10 = k.C.f16816g.j();
        if (j10 == null) {
            String valueOf = String.valueOf(((t2) this.e.get()).f17702u);
            int i = a0.f19634b;
            i.f("Empty activity context at preloading: ".concat(valueOf));
            h3 = h(this.f5495b);
        } else {
            h3 = h(j10);
        }
    ...
    public dt0(String str, ClientApi clientApi, Context context, int i, hq0 hq0Var, t2 t2Var, p0 p0Var, ScheduledExecutorService scheduledExecutorService, fr0 fr0Var, et0 et0Var, a aVar, at0 at0Var, int i10) {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public dt0(ClientApi clientApi, Context context, int i, hq0 hq0Var, t2 t2Var, n0 n0Var, ScheduledExecutorService scheduledExecutorService, fr0 fr0Var, et0 et0Var, a aVar, int i10) {
