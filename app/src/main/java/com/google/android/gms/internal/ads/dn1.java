...
public abstract class dn1 extends cm1 {
    ...
    public final int d(oo1 oo1Var) {
        ...
        if (h()) {
            ...
            q.x.o(a5.a.f(j11, "serialized size must be non-negative, was ", new StringBuilder(String.valueOf(j11).length() + 42)));
            return 0;
        }
        int i = this.zzc;
    ...
    public final void g(int i) {
        if (i >= 0) {
            ...
            q.x.o(a5.a.f(i, "serialized size must be non-negative, was ", new StringBuilder(String.valueOf(i).length() + 42)));
        }
    }
