...
public final class zq implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f13248u) {
            case 0:
                a0.k("loadJavascriptEngine > ADMOB_UI_HANDLER.postDelayed: Trying to acquire lock");
                dr drVar = this.f13249v;
                synchronized (drVar.f5484c) {
                    try {
                        a0.k("loadJavascriptEngine > ADMOB_UI_HANDLER.postDelayed: Lock acquired");
                        ...
                        if (((AtomicInteger) crVar.f3469c).get() != -1 && ((AtomicInteger) crVar.f3469c).get() != 1) {
                            ...
                            a0.k(sb4.toString());
                            a0.k("loadJavascriptEngine > ADMOB_UI_HANDLER.postDelayed: Lock released");
                            return;
                        }
                        a0.k("loadJavascriptEngine > ADMOB_UI_HANDLER.postDelayed: Lock released, the promise is already settled");
                        return;
                    } finally {
                    }
                }
            default:
                ...
                a0.k("loadJavascriptEngine > newEngine.setLoadedListener(postDelayed): Trying to acquire lock");
                synchronized (drVar2.f5484c) {
                    try {
                        a0.k("loadJavascriptEngine > newEngine.setLoadedListener(postDelayed): Lock acquired");
                        if (((AtomicInteger) crVar2.f3469c).get() != -1 && ((AtomicInteger) crVar2.f3469c).get() != 1) {
                            ...
                            a0.k(sb5.toString());
                            a0.k("loadJavascriptEngine > newEngine.setLoadedListener(postDelayed): Lock released");
                            return;
                        }
                        a0.k("loadJavascriptEngine > newEngine.setLoadedListener(postDelayed): Lock released, the promise is already settled");
                        return;
                    } finally {
                    }
                }
