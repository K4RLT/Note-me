...
public abstract class nc {
    ...
    public static final int[] f8642a;
    ...
    public static String a(String str) {
        ...
        while (i11 < decode.length) {
                ...
                while (true) {
                    if (i31 != 91464932) {
                        if (i31 != 1326254146) {
                            ...
                            int i32 = i17 >>> i19;
                            int[] iArr = f8642a;
                            i16 += ((i17 << i18) ^ (i32 + i17)) ^ (i20 + iArr[i20 & i21]);
                            i20 += i22;
                            i17 += ((i16 << i18) ^ (i32 + i16)) ^ (i20 + iArr[(i20 >> i23) & i21]);
                            i14++;
                            i31 -= 1234789214;
                        }
                    } else {
                        int i33 = 751433995 + i31;
                        i31 += 1234789214;
                        if (i14 >= i15) {
                            i31 = i33;
                        }
            ...
            decode[i11] = (byte) (((decode[i11] ^ bArr[i12]) << 24) >> 24);
            i11++;
            i10 = i;
        }
