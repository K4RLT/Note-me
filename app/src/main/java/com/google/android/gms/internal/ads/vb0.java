        ...
        switch (this.f11873a) {
            case 0:
                ...
                if (((Boolean) g9.r.e.f17698c.a(sl.Q2)).booleanValue()) {
                    a5.a.u(f9.k.C.f16819k, (zd0) twVar.f11473y, "native-assets-loading-basic-start");
                }
                ra0 ra0Var = new ra0();
                ...
                if (aq0Var.f4584h.contains(Integer.toString(ra0Var.q()))) {
                    ...
                    if (qp0Var.M) {
                        ...
                        optString2 = p.a.o(new StringBuilder(String.valueOf(str2).length() + 3 + String.valueOf(optString2).length()), str2, " : ", optString2);
                    }
                ...
                int q10 = ra0Var.q();
                throw new cg0(1, a5.a.f(q10, "Invalid template ID: ", new StringBuilder(String.valueOf(q10).length() + 21)));
            case 1:
                if (((Boolean) g9.r.e.f17698c.a(sl.J2)).booleanValue() && (bundle = ((dv) this.f11874b).G) != null) {
            ...
            case 2:
                ...
                while (true) {
                    ...
                    if (it.hasNext()) {
                        pn0 pn0Var = (pn0) ((ac.b) it.next()).get();
                        if (pn0Var != null) {
                            pn0Var.l(obj);
                        }
                    } else {
                        if (((Boolean) g9.r.e.f17698c.a(sl.J2)).booleanValue() && (bundle2 = (Bundle) this.f11876d) != null) {
