...
public final class s {
    ...
    public static o b(n nVar, List list) {
        l(e0.FN, 2, list);
        n k3 = ((e) nVar.f18939w).k(nVar, (n) list.get(0));
        n k4 = ((e) nVar.f18939w).k(nVar, (n) list.get(1));
        if (k4 instanceof d) {
            ArrayList x9 = ((d) k4).x();
        ...
        x.n(a.k("FN requires an ArrayValue of parameter names found ", k4.getClass().getCanonicalName()));
        return null;
    }
    ...
    public static n e(b0 b0Var, n nVar, n nVar2) {
        ...
        x.n("Non-iterable type in for...of loop.");
        return null;
    }
    ...
    public final void c(String str) {
        if (this.f13905a.contains(b(str))) {
            throw new UnsupportedOperationException(a.k("Command not implemented: ", str));
        }
