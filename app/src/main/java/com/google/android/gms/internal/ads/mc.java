                        ...
                        try {
                            switch (this.f8318a) {
                                ...
                                case 2:
                                    ...
                                    ddVar.f5402a.d(id.d(n10.d(oc.e(byteArrayOutputStream.toByteArray()))));
                                    return Optional.empty();
                                case 3:
                                    dd ddVar2 = (dd) obj;
                                    ...
                                    ddVar2.f5402a.d(id.d(n11.d(oc.e(byteArrayOutputStream2.toByteArray()))));
                                    return Optional.empty();
                                case 4:
                                    dd ddVar3 = (dd) obj;
                                ...
                                case 5:
                                    ...
                                    adVar5.d(id.b(adVar5.e().m() << ((int) adVar5.e().m())));
                                    return Optional.empty();
                                case 6:
                                    ad adVar6 = ((dd) obj).f5402a;
                                    adVar6.d(id.b(adVar6.e().m() >>> ((int) adVar6.e().m())));
                                    return Optional.empty();
                                case 7:
                                ...
                                case 8:
                                    ...
                                    adVar8.d(id.b(adVar8.e().m() - adVar8.e().m()));
                                    return Optional.empty();
                                case 9:
                                    dd ddVar4 = (dd) obj;
