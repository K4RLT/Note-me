...
public abstract class ct implements q2 {
        ...
        if (j11 < 2097151) {
            ...
            for (int i13 = 0; i13 < iArr.length; i13++) {
                ...
                try {
                    ...
                    a.k(F2.concat(" digest not supported"), e);
                    return null;
                }
            }
            int i14 = 0;
            ...
            for (i = 3; i14 < i; i = 3) {
                ...
                while (mo212zza > 0) {
                    ...
                    try {
                        ...
                        throw new DigestException(a.f(i18, i16, "Failed to digest chunk #", " of section #", new StringBuilder(String.valueOf(i18).length() + 37 + String.valueOf(i16).length())), e8);
                    }
                }
                i16++;
                i14 = i17 + 1;
            ...
            for (int i22 = 0; i22 < iArr.length; i22++) {
                ...
                try {
                    ...
                    a.k(F3.concat(" digest not supported"), e10);
                    return null;
                }
            }
            return bArr5;
                ...
                if (i != 769) {
                    switch (i) {
                        ...
                        case 260:
                            return 2;
                        default:
                            x.n("Unknown signature algorithm: 0x".concat(String.valueOf(Long.toHexString(i))));
                            return 0;
                    }
                }
                return 1;
    ...
    public static String F(int i) {
        if (i != 1) {
            ...
            x.n(a.f(i, "Unknown content digest algorthm: ", new StringBuilder(String.valueOf(i).length() + 33)));
            return null;
        }
        return "SHA-256";
    }
    ...
    public static ByteBuffer K(ByteBuffer byteBuffer) {
        if (byteBuffer.remaining() >= 4) {
            ...
            if (i >= 0) {
                ...
                x.p(a.f(i, remaining, "Length-prefixed field longer than remaining buffer. Field length: ", ", remaining: ", new StringBuilder(String.valueOf(i).length() + 79 + String.valueOf(remaining).length())));
                return null;
            }
            x.n("Negative length");
            return null;
        ...
        x.p(a.f(remaining2, "Remaining buffer too short to contain length of length-prefixed field. Remaining: ", new StringBuilder(String.valueOf(remaining2).length() + 82)));
        return null;
    }
    ...
    public static byte[] L(ByteBuffer byteBuffer) {
        ...
        if (i >= 0) {
            ...
            int remaining = byteBuffer.remaining();
            x.p(a.f(i, remaining, "Underflow while reading length-prefixed value. Length: ", ", available: ", new StringBuilder(String.valueOf(i).length() + 68 + String.valueOf(remaining).length())));
            return null;
        }
        x.p("Negative length");
        return null;
    ...
    public static void n(int i, Object obj) {
        ...
        q.h(a.f(i, "at index ", new StringBuilder(String.valueOf(i).length() + 9)));
    }
    ...
    public static X509Certificate[][] p(FileChannel fileChannel, sa saVar) {
        ...
        try {
            ...
            try {
                ...
                while (K.hasRemaining()) {
                    ...
                    try {
                        ...
                        throw new SecurityException(a.j(new StringBuilder(String.valueOf(i).length() + 37), "Failed to parse/verify signer #", i, " block"), e);
                    }
                }
                if (i > 0) {
                    if (!hashMap.isEmpty()) {
            ...
            a.k("Failed to obtain X.509 CertificateFactory", e11);
            return null;
        }
    }
    ...
    public static final ResolveInfo q(Intent intent, ArrayList arrayList, Context context) {
        ...
        try {
            ...
            k.C.f16817h.d("OpenSystemBrowserHandler.getDefaultBrowserResolverForIntent", th);
            return resolveInfo;
        }
    }
