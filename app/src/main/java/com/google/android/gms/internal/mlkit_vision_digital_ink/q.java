...
public final class q implements j0 {
    ...
    public q(Context context) {
        this.f14825a = z1.g(context.getSystemService("blob_store"));
    }
    ...
    public final void n(Uri uri) {
        ...
        if (TextUtils.equals(path, "*.lease")) {
            ...
            while (it.hasNext()) {
                sha256Digest = z1.e(it.next()).getSha256Digest();
                p(sha256Digest);
            }
            return;
        }
    ...
    public final ParcelFileDescriptor o(Uri uri) {
        ...
        b(uri);
        createWithSha256 = BlobHandle.createWithSha256(c(uri.getPath()), "The file is shared to provide a better user experience", 0L, "File downloaded through MDDLib");
