...
public final class p8 implements m7, d, s81, b, c {
            ...
            if (s10 != null) {
                for (Object obj2 : s10) {
                    if (obj2 instanceof IBinder) {
                        k1Var = k2.v4((IBinder) obj2);
                    } else {
                        k1Var = null;
                    }
                    if (k1Var != null) {
                        ((ArrayList) this.f9423z).add(new a(k1Var));
                    }
                }
            }
    ...
    public b b(String str) {
        k kVar = k.f20055v;
        if (str != null) {
            if (!((Boolean) r.e.f17698c.a(sl.f10738g)).booleanValue() || !str.isEmpty()) {
                try {
                    return f(str, 0L, 1);
    ...
    public b f(final String str, final long j10, final int i) {
        final String str2;
        h hVar = (h) this.f9419v;
        if (i > hVar.f20049a) {
            ...
            if (vs0Var != null && hVar.f20052d) {
                ...
                return ed1.e(k.f20057x);
            }
            return ed1.e(k.f20056w);
        }
        if (((Boolean) r.e.f17698c.a(sl.L9)).booleanValue()) {
            Uri parse = Uri.parse(str);
            String encodedQuery = parse.getEncodedQuery();
            Uri.Builder clearQuery = parse.buildUpon().clearQuery();
            clearQuery.appendQueryParameter("pa", Integer.toString(i));
            String valueOf = String.valueOf(clearQuery.build());
            str2 = a.o(new StringBuilder(valueOf.length() + 1 + String.valueOf(encodedQuery).length()), valueOf, "&", encodedQuery);
        } else {
            str2 = str;
        }
        ...
        switch (this.f9418u) {
            ...
            case 6:
                ...
                synchronized (ko0Var) {
                    ...
                    ko0Var.f7828j = null;
                    if (((Boolean) r.e.f17698c.a(sl.f10908q9)).booleanValue()) {
        ...
        switch (this.f9418u) {
            case 5:
                ...
                if (((Boolean) r.e.f17698c.a(sl.I6)).booleanValue()) {
                    a0.l("Native ad failed to load", th);
                }
                x10 x10Var = (x10) this.f9422y;
                y1 A3 = x21.A(th, ((i50) x10Var.f12413p.zzb()).f6997l);
            ...
            case 6:
                ...
                r rVar = r.e;
                if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
                    a0.l("App open ad failed to load", th);
                }
                ko0 ko0Var = (ko0) this.f9423z;
            ...
            case 7:
                ...
                if (((Boolean) rVar2.f17698c.a(nlVar2)).booleanValue()) {
                    a0.l("Interstitial ad failed to load", th);
                }
                h20 h20Var = (h20) this.f9422y;
                y1 A4 = x21.A(th, ((i50) h20Var.f6558o.zzb()).f6997l);
                fp0 fp0Var = (fp0) this.f9423z;
                synchronized (fp0Var) {
                    try {
                        fp0Var.i = null;
            ...
            default:
                if (((Boolean) r.e.f17698c.a(sl.I6)).booleanValue()) {
                    a0.l("Rewarded ad failed to load", th);
                }
                kp0 kp0Var = (kp0) this.f9423z;
                ...
                synchronized (kp0Var) {
                    try {
                        if (k20Var != null) {
                            ...
                            kp0Var.f7835b.execute(new a(this, 22, A2));
                        } else {
                            kp0Var.f7837d.x(A2);
