...
public final class lc0 extends ph implements ko {
    ...
    /* JADX WARN: Type inference failed for: r8v26, types: [java.util.Map, r0] */
        ...
        switch (i) {
            ...
            case 3:
                try {
                    ...
                    k.C.f16817h.d("InternalNativeCustomTemplateAdShim.getAvailableAssetNames", e);
            ...
            case 13:
                ...
                if (k3 != null) {
                    ...
                    v80.g(tt0Var);
                    if (ra0Var5.j() != null) {
                        ra0Var5.j().b("onSdkLoaded", new r0(0));
                    }
                    i10 = 1;
                } else {
                    int i13 = a0.f19634b;
                    i.f("Trying to start OMID session before creation.");
                }
                parcel2.writeNoException();
            ...
            case 15:
                try {
                    ...
                    if (Objects.equals(str, "Google")) {
                        int i14 = a0.f19634b;
                        i.f("Illegal argument specified for omid partner name.");
                    } else if (TextUtils.isEmpty(str)) {
                        int i15 = a0.f19634b;
                        i.f("Not starting OMID session. OM partner name has not been configured.");
                    } else {
                    ...
                    k.C.f16817h.d("InternalNativeCustomTemplateAdShim.initializeDisplayOpenMeasurement", e8);
                }
                parcel2.writeNoException();
                return true;
            case 16:
                try {
                    ...
                    k.C.f16817h.d("InternalNativeCustomTemplateAdShim.getMediaContent", e10);
                }
                parcel2.writeNoException();
                qh.e(parcel2, xnVar2);
                return true;
