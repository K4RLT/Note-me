...
public final class ai0 {
    ...
    public ai0(Context context, a aVar, qp0 qp0Var, h00 h00Var, be0 be0Var) {
        this.f4512a = context;
        this.f4513b = aVar;
        this.f4514c = qp0Var;
        this.f4515d = h00Var;
        ...
        if (qp0Var.T) {
            ...
            if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
                if (((Boolean) rVar.f17698c.a(sl.f10807k6)).booleanValue() && (h00Var = this.f4515d) != null) {
                    if (this.f4516f != null) {
                        int i = a0.f19634b;
                        i.f("Omid javascript session service already started for ad.");
                        return false;
                    }
                    ...
                    if (((JSONObject) jk0Var.f7466v).optBoolean((String) rVar.f17698c.a(sl.f10837m6), true)) {
                        ...
                        if (xt0Var == null) {
                            int i11 = a0.f19634b;
                            i.f("Unable to create javascript session service.");
                            return false;
                        }
                        int i12 = a0.f19634b;
                        i.e("Created omid javascript session service.");
                        this.f4516f = xt0Var;
                        h00Var.M0(this);
                        return true;
                    }
        ...
        try {
            ...
            if (xt0Var != null && (h00Var = this.f4515d) != null) {
                ...
                while (i < size) {
                    ...
                    v80.p(new a(xt0Var, 19, (View) obj));
                }
