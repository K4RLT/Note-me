...
public final class gi implements Application.ActivityLifecycleCallbacks {
            ...
            try {
                ...
                while (i < size) {
                    ...
                    try {
                        ...
                        k.C.f16817h.d("AppActivityTracker.ActivityListener.onActivityDestroyed", e);
                        int i10 = a0.f19634b;
                        i.d("", e);
                    }
                }
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        synchronized (this.f6402w) {
            ...
            while (i < size) {
                ...
                try {
                    ...
                    k.C.f16817h.d("AppActivityTracker.ActivityListener.onActivityPaused", e);
                    int i10 = a0.f19634b;
                    i.d("", e);
                }
            }
        ...
        f fVar = this.B;
        if (fVar != null) {
            f0.f19676l.removeCallbacks(fVar);
        }
        b0 b0Var = f0.f19676l;
        ...
        synchronized (this.f6402w) {
            ...
            while (i10 < size) {
                ...
                try {
                    ...
                    k.C.f16817h.d("AppActivityTracker.ActivityListener.onActivityResumed", e);
                    int i11 = a0.f19634b;
                    i.d("", e);
                }
            }
