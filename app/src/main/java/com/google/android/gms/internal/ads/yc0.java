    ...
    public final void c(Activity activity, boolean z3) {
        ...
        if (!m4) {
            ...
            if (((Boolean) qlVar.a(nlVar)).booleanValue()) {
                k9.f0.l(context, this.f13068b, this.f12851v);
            }
            if (((Boolean) qlVar2.a(sl.f10787j1)).booleanValue() && k9.f0.g(context)) {
                int i = k9.a0.f19634b;
                l9.i.f("Rewarded ads that show when your app is in the background are a violation of AdMob policies and may lead to blocked ad serving. To learn more, visit https://goo.gle/admob-interstitial-policies");
                y60Var.a();
        ...
        if (this.f12852w) {
            ...
            l9.i.f("The rewarded ad have been showed.");
