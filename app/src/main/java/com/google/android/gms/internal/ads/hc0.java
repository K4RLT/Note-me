...
public final class hc0 extends ph implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, IInterface {
            ...
            if (i != 4) {
                if (i != 5) {
                    if (i != 6) {
                        ...
                        if (this.f6670x) {
                            int i10 = a0.f19634b;
                            i.c("getVideoController: Instream ad should not be used after destroyed");
                        } else {
    ...
    public final void v4(a aVar, nq nqVar) {
        String str;
        ...
        if (this.f6670x) {
            int i = a0.f19634b;
            i.c("Instream ad can not be shown after destroy().");
            try {
                nqVar.u(2);
                return;
        ...
        if (view != null && this.f6668v != null) {
            if (this.f6671y) {
                int i11 = a0.f19634b;
                i.c("Instream ad should not be used again.");
                try {
                    nqVar.u(1);
                    return;
            ...
            this.f6671y = true;
            w4();
            ((ViewGroup) b.z1(aVar)).addView(this.f6667u, new ViewGroup.LayoutParams(-1, -1));
            fp fpVar = k.C.B;
        ...
        int i14 = a0.f19634b;
        i.c("Instream internal error: ".concat(str));
        try {
            nqVar.u(0);
