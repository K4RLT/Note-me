...
public abstract class bn1 implements Cloneable {
    ...
    public static void e(int i, List list) {
        ...
        String j10 = a5.a.j(new StringBuilder(String.valueOf(size).length() + 26), "Element at index ", size, " is null.");
        int size2 = list.size();
        while (true) {
            size2--;
            if (size2 >= i) {
    ...
    public final void a(byte[] bArr, wm1 wm1Var) {
        ...
        try {
            ...
            l4.a.k("Reading from byte array should not throw IOException.", e8);
