...
public final class yk0 implements d, a80, k70, v60, b70, a, s60, t70, z60, f90 {
    public final be0 D;
    ...
    public final ArrayBlockingQueue E = new ArrayBlockingQueue(((Integer) r.e.f17698c.a(sl.f10764ha)).intValue());
    ...
    public final void L() {
        Object obj;
        if (!((Boolean) r.e.f17698c.a(sl.f10750gc)).booleanValue() && (obj = this.f12894u.get()) != null) {
            try {
                ((x) obj).e();
            } catch (RemoteException e) {
                int i = a0.f19634b;
    ...
    public final synchronized void p(String str, String str2) {
        if (this.f12899z.get()) {
            if (!this.E.offer(new Pair(str, str2))) {
                int i = a0.f19634b;
                i.a("The queue for app events is full, dropping the new event.");
                be0 be0Var = this.D;
                if (be0Var != null) {
                    s a10 = be0Var.a();
    ...
    public final void t() {
        if (this.A.get() && this.B.get()) {
            ...
            while (it.hasNext()) {
                ...
                if (obj != null) {
                    try {
                        ((u0) obj).e0((String) pair.first, (String) pair.second);
                    } catch (RemoteException e) {
                        int i = a0.f19634b;
                        i.i(e, "#007 Could not call remote method.");
                    } catch (NullPointerException e8) {
