            ...
            switch (hashCode) {
                ...
                case -1964744830:
                    ...
                    if (str29.equals("offline_ad_config")) {
                        if (((Boolean) sl.M9.d()).booleanValue()) {
                            JSONObject c10 = g9.c(jsonReader);
                            gVar = new g(c10.optInt("impression_prerequisite", 0), c10.optInt("click_prerequisite", 0), c10.optBoolean("notification_flow_enabled", false));
                        } else {
                            jsonReader.skipValue();
                        }
                        list20 = list;
                ...
                case -1828733410:
                    ...
                    if (str33.equals("network_ping_config")) {
                        if (((Boolean) sl.K9.d()).booleanValue()) {
                            JSONObject optJSONObject = g9.c(jsonReader).optJSONObject("ping_strategy");
                            if (optJSONObject == null) {
                                hVar = new h(1, 0, 1.0d, false);
                                str2 = str3;
                            } else {
                                str2 = str3;
                                hVar = new h(optJSONObject.optInt("max_attempts", 1), optJSONObject.optInt("initial_backoff_ms", 0), optJSONObject.optDouble("backoff_multiplier", 1.0d), optJSONObject.optBoolean("buffer_after_max_attempts", false));
                            }
                            cVar = new c(10, hVar);
                            list20 = list;
                            list19 = list4;
                ...
                case -1812055556:
                    ...
                    if (str34.equals("play_prewarm_options")) {
                        JSONObject c11 = g9.c(jsonReader);
                ...
                case -1240082064:
                    ...
                    if (str51.equals("ad_event_value")) {
                        JSONObject c12 = g9.c(jsonReader);
                        d3 d3Var2 = new d3(c12.getInt("type_num"), c12.getInt("precision_num"), c12.getLong("value"), c12.getString("currency"));
                        str2 = str3;
                        list20 = list;
                        list19 = list4;
                        list17 = list2;
                ...
                case -544216775:
                    ...
                    if (str70.equals("safe_browsing")) {
                        JSONObject c13 = g9.c(jsonReader);
                        nw nwVar2 = new nw(c13.optString("click_string", str3), c13.optString("report_url", str3), c13.optBoolean("rendered_ad_enabled", false), c13.optBoolean("non_malicious_reporting_enabled", false), g9.a(c13.optJSONArray("allowed_headers"), null), c13.optBoolean("protection_enabled", false), c13.optBoolean("malicious_reporting_enabled", false), g9.a(c13.optJSONArray("webview_permissions"), null));
                        list3 = list18;
                        str2 = str3;
                        list20 = list;
                        nwVar = nwVar2;
                ...
                case 639133141:
                    ...
                    if (str94.equals("response_info_extras_override")) {
                        if (((Boolean) sl.I7.d()).booleanValue()) {
                            try {
                                Bundle h3 = g9.h(g9.c(jsonReader));
                                if (h3 != null) {
                                    bundle2 = h3;
                                }
                                list3 = list18;
