...
public final class mx {
    ...
    public mx(String str, long j10) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                if (((Boolean) g9.r.e.f17698c.a(sl.f10703dd)).booleanValue() && a()) {
                    return;
                }
                if (this.f8476g.optInt("status", -1) != 1) {
                    this.f8477h = false;
                    int i = k9.a0.f19634b;
                    l9.i.f("App settings could not be fetched successfully.");
                    return;
                }
                this.f8477h = true;
                ...
                if (((Boolean) g9.r.e.f17698c.a(sl.M7)).booleanValue() && (optJSONObject2 = this.f8476g.optJSONObject("common_settings")) != null && (optJSONArray = optJSONObject2.optJSONArray("loeid")) != null) {
                    for (int i12 = 0; i12 < optJSONArray.length(); i12++) {
                        this.i.add(optJSONArray.get(i12).toString());
                    }
                }
                if (((Boolean) g9.r.e.f17698c.a(sl.f10761h7)).booleanValue() && (optJSONObject = this.f8476g.optJSONObject("common_settings")) != null) {
                    this.f8478j = optJSONObject.optBoolean("is_prefetching_enabled", false);
                }
            } catch (JSONException e) {
                int i13 = k9.a0.f19634b;
                l9.i.g("Exception occurred while processing app setting json", e);
                f9.k.C.f16817h.d("AppSettings.parseAppSettingsJson", e);
            }
        }
    }
    ...
    public final boolean a() {
        ...
        if (((Boolean) g9.r.e.f17698c.a(sl.f10664b5)).booleanValue()) {
            f9.k kVar = f9.k.C;
