...
public final class ax implements sr1 {
    ...
    /* JADX WARN: Type inference failed for: r3v26, types: [com.google.android.gms.internal.ads.mh0, c2.b] */
    ...
    public final Object zzb() {
        ...
        switch (this.f4621a) {
            case 0:
                ...
                return new zw(context, new x90((la.a) swVar.f11181c.f11431a, 5, (qw) swVar.f11180b.zzb()));
            case 1:
                return new i0.m(5, ((ur1) this.f4622b).zzb(), ((ur1) this.f4623c).zzb(), false);
            case 2:
                return ((tw) this.f4622b).q(((xr1) this.f4623c).zzb());
            case 3:
                return new nl0(((rw) this.f4622b).c(), ((Integer) g9.r.e.f17698c.a(sl.Td)).intValue(), (ScheduledExecutorService) this.f4623c.zzb());
            case 4:
                return new nl0(new hl0(2, ((ad0) this.f4622b).f4461b.a()), ((Integer) g9.r.e.f17698c.a(sl.Yd)).intValue(), (ScheduledExecutorService) this.f4623c.zzb());
            case 5:
                return new nl0(((rw) this.f4622b).e(), ((Integer) g9.r.e.f17698c.a(sl.Ud)).intValue(), (ScheduledExecutorService) this.f4623c.zzb());
            case 6:
                Boolean bool = (Boolean) g9.r.e.f17698c.a(sl.B6);
                bool.booleanValue();
            ...
            case 27:
                return new c2.b(((ax) this.f4622b).a(), ((l10) this.f4623c).zzb());
            case 28:
                lh0 lh0Var = (lh0) ((rr1) this.f4622b).zzb();
                ax axVar = (ax) this.f4623c;
                return new td0(lh0Var, (mh0) new c2.b(((ax) axVar.f4622b).a(), ((l10) axVar.f4623c).zzb()));
            default:
                xa0 xa0Var = (xa0) this.f4622b;
                wx wxVar6 = xx.f12651a;
                lo1.b(wxVar6);
                aq0 a12 = xa0Var.f12535b.a();
                return new nl0(new pl0(wxVar6, a12, 0), ((Integer) g9.r.e.f17698c.a(sl.Qd)).intValue(), (ScheduledExecutorService) this.f4623c.zzb());
        }
    }
}
