...
public final class t90 implements k70, j9.m, b70 {
    ...
    public t90(Context context, h00 h00Var, qp0 qp0Var, l9.a aVar, ai0 ai0Var) {
    ...
    public final boolean a() {
        xt0 xt0Var;
        if (((Boolean) g9.r.e.f17698c.a(sl.f10807k6)).booleanValue()) {
    ...
    /* JADX WARN: Type inference failed for: r1v4, types: [java.util.Map, n.r0] */
    @Override // j9.m
    public final void d() {
        h00 h00Var;
        if (!((Boolean) g9.r.e.f17698c.a(sl.f10854n6)).booleanValue() && (h00Var = this.f11294v) != 0) {
            if (this.f11298z != null || a()) {
                if (this.f11298z != null) {
                    h00Var.b("onSdkImpression", new n.r0(0));
                } else {
                    this.f11297y.c();
                }
            }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v3, types: [java.util.Map, n.r0] */
    ...
    public final void y() {
        ...
        if (a()) {
            ...
            if (((Boolean) g9.r.e.f17698c.a(sl.f10854n6)).booleanValue()) {
                h00Var.b("onSdkImpression", new n.r0(0));
            }
        }
    }
