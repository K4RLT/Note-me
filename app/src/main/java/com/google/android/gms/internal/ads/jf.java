...
public final class jf implements lf {
        ...
        synchronized (jf.class) {
            try {
                if (L == null) {
                    ...
                    tf c10 = c(context);
                    kg a11 = a(context, executorService);
                    d2 d2Var = new d2();
                    g9 g9Var = new g9();
                    tw twVar = new tw(context, executorService, a10, (hv0) new Object());
                    o c11 = h8.c(new bo0(3, twVar), executorService);
                    ...
                    jf jfVar2 = new jf(context, a10, new tw(context, q10), new xv0(context, q10, new tf(7, a10), ((Boolean) r.e.f17698c.a(sl.h3)).booleanValue()), new bw0(context, agVar, a10, obj, false), agVar, executorService, obj, q10, a11, d2Var, g9Var);
                    L = jfVar2;
                    jfVar2.j();
                    L.k();
                }
    ...
    public final void a(int i, int i10, int i11) {
        ...
        if (((Boolean) r.e.f17698c.a(sl.f10973ud)).booleanValue() && (displayMetrics = this.f7427u.getResources().getDisplayMetrics()) != null) {
            float f10 = i;
                        ...
                        if (!C.z().z().isEmpty()) {
                            if (!C.z().A().isEmpty()) {
                                if (C.B().a().length != 0) {
                                    ...
                                    s6 s6Var = this.C;
                                    int i10 = d2.f12339w;
                                    if (((Boolean) r.e.f17698c.a(sl.f10725f3)).booleanValue()) {
                                        if (i10 == 3) {
                                            f10 = this.f7429w.e(C);
                                        } else {
                                            if (i10 == 4) {
