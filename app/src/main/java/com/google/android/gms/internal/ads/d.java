...
public final /* synthetic */ class d implements l, p2 {
    ...
    public com.google.android.gms.internal.mlkit_vision_digital_ink.iw a() {
        ...
        if (i >= 34) {
            ...
            a.i((ActivityOptions) this.f5232x);
        }
        if (i >= 36) {
            if (((ActivityOptions) this.f5232x) == null) {
                this.f5232x = ActivityOptions.makeBasic();
            }
            g.a((ActivityOptions) this.f5232x, !intent.getBooleanExtra("androidx.browser.customtabs.extra.DISABLE_BACKGROUND_INTERACTION", false));
        }
    ...
    public Boolean d() {
        ...
        Bundle bundle;
        g gVar = ((FirebaseMessaging) this.f5232x).f15598a;
        gVar.a();
    ...
    public void e(Runnable runnable, Executor executor) {
        synchronized (this.f5230v) {
            try {
                if (this.f5229u) {
                    ((ArrayDeque) this.f5231w).add(new q(runnable, executor));
                } else {
                    this.f5229u = true;
                    l(runnable, executor);
                }
    ...
    public String i() {
        if (!this.f5229u) {
            this.f5229u = true;
            this.f5231w = ((q0) this.f5232x).D().getString((String) this.f5230v, null);
        }
        return (String) this.f5231w;
    }

    public void j(String str) {
        SharedPreferences.Editor edit = ((q0) this.f5232x).D().edit();
    ...
    public void k() {
        synchronized (this.f5230v) {
            try {
                ...
                q qVar = (q) ((ArrayDeque) this.f5231w).remove();
    ...
    public d(FirebaseMessaging firebaseMessaging, c cVar) {
