    ...
    */
    ...
    public static final Integer b(String str, Map map) {
        ...
        try {
            ...
            String l10 = a.l(new StringBuilder(str.length() + 39 + String.valueOf(str2).length()), "Precache invalid numeric parameter '", str, "': ", str2);
            int i = a0.f19634b;
            i.f(l10);
            return null;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:123:0x0354, code lost:
        ...
        r3 = a0.f19634b;
        i.d("Error constructing openable urls response.", r0);
     */
