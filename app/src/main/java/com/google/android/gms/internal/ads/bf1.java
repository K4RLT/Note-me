...
public final class bf1 implements af1 {
    ...
    public static final a7.k f4785x = new a7.k(10);
            ...
            if (ct.i(1)) {
                ...
                if (i10 * 16 == length) {
                    ...
                    if (length2 < 16) {
                        ...
                        if (copyOf.length == 16) {
                            ...
                            q.x.n("The lengths of x and y should match.");
                            return null;
                        }
                    } else {
                        q.x.n("x must be smaller than a block.");
                        return null;
                    }
                }
                ...
                for (int i13 = 0; i13 < i11; i13++) {
                    ...
                    if (cipher.doFinal(bArr3, 0, 16, bArr2) != 16) {
                        q.x.o("Cipher didn't write full block");
                        return null;
                    }
                }
