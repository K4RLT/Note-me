...
public final class kp0 {
    ...
    public final boolean a(z2 z2Var, String str, an1 an1Var, el0 el0Var) {
        ...
        if (str == null) {
            int i = a0.f19634b;
            i.c("Ad unit ID should not be null for rewarded video ad.");
        ...
        zp0Var.f13228c = str;
        zp0Var.f13227b = new c3("reward_mb", 0, 0, true, 0, 0, null, false, false, false, false, false, false, false, false, false);
        ...
        obj.f7506a = a10;
        b o10 = zo0Var.o(new x90(8, obj, null, false), new bl0(2, this));
        this.i = o10;
