...
public abstract class q2 {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (z3) {
                ...
                for (int i14 = 0; i14 < list.size(); i14++) {
                    ...
                    i13 += i1.o((intValue >> 31) ^ (intValue + intValue));
                }
                i1Var.l(i13);
                while (i10 < list.size()) {
            ...
            if (!(list instanceof c2)) {
                ...
                if (z3) {
                    ...
                    for (int i12 = 0; i12 < list.size(); i12++) {
                        ...
                        i11 += i1.p((longValue >> 63) ^ (longValue + longValue));
                    }
                    i1Var.l(i11);
                    while (i10 < list.size()) {
    ...
    public static void d(int i, List list, d2 d2Var, boolean z3) {
        if (list != null && !list.isEmpty()) {
            ...
            if (z3) {
                ...
                int i13 = 0;
                for (int i14 = 0; i14 < list.size(); i14++) {
                    i13 += i1.o(((Integer) list.get(i14)).intValue());
                }
                i1Var.l(i13);
                while (i10 < list.size()) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!(list instanceof c2)) {
                ...
                if (z3) {
                    ...
                    int i11 = 0;
                    for (int i12 = 0; i12 < list.size(); i12++) {
                        i11 += i1.p(((Long) list.get(i12)).longValue());
                    }
                    i1Var.l(i11);
                    while (i10 < list.size()) {
    ...
    public static int g(List list) {
        ...
        int i11 = 0;
        while (i < size) {
            i11 += i1.p(((Integer) list.get(i)).intValue());
            i++;
        }
        return i11;
    }
    ...
    public static int k(List list) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            i += i1.p(((Long) list.get(i10)).longValue());
        }
        return i;
    }
    ...
    public static int l(List list) {
        ...
        while (i < size) {
            ...
            i11 += i1.o((intValue >> 31) ^ (intValue + intValue));
            i++;
        }
        return i11;
    }
    ...
    public static int m(List list) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            i += i1.p((longValue >> 63) ^ (longValue + longValue));
        }
        return i;
    }
    ...
    public static int n(List list) {
        ...
        int i11 = 0;
        while (i < size) {
            i11 += i1.o(((Integer) list.get(i)).intValue());
            i++;
        }
        return i11;
    }
    ...
    public static void s(int i, List list, d2 d2Var, boolean z3) {
        if (list != null && !list.isEmpty()) {
            ...
            if (z3) {
                ...
                int i13 = 0;
                for (int i14 = 0; i14 < list.size(); i14++) {
                    i13 += i1.p(((Integer) list.get(i14)).intValue());
                }
                i1Var.l(i13);
                while (i10 < list.size()) {
