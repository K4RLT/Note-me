        ...
        switch (this.f8372a) {
            ...
            case 1:
                ...
                if (arrayList2 != null) {
                    ...
                    if (((Boolean) r.e.f17698c.a(sl.f10878od)).booleanValue() && rnVar != null) {
            ...
            default:
                try {
                    JSONObject g8 = g9.g("pii", (JSONObject) obj);
                    a aVar = (a) this.f8373b;
                    if (aVar != null) {
