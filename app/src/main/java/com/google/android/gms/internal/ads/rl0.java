    ...
    public final b zza() {
        ...
        switch (i) {
            case 0:
                ...
                b c02 = ed1.c0((b) obj, x20.i, executor);
                if (((Integer) r.e.f17698c.a(sl.Vd)).intValue() > 0) {
            ...
            case 2:
                ...
                try {
                    b0 b0Var = f0.f19676l;
                    Context context2 = b.a(context).f3851u;
                ...
                if (Build.VERSION.SDK_INT >= 30) {
                    if (((Boolean) r.e.f17698c.a(sl.f10814ke)).booleanValue()) {
                        try {
                        ...
                        if (installSourceInfo != null) {
                            ...
                            try {
                                if (TextUtils.isEmpty(str5)) {
                                    a0.k("No installing package name found");
                                    str5 = null;
                                }
                                ...
                                try {
                                    ...
                                    k.C.f16817h.d("PackageInfoSignalSource.getInstallSourceInfo", e);
                                    str3 = str5;
                                    str4 = str6;
                            ...
                            if (TextUtils.isEmpty(initiatingPackageName)) {
                                a0.k("No initiating package name found");
                                str3 = str5;
                                str4 = str6;
                                return ed1.e(new en0(str7, valueOf, str, str2, str3, str4));
                            }
            ...
            default:
                ...
                if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
                    if (((Boolean) rVar.f17698c.a(sl.S3)).booleanValue()) {
                        wx wxVar = (wx) obj3;
                        b c03 = ed1.c0(xy.q(h8.e(null)), x20.f12437l, wxVar);
