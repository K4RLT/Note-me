...
public final class i {
    ...
    public i(z4 z4Var, z4 z4Var2, z4 z4Var3) {
        ...
        while (listIterator.hasNext()) {
            ...
            if (TextUtils.isEmpty(j0Var.d())) {
                ...
                if (j0Var2 != null) {
                    x.n(a.l("Cannot override Backend ", j0Var2.getClass().getCanonicalName(), " with ", j0Var.getClass().getCanonicalName()));
                    throw null;
                }
            }
        }
        ...
        while (listIterator2.hasNext()) {
            ...
            if (TextUtils.isEmpty("compress")) {
                ...
                x.n(a.l("Cannot to override Transform ", k0.class.getCanonicalName(), " with ", k0Var.getClass().getCanonicalName()));
                throw null;
            }
        }
    ...
    public final j0 j(String str) {
        ...
        throw new IOException(a.k("Requested backend isn't registered: ", str));
    }
    ...
    public final h4 k(Uri uri) {
        ...
        while (i10 < size) {
            ...
            if (matcher.matches()) {
                ...
                x.n("Invalid fragment spec: ".concat(String.valueOf(str)));
                return null;
            }
        }
        ...
        while (i < i13) {
            ...
            if (k0Var != null) {
                ...
                throw new IOException(a.l("Requested transform isn't registered: ", str2, ": ", String.valueOf(uri)));
            }
        }
