...
public abstract class l1 implements e2 {
    ...
    public final void close() {
        ...
        if (e2Var != null) {
            if (this == e2Var) {
                q1.c(a10, ((l1) e2Var).f14585u);
                this.f14589y = null;
                return;
            }
            throw new IllegalStateException(a5.a.h("Tried to end span ", str, ", but that span is not the current span. The current span is ", ((l1) e2Var).f14588x, "."));
        }
        throw new IllegalStateException(p.a.k("Tried to end [", str, "], but no trace was active. This is caused by mismatched or missing calls to beginSpan."));
    }
