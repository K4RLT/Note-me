            ...
            default:
                ...
                if (c11 && (urVar = this.f14862c) != null) {
                    ...
                    if (q2Var.a() == null) {
                                                                ...
                                                                if (omVar3 != null) {
                                                                    ...
                                                                    if (!str6.startsWith("inlinefile")) {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            int i25 = jr.f14529v;
                                                                            e eVar4 = new e(21, false);
                                                                            eVar4.f24675v = vq.MALFORMED_FILE_URI_ERROR;
                                                                            eVar4.f24677x = e10;
                                                                            return n5.l(eVar4.C());
                                                                        }
                                                                    }
                                                                    x.n("InlineDownloadParams must be set when using inlinefile: scheme");
                                                                    return null;
                                                                }
                                                                q.h("Null customDownloaderMetadata");
                                                                return null;
                                                            }
                                                            q.h("Null extraHttpHeaders");
                                                            return null;
                                                        }
                                                        q.h("Null fileUri");
                                                        return null;
                        ...
                        int i12 = g2.f14354a;
                        return n5.q(m4, new r0(b(), 3, eaVar), (Executor) lwVar.A);
                    }
                    q.b();
                    return null;
                }
                ...
                int i13 = g2.f14354a;
                return n5.q(m10, new r0(b(), 3, eaVar2), (Executor) lwVar.A);
        }
    }
