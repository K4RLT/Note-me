...
public final class op0 extends ph {
    ...
    public final synchronized void B1(oa.a aVar) {
        try {
            fa.y.d("showAd must be called on the main UI thread.");
            if (this.f9192x != null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:171:0x0243, code lost:
        ...
        if (((java.lang.Boolean) g9.r.e.f17698c.a(com.google.android.gms.internal.ads.sl.f10981v6)).booleanValue() == false) goto L163;
     */
