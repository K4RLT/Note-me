    ...
    */
    public final com.google.android.gms.internal.ads.f3 a(java.lang.String r17, java.lang.String r18, long r19, boolean r21) {
        /*
            ...
            if (r6 == 0) goto L3e
            r7 = r18
            java.lang.String r6 = e(r1, r7, r6)
    ...
    public final f3 d(String str, boolean z3) {
        ...
        x.o(this.e.concat(": Invalid negative current timestamp. Updating PAID failed"));
        return null;
    }
    ...
    public final String e(String str, String str2, String str3) {
        String str4;
        if (str2 != null) {
            return UUID.nameUUIDFromBytes(a.o(new StringBuilder(str2.length() + str.length() + str3.length()), str, str2, str3).getBytes(StandardCharsets.UTF_8)).toString();
        }
        if (str2 != null) {
            str4 = "not null";
        } else {
        ...
        a.t(sb2, this.e, ": Invalid argument to generate PAIDv1 on 3p traffic, Ad ID is not null, package name is ", str4, ", hashKey is ");
        sb2.append("not null");
