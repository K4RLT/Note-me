...
public final class py1 implements com.google.android.gms.internal.mlkit_vision_digital_ink.da {
    ...
    public com.google.android.gms.internal.mlkit_vision_digital_ink.ya zza() {
        ...
        try {
            ...
            str = a.l("System limit exceeded for file ", orVar.D(), ", group ", trVar.P());
            i = 25;
            ...
            str = a.l("Malformed lease Uri for file ", orVar.D(), ", group ", trVar.P());
            i = 18;
            ...
            str = a.l("Error while acquiring lease for file ", orVar.D(), ", group ", trVar.P());
            i = 20;
        }
        if (i == 0) {
