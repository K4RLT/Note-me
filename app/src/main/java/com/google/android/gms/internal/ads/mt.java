...
public final class mt extends mu {
    ...
    public final void u(boolean z3) {
        synchronized (this.G) {
            try {
                if (this.N != null) {
                    if (((Boolean) r.e.f17698c.a(sl.f10798jc)).booleanValue() && Looper.getMainLooper().getThread() != Thread.currentThread()) {
        ...
        if (viewGroup != null) {
            ...
            if (booleanValue2) {
                try {
                    ...
                    int i = a0.f19634b;
                    i.d("Unable to add webview back to view hierarchy.", e);
                    k.C.f16817h.d("MraidCallResizeHandler.collapseInternal", e);
                }
            } else {
                viewGroup2.addView((View) h00Var);
                h00Var.C0(this.J);
