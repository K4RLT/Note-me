    ...
    public final Object next() {
        ...
        switch (this.f14233u) {
            ...
            case 3:
                ...
                eg egVar = (eg) ((a41) this.f14236x).f4359y;
                egVar.getClass();
    ...
    public final void remove() {
        ...
        switch (this.f14233u) {
            ...
            case 3:
                ...
                if (z10) {
                    this.f14234v.remove();
                    ((eg) ((a41) this.f14236x).f4359y).getClass();
                    ((Collection) this.f14235w).size();
                    ((Collection) this.f14235w).clear();
                    this.f14235w = null;
                    return;
                }
                x.o("no calls to next() since the last call to remove()");
                return;
            case 4:
                ...
                if (z11) {
                    ...
                    this.f14234v.remove();
                    ((yc) this.f14236x).f31603w.getClass();
                    collection2.size();
                    collection2.clear();
                    this.f14235w = null;
                    return;
