    ...
    public final void l(Object obj) {
        ...
        switch (this.f5133a) {
            case 0:
                ...
                if (pp0Var != null) {
                    if (!((Boolean) r.e.f17698c.a(sl.f10943sd)).booleanValue()) {
            ...
            case 1:
                try {
                    ...
                    a0.k("Unable to get cache_state");
                    return;
                }
            case 2:
                try {
                    ...
                    a0.k("Failed putting version constants.");
                    return;
                }
            default:
                try {
                    ...
                    a0.k("Failed putting experiment ids.");
                    return;
                }
        }
    }
