...
public abstract class iw0 {
    ...
    public static void a(String str) {
        ...
        if (!str.equalsIgnoreCase(":memory:")) {
            ...
            while (i10 <= length) {
                ...
                if (kotlin.jvm.internal.l.b(str.charAt(i), 32) <= 0) {
                    z3 = true;
                } else {
                    z3 = false;
                }
    ...
    public abstract void c(r5.c cVar);

    public abstract void d(r5.c cVar, int i, int i10);

    public abstract void e(r5.c cVar);

    public abstract void f(r5.c cVar, int i, int i10);
