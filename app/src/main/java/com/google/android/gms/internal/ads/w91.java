...
public final class w91 {
    ...
    public static w91 a(xk0 xk0Var) {
        ...
        StringBuilder sb2 = new StringBuilder(a.v(str3, length + length2, length3));
        sb2.append(str);
        sb2.append(str2);
        sb2.append(i10);
        sb2.append(str3);
    ...
    public static String f(String str, String str2, Object... objArr) {
        if (objArr.length > 0) {
            try {
                ...
                str2 = a.l(new StringBuilder(String.valueOf(join).length() + length + 2 + 1), str2, " [", join, "]");
            }
        }
        return a.o(new StringBuilder(str.length() + 3 + str2.length()), str, " : ", str2);
    }
