...
public abstract class a9 {
    ...
    */
    public static android.text.SpannedString a(java.lang.String r19, java.lang.String r20, java.util.List r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.a(java.lang.String, java.lang.String, java.util.List):android.text.SpannedString");
    }
    ...
    */
    public static void c(java.lang.String r16, com.google.android.gms.internal.ads.z8 r17) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.c(java.lang.String, com.google.android.gms.internal.ads.z8):void");
    }
        ...
        for (int i21 = 0; i21 < f10.size(); i21++) {
            ...
            if (u8Var.i) {
                if (u8Var.i) {
                    ...
                    x.o("Background color not defined.");
                    return;
                }
            }
            if (u8Var.e != null) {
    ...
    public static ArrayList f(List list, String str, x8 x8Var) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (u8Var.f11566a.isEmpty() && u8Var.f11567b.isEmpty() && u8Var.f11568c.isEmpty() && u8Var.f11569d.isEmpty()) {
                ...
                int a10 = a(u8Var.f11569d, a(u8Var.f11567b, a(u8Var.f11566a, 0, 1073741824, str), 2, str2), 4, str3);
