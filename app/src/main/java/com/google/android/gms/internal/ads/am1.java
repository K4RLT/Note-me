...
public final class am1 implements Closeable {
    ...
    public final void K(String str) {
        String k3 = k();
        throw new IOException(a.o(new StringBuilder(str.length() + k3.length() + 79), str, k3, "\nSee https://github.com/google/gson/blob/main/Troubleshooting.md#malformed-json"));
    }
    ...
    public final IllegalStateException L(String str) {
        ...
        String a10 = lr1.a(m());
        String k3 = k();
        int v2 = a.v(a10, str.length() + 18, k3.length());
        if (m4 == 9) {
        ...
        a.t(sb2, "Expected ", str, " but was ", a10);
        return new IllegalStateException(a.o(sb2, k3, "\nSee ", concat));
    }
    ...
    */
    ...
    public final String k() {
        ...
        for (int i11 = 0; i11 < this.E; i11++) {
            ...
            switch (i12) {
                ...
                case 8:
                    break;
                default:
                    q.f(a.f(i12, "Unknown scope value: ", new StringBuilder(String.valueOf(i12).length() + 21)));
                    return null;
            }
        }
        int i14 = i10 + 1;
        ...
        a.r(i, i14, " at line ", " column ", sb4);
        return a.k(sb4, " path ", sb3);
    }
    ...
    */
    ...
    public final void w(int i) {
        ...
        String k3 = k();
        throw new IOException(a.k(new StringBuilder(k3.length() + 26), "Nesting limit 1280 reached", k3));
    }
}
