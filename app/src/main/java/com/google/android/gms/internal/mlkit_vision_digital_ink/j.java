...
public abstract class j {
    ...
    public static Account a(String str) {
        ...
        pa.h(z3, "Malformed account", new Object[0]);
    ...
    public static String b(Account account) {
        ...
        pa.h(z3, "Account type contains ':'.", new Object[0]);
        if (account.type.indexOf(47) == -1) {
            z9 = true;
        } else {
            z9 = false;
        }
        pa.h(z9, "Account type contains '/'.", new Object[0]);
        if (account.name.indexOf(47) != -1) {
            z10 = false;
        }
        pa.h(z10, "Account name contains '/'.", new Object[0]);
