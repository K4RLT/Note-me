...
public abstract class om1 implements Iterable, Serializable {
    ...
    public static int b(int i, int i10, int i11) {
        ...
        if ((i | i10 | i12 | (i11 - i10)) < 0) {
            if (i >= 0) {
                if (i10 < i) {
                    x.l(a.f(i, i10, "Beginning index larger than ending index: ", ", ", new StringBuilder(String.valueOf(i).length() + 44 + String.valueOf(i10).length())));
                    return 0;
                }
                x.l(a.f(i10, i11, "End index: ", " >= ", new StringBuilder(String.valueOf(i10).length() + 15 + String.valueOf(i11).length())));
                return 0;
            }
            x.l(a.j(new StringBuilder(String.valueOf(i).length() + 21), "Beginning index: ", i, " < 0"));
            return 0;
        }
        return i12;
    }
    ...
    public static om1 t(Iterator it, int i) {
        if (i > 0) {
            ...
            int k13 = t3.k();
            int k14 = t10.k();
            x.n(a.f(k13, k14, "ByteString would be too long: ", "+", new StringBuilder(String.valueOf(k13).length() + 31 + String.valueOf(k14).length())));
            return null;
        }
        Locale locale = Locale.ROOT;
        x.n(a.i("length (", i, ") must be >= 1"));
        return null;
    }
    ...
    public final String toString() {
        ...
        return a.k(a.m("<ByteString@", hexString, " size=", k3, " contents=\""), concat, "\">");
    }
