...
public final class kt0 {
    ...
    public kt0(Object obj, a aVar, double d2, int i) {
        if (aVar != null) {
            this.f7872a = obj;
            this.f7874c = aVar;
            this.f7873b = System.currentTimeMillis();
            this.f7875d = Math.min(Math.max(((Long) r.e.f17698c.a(sl.f10722f0)).longValue() * 1000, 10000L), 21600000L);
            this.e = d2;
            this.f7876f = i;
            return;
        }
        x.n("Clock cannot be null.");
        throw null;
    }
