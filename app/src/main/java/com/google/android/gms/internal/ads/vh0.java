...
public final /* synthetic */ class vh0 implements DialogInterface.OnClickListener {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        switch (this.f11903a) {
            case 0:
                ...
                j9.d dVar = (j9.d) this.f11906d;
                HashMap hashMap = new HashMap();
                hashMap.put("dialog_action", "confirm");
                wh0Var.B4(wh0Var.f12246z, "rtsdc", hashMap);
                activity.startActivity(f9.k.C.f16815f.k(activity));
                wh0Var.z4();
                if (dVar != null) {
                    dVar.l();
                    return;
    ...
    public /* synthetic */ vh0(wh0 wh0Var, Activity activity, j9.d dVar, int i) {
        this.f11903a = i;
        this.f11904b = wh0Var;
