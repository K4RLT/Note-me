        ...
        switch (i) {
            ...
            case 1:
                ...
                if (((Boolean) vm.i.p()).booleanValue()) {
                    f9.k.C.f16817h.d("prepareClickUrl.attestation2", th);
                }
                return str;
            case 2:
            ...
            default:
                ...
                l9.i.c("Error calling adapter: ".concat(String.valueOf(str)));
                if (((Boolean) g9.r.e.f17698c.a(sl.Fe)).booleanValue()) {
                    f9.k.C.f16817h.e("rtbSignal.fetchRtbJsonInfo-".concat(String.valueOf(str)), th2);
                    return null;
                }
                f9.k.C.f16817h.d("rtbSignal.fetchRtbJsonInfo-".concat(String.valueOf(str)), th2);
                return null;
        }
    }
}
