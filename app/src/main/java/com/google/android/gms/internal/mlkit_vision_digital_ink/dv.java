...
public final /* synthetic */ class dv implements ea {
    ...
    public final /* synthetic */ b6.u f14225b;

    public /* synthetic */ dv(b6.u uVar, int i) {
        this.f14224a = i;
        this.f14225b = uVar;
    }
    ...
    public final ya l(Object obj) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                int i12 = g2.f14354a;
                return n5.q(p10, new r0(q1.b(), i11, dvVar), (Executor) uVar.A);
            case 2:
            ...
            case 4:
                ...
                if (!d2.getBoolean("mdd_migrated_to_offroad", false)) {
                    ...
                    int i13 = g2.f14354a;
                    return n5.p(f10, new f2(q1.b(), i10, rlVar), executor);
                }
                return va.f15125v;
            case 5:
                ...
                int i14 = g2.f14354a;
                return n5.q(m4, new r0(q1.b(), i11, dvVar2), (Executor) uVar.A);
            case 6:
                ya j10 = ((wv) uVar.f1785y).j();
                dv dvVar3 = new dv(uVar, 2);
                int i15 = g2.f14354a;
                return n5.q(j10, new r0(q1.b(), i11, dvVar3), (Executor) uVar.A);
            default:
