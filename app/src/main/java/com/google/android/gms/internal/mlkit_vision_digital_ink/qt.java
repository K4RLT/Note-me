    ...
    public final ya l(Object obj) {
        ...
        switch (i) {
            ...
            case 2:
                if (f7.q(trVar)) {
                    ...
                    try {
                        ...
                        int i11 = g2.f14354a;
                        w9 q10 = n5.q(t3, new r0(b(), 3, c1Var), executor);
                        q10.g(new ra(q10, i10, new pw(b(), 12, new gw(13, hbVar, trVar, false))), executor);
                        return q10;
                    } catch (IOException e) {
                        int i12 = jr.f14529v;
            ...
            default:
                ...
                int i13 = g2.f14354a;
                return n5.p(vaVar, new f2(b(), i10, rlVar), (Executor) hbVar.f6653y);
        }
    }
