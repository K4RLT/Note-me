...
public final class vi0 implements ji0 {
    ...
    public vi0(Context context, l9.a aVar, h20 h20Var, wx wxVar) {
        ...
        switch (i) {
            case 0:
                if (((Boolean) g9.r.e.f17698c.a(sl.W8)).booleanValue() && qp0Var.f9936g0) {
                    try {
                        view = (View) oa.b.z1(((bs) this.e).u4());
        ...
        switch (this.f11907a) {
            case 0:
                try {
                    ...
                    zsVar.Z2(str);
                    boolean booleanValue = ((Boolean) g9.r.e.f17698c.a(sl.W8)).booleanValue();
                    ...
                    if (booleanValue && qp0Var.f9936g0) {
                        ...
                        zsVar.m2(str2, jSONObject2, aq0Var.f4581d, new oa.b(context), new ui0(this, gi0Var), (as) iInterface, aq0Var.f4582f);
                        return;
                    }
                    String str3 = qp0Var.U;
                    String jSONObject3 = jSONObject.toString();
                    aq0 aq0Var2 = (aq0) wp0Var.f12312a.f4819v;
                    zsVar.U0(str3, jSONObject3, aq0Var2.f4581d, new oa.b(context), new ui0(this, gi0Var), (as) iInterface, aq0Var2.f4582f);
                    return;
            ...
            case 1:
                ...
                String i = wa.g9.i(qp0Var.f9956s);
                Context context2 = this.f11908b;
                as asVar = (as) gi0Var.f6408c;
                try {
                    iq0Var.f7192a.Z3(new oa.b(context2), aq0Var3.f4581d, jSONObject4, i, asVar);
                    return;
                } finally {
            ...
            default:
                try {
                    ...
                    zsVar2.Z2(str4);
                    int i10 = ((l9.a) this.e).f20031w;
                    int intValue = ((Integer) g9.r.e.f17698c.a(sl.f10867o2)).intValue();
                    String str5 = qp0Var.U;
                    Context context3 = this.f11908b;
                    if (i10 < intValue) {
                        zsVar2.j4(str5, jSONObject5.toString(), ((aq0) wp0Var.f12312a.f4819v).f4581d, new oa.b(context3), new hj0(this, gi0Var), (as) iInterface2);
                        return;
                    }
                    String jSONObject6 = jSONObject5.toString();
                    aq0 aq0Var4 = (aq0) wp0Var.f12312a.f4819v;
                    zsVar2.p4(str5, jSONObject6, aq0Var4.f4581d, new oa.b(context3), new hj0(this, gi0Var), (as) iInterface2, aq0Var4.f4585j);
                    return;
    ...
    public vi0(Context context, x10 x10Var, l9.a aVar) {
        this.f11908b = context;
        this.f11909c = x10Var;
        this.e = aVar;
    }
