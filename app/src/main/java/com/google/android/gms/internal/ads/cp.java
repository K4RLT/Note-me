...
public final class cp implements mp {
        ...
        if (map != null) {
            ...
            if (!TextUtils.isEmpty(str)) {
                try {
                    ...
                    int i = a0.f19634b;
                    i.g("Exception occurred while getting webview content height", e);
                }
            }
        }
    }
    ...
    public static final Bundle b(Map map) {
        ...
        if (map.containsKey("networkExtras")) {
            try {
                ...
                k.C.f16817h.d("OutOfContextTestingGmsgHandler.generateNetworkExtras", e);
            }
        }
        return bundle;
    }
    ...
    public static final ArrayList c(String str, String str2) {
        try {
            ...
            k.C.f16817h.d("OutOfContextTestingGmsgHandler.stringArrayToList.".concat(str2), e);
