...
public final class mf implements s81 {
    ...
    public boolean a(long j10) {
        Object obj;
        List list = (List) ((l) this.f8338w).f18933v;
        int size = list.size();
        int i = 0;
        while (true) {
            if (i < size) {
                obj = list.get(i);
                if (s.a(((v) obj).f27357a, j10)) {
                    break;
                }
                i++;
            } else {
        ...
        synchronized (this.f8337v) {
            try {
                if (!this.f8336u) {
                    ...
                    if (application == null) {
                        int i = a0.f19634b;
                        i.f("Can not cast Context to Application");
                        return;
                    }
                    ...
                    if (!giVar.C) {
                        ...
                        giVar.D = ((Long) r.e.f17698c.a(sl.B1)).longValue();
                        giVar.C = true;
                    }
                    this.f8336u = true;
                }
    ...
    public synchronized void f(int i) {
        ...
        this.f8336u = true;
        l(new y1(i, fk0.c(i, ((gi0) this.f8337v).f6406a), "undefined", null, null));
    }
        ...
        synchronized (this.f8337v) {
            if (((ArrayDeque) this.f8338w) != null && !this.f8336u) {
                ...
                while (true) {
                    synchronized (this.f8337v) {
                        try {
                            mVar = (m) ((ArrayDeque) this.f8338w).poll();
                            if (mVar == null) {
                                this.f8336u = false;
                                return;
                            }
    ...
    public synchronized void l(y1 y1Var) {
        int i = 1;
        if (true == ((Boolean) r.e.f17698c.a(sl.f10997w6)).booleanValue()) {
            i = 3;
        }
    ...
    public mf(Context context, int i) {
        switch (i) {
            case 3:
                ExecutorService executorService = b.f20035b;
