...
public final class wj0 implements ji0 {
    ...
    public static final void c(wp0 wp0Var, qp0 qp0Var, gi0 gi0Var) {
        try {
            ...
            int i = k9.a0.f19634b;
            l9.i.g("Fail to load ad from adapter ".concat(String.valueOf(str)), e);
        }
    }
    ...
    public final Object a(wp0 wp0Var, qp0 qp0Var, gi0 gi0Var) {
        switch (this.f12250a) {
            case 0:
                ...
                zc0 zc0Var = new zc0(new j6.c(7, this, gi0Var, qp0Var), null, 0);
            ...
            default:
                ...
                zc0 zc0Var2 = new zc0(new j6.e(this, gi0Var, qp0Var), null, 0);
            ...
            case 0:
                ...
                try {
                    ...
                    if (i == 3) {
                        iq0 iq0Var = (iq0) obj;
                        try {
                            iq0Var.f7192a.V1(new oa.b(context), z2Var, jSONObject.toString(), (as) iInterface);
                            return;
                        } finally {
                        }
                    }
                    iq0 iq0Var2 = (iq0) obj;
                    try {
                        iq0Var2.f7192a.y3(new oa.b(context), z2Var, jSONObject.toString(), (as) iInterface);
                        return;
                    } finally {
                    }
                } catch (Exception e) {
                ...
                l9.i.g("Fail to load ad from adapter ".concat(String.valueOf(str2)), e);
                return;
            default:
                ...
                if (!iq0Var3.a()) {
                    ...
                    try {
                        iq0Var3.f7192a.w2(new oa.b(context2), aq0Var2.f4581d, pvVar, jSONObject2);
                        return;
                    } finally {
                    }
                }
