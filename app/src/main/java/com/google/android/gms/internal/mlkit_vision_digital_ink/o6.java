        ...
        if (i != i10) {
            ...
            for (int i12 = i; i12 < i10; i12++) {
                ...
                if (charAt < '\n') {
                    i11 = (i11 * 10) + charAt;
                    if (i11 > 999999) {
                        throw b.b("precision too large", i, i10, str);
                    }
                } else {
                    throw b.a("invalid precision character", i12, str);
                }
            }
            if (i11 == 0) {
                if (i10 == i + 1) {
                ...
                throw b.b("invalid precision", i, i10, str);
            }
            return i11;
        }
        throw b.a("missing precision", i - 1, str);
    }
