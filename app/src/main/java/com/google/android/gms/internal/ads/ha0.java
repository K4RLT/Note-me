...
public final class ha0 extends ph implements xn {
    ...
    public static float v4(a aVar) {
        Drawable drawable;
        if (aVar != null && (drawable = (Drawable) b.z1(aVar)) != null && drawable.getIntrinsicWidth() != -1 && drawable.getIntrinsicHeight() != -1) {
            ...
            case 2:
                ...
                if (f10 != 0.0f) {
                    ...
                    try {
                        ...
                        int i13 = a0.f19634b;
                        i.d("Remote exception getting video controller aspect ratio.", e);
                    }
                } else {
                    a aVar = this.f6643v;
                    if (aVar != null) {
                        f12 = v4(aVar);
                    } else if (((Boolean) r.e.f17698c.a(sl.Od)).booleanValue() && ra0Var.i() != null && (l0 = ra0Var.i().l0()) != null && (i10 = l0.f12386c) >= 0 && (i11 = l0.f12385b) > 0) {
                        f12 = i10 / i11;
                    } else {
                        zn b10 = ra0Var.b();
                        if (b10 != null) {
