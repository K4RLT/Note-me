    ...
    */
    public fv(android.content.Context r8) {
        ...
        L66:
            ...
            goto L64
        L6b:
            n r5 = b.a(r8)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L64
            java.lang.String r6 = r0.packageName     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L64
            android.content.pm.PackageInfo r3 = c(r3, r6)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L64
            if (r3 == 0) goto L64
        ...
        L9f:
            r7.f6178j = r0
            n r0 = b.a(r8)     // Catch: java.lang.Exception -> Ld7
            java.lang.String r3 = "com.android.vending"
            r5 = 128(0x80, float:1.794E-43)
            android.content.pm.PackageInfo r0 = c(r5, r3)     // Catch: java.lang.Exception -> Ld7
            if (r0 == 0) goto Ld7
    ...
    public static ResolveInfo e(PackageManager packageManager, String str) {
        try {
            ...
            k.C.f16817h.d("DeviceInfo.getResolveInfo", th);
            return null;
        }
    }
    ...
    public final void b(Context context) {
        ...
        if (audioManager != null) {
            try {
                ...
                k.C.f16817h.d("DeviceInfo.gatherAudioInfo", th);
            }
        }
    }
