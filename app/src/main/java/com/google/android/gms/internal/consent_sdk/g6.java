...
public final class g6 implements m6 {
    ...
    public static final Unsafe f13415h = i();
    ...
    */
    public final int b(com.google.android.gms.internal.consent_sdk.q5 r11) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.consent_sdk.b(com.google.android.gms.internal.consent_sdk.q5):int");
    }
    ...
    */
    public final boolean d(com.google.android.gms.internal.consent_sdk.q5 r8, com.google.android.gms.internal.consent_sdk.q5 r9) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.consent_sdk.d(com.google.android.gms.internal.consent_sdk.q5, com.google.android.gms.internal.consent_sdk.q5):boolean");
    }
    ...
    */
    public final void e(java.lang.Object r29, com.google.android.gms.internal.consent_sdk.a6 r30) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.consent_sdk.e(java.lang.Object, com.google.android.gms.internal.consent_sdk.a6):void");
    }
            ...
            while (true) {
                ...
                if (i < iArr.length) {
                    ...
                    switch (m4) {
                        ...
                        case 48:
                        case 49:
                            t5 t5Var = (t5) h(j10, obj);
                            t5 t5Var2 = (t5) h(j10, obj2);
                            int size = t5Var.size();
                        ...
                        case 50:
                            s6 s6Var = n6.f13506a;
                            c6 c6Var = (c6) h(j10, obj);
                            c6 c6Var2 = (c6) h(j10, obj2);
                            if (!c6Var2.isEmpty()) {
                                if (!c6Var.f13380u) {
                                    if (c6Var.isEmpty()) {
                                        c6Var = new c6();
    ...
    */
                ...
                if (m4 != 9 && m4 != 17) {
                    if (m4 != 27) {
                        if (m4 != 60 && m4 != 68) {
                            ...
                            if (j(i16, obj, i10) && !p(i10).h(h(n10 & 1048575, obj))) {
                            }
                            i13++;
                            i14 = i;
                            i12 = i11;
                    ...
                    List list = (List) h(n10 & 1048575, obj);
                    if (list.isEmpty()) {
                        continue;
                    } else {
                        m6 p10 = p(i10);
                    ...
                    if (w(obj, i10, i, i11, i19) && !p(i10).h(h(n10 & 1048575, obj))) {
                    }
                    i13++;
                    i14 = i;
                    i12 = i11;
    ...
    public final boolean j(int i, Object obj, int i10) {
        if (e(this.f13416a[i10 + 2] & 1048575, obj) == i) {
            return true;
        }
        return false;
    }
        ...
        if (j10 == 1048575) {
            ...
            switch (m(n10)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    if (h5.f13430w.equals(h(j11, obj))) {
                        return false;
                    }
                    break;
                case 11:
