...
public abstract class s {
    ...
    public static final w2 f14944a = w2.a(".");
            ...
            if (f14944a.b(str).size() == 1 || (str.endsWith(".lease") && !TextUtils.equals(str, ".lease"))) {
                if (!TextUtils.isEmpty(uri.getQuery())) {
                    if (uri.getQueryParameterNames().size() == 1 && uri.getQueryParameter("expiryDateSecs") != null) {
                        ...
                        throw new IOException(g3.a.k("The uri query is malformed, expected expiryDateSecs=<expiryDateSecs> but found query ", uri.getQuery()));
                    }
                }
                return;
            }
        }
        throw new IOException(g3.a.k("The uri is malformed, expected <non_empty_checksum> or <non_empty_checksum>.lease but found ", uri.getPath()));
    }
                            ...
                            for (int i12 = 65; i12 <= 90; i12++) {
                                ...
                                if (b10 == -1) {
                                    ...
                                    if (b11 == -1) {
                                        ...
                                        q.x.o(tl.e("Can't ignoreCase() since '%s' and '%s' encode different values", Character.valueOf(c13), Character.valueOf(c14)));
                                        return null;
                                    }
                                }
                            }
