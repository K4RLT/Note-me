...
public final class sm1 extends um1 {
    ...
    public sm1(byte[] bArr, int i) {
        ...
        if (((length - i) | i) >= 0) {
            ...
            x.n(i1.c("Array range is invalid. Buffer.length=", length, i, ", offset=0, length="));
            throw null;
        }
    }
    ...
    public final void I1(byte b10) {
        ...
        try {
            ...
            try {
                ...
                e = e;
                i = i10;
                throw new c(i, this.f11067x, 1, e, 2);
            }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        i10 = i15;
                        throw new c(i10, this.f11067x, 10, indexOutOfBoundsException, 2);
                    }
                } catch (IndexOutOfBoundsException e8) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        indexOutOfBoundsException = e;
                        i11 = i19;
                        throw new c(i11, this.f11067x, 1, indexOutOfBoundsException, 2);
                    }
                } catch (IndexOutOfBoundsException e8) {
                    indexOutOfBoundsException = e8;
                    i11 = i16;
    ...
    public final void O1(int i) {
        ...
        try {
            ...
            throw new c(i10, this.f11067x, 4, e, 2);
        }
    }
    ...
    public final void R1(long j10) {
        ...
        try {
            ...
            throw new c(i, this.f11067x, 8, e, 2);
        }
    }
    ...
    public final void U1(byte[] bArr, int i, int i10) {
        try {
            ...
            throw new c(this.f11068y, this.f11067x, i10, e, 2);
        }
    }
