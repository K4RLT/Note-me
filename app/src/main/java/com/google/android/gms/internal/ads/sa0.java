...
public final class sa0 extends ta0 {
    ...
    public sa0(qp0 qp0Var, JSONObject jSONObject) {
        ...
        JSONObject k3 = g9.k(jSONObject, strArr);
        if (k3 == null) {
            optJSONObject = null;
        } else {
        ...
        JSONObject k4 = g9.k(jSONObject, strArr2);
        if (k4 == null) {
            optBoolean = false;
        } else {
        ...
        JSONObject k10 = g9.k(jSONObject, strArr3);
        if (k10 == null) {
            optBoolean2 = false;
        } else {
        ...
        JSONObject k11 = g9.k(jSONObject, strArr4);
        if (k11 == null) {
            optBoolean3 = false;
        } else {
        ...
        JSONObject k12 = g9.k(jSONObject, strArr5);
