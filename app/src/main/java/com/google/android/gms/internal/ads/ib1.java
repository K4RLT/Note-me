    ...
    public static ib1 h0(kb1 kb1Var, bl0 bl0Var, Integer num) {
        ...
        if (gl1Var.f6427a.length == 32) {
            if (q91Var == q91Var2) {
                ...
                q.x.o("Unknown Variant: ".concat(q91Var.f9792v));
                return null;
            }
            return new ib1(kb1Var, bl0Var, b10, num);
        }
        int length = gl1Var.f6427a.length;
        throw new GeneralSecurityException(a5.a.f(length, "XAesGcmKey key must be constructed with key of length 32 bytes, not ", new StringBuilder(String.valueOf(length).length() + 68)));
    }
