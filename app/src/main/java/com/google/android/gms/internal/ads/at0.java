...
public final class at0 {
    ...
    public at0(c0 c0Var, ScheduledExecutorService scheduledExecutorService, bl0 bl0Var, a aVar) {
        this.f4606a = c0Var;
    ...
    public final void b(dt0 dt0Var, boolean z3) {
        ...
        String r8 = dt0Var.r();
        s a10 = ((be0) this.f4611g.f4819v).a();
    ...
    public final void c(dt0 dt0Var, int i) {
        ...
        if (!this.f4607b.get() && dt0Var.t() == 0 && dt0Var.u()) {
            dt0Var.k();
            k(((Long) r.e.f17698c.a(sl.f10692d0)).longValue());
            return;
        }
        k(0L);
    }
    ...
    public final void h(dt0 dt0Var) {
        if (dt0Var.t() > 0 || dt0Var.f5504m.get()) {
            this.f4610f.execute(new a(this, 24, dt0Var));
        }
    ...
    public final void l() {
        ...
        if (e() >= f10 && !j()) {
            ...
            if (e() < f10 || j()) {
                ...
                synchronized (this) {
                    this.f4608c = this.f4610f.schedule(new zs0(this, 3), ((Long) r.e.f17698c.a(sl.f10706e0)).longValue(), TimeUnit.MILLISECONDS);
                }
                return;
            }
        }
