    ...
    public final void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str) {
        switch (this.f12640a) {
            ...
            case 1:
                ...
                fe0Var.i.set(f9.b(fe0Var.f6046b, (String) this.f12641b));
                return;
            case 2:
                if (str != null && ((List) this.f12642c).contains(str)) {
                    try {
                        ...
                        k.C.f16817h.e("InspectorSharedPreferenceCollector.onSharedPreferenceChanged", e);
                        return;
                    }
                }
                return;
            default:
                w wVar = (w) this.f12642c;
                synchronized (wVar) {
                    try {
