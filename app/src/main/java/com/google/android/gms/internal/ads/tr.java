...
public final class tr extends ph implements vr {
    ...
    public final boolean C(String str) {
        try {
            return n9.a.class.isAssignableFrom(Class.forName(str, false, tr.class.getClassLoader()));
    ...
    public final xr o(String str) {
        try {
            try {
                ...
                if (n9.g.class.isAssignableFrom(cls)) {
                    return new ks((n9.g) cls.getDeclaredConstructor(null).newInstance(null));
                }
                if (n9.a.class.isAssignableFrom(cls)) {
                    return new ks((n9.a) cls.getDeclaredConstructor(null).newInstance(null));
                }
                ...
                l9.i.a("Reflection failed, retrying using direct instantiation");
    ...
    public final boolean t(String str) {
        try {
            return o9.a.class.isAssignableFrom(Class.forName(str, false, tr.class.getClassLoader()));
        } catch (Throwable unused) {
