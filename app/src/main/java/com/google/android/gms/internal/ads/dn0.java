    ...
    public final void l(Object obj) {
        switch (this.f5465a) {
            case 0:
                ...
                if (!hashMap.isEmpty()) {
                    if (((Boolean) g9.r.e.f17698c.a(sl.K8)).booleanValue()) {
                        k91 A = n91.A();
                    ...
                    for (Map.Entry entry2 : hashMap.entrySet()) {
                        ...
                        if (!arrayDeque2.isEmpty()) {
                            ...
                            try {
                                ...
                                k9.a0.l("Failed putting the on-device storage record.", e);
                            }
                        }
                    }
            ...
            default:
                try {
                    ((JSONObject) obj).put("video_decoders", g9.p.f17688g.f17689a.k(this.f5466b));
                    return;
                } catch (JSONException e8) {
                    k9.a0.k("Could not encode video decoder properties: ".concat(String.valueOf(e8.getMessage())));
                    return;
                }
        }
    }
