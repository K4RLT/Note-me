...
public abstract class r71 extends z71 {
    ...
    public static void s(Runnable runnable, Executor executor) {
        try {
            ...
            a10.logp(level, "com.google.common.util.concurrent.AbstractFuture", "executeListener", a.l(new StringBuilder(valueOf.length() + 57 + valueOf2.length()), "RuntimeException while executing runnable ", valueOf, " with executor ", valueOf2), (Throwable) e);
        }
    }
    ...
    */
    ...
    public Object get(long j10, TimeUnit timeUnit) {
        ...
        if (!Thread.interrupted()) {
            ...
            throw new TimeoutException(a.o(new StringBuilder(sb3.length() + 5 + String.valueOf(r71Var).length()), sb3, " for ", r71Var));
        }
        throw new InterruptedException();
    }
