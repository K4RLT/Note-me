...
public final /* synthetic */ class iv1 implements Runnable {
    ...
    private final void a() {
        ...
        a0 a0Var = (a0) this.f7236v;
        l lVar = (l) a0Var.f3898v;
    ...
    /* JADX WARN: Type inference failed for: r6v10, types: [java.lang.Object, b] */
        ...
        switch (this.f7235u) {
            ...
            case 5:
                ...
                try {
                    ...
                    hVar2.a(new a("Internal error has occurred when executing ML Kit tasks", e8));
                    return;
                }
            case 6:
                b bVar = (b) this.f7236v;
                z zVar = (z) this.f7237w;
                c cVar = (c) zVar.f3437v;
                l lVar = (l) ((d) zVar.f3441z).D.get((a) zVar.f3438w);
                if (lVar != null) {
                    if (bVar.f4022v == 0) {
                        zVar.f3436u = true;
                        if (cVar.l()) {
                            if (zVar.f3436u && (iVar = (i) zVar.f3439x) != null) {
                        ...
                        try {
                            ...
                            lVar.l(new b(10, null, null), null);
                            return;
                        }
                    }
                    lVar.l(bVar, null);
            ...
            case 7:
                ...
                try {
                    ...
                    Bundle bundle2 = (Bundle) com.google.android.gms.internal.measurement.a(t12, Bundle.CREATOR);
                    t12.recycle();
                    if (bundle2 == null) {
                        d1.d(k0Var);
            ...
            case 8:
                h3 h3Var = ((f1) this.f7237w).f16128u;
                h3Var.Z();
                d dVar = (d) this.f7236v;
                ...
                return;
            case 9:
                t1 t1Var = (t1) this.f7236v;
                String str5 = (String) this.f7237w;
                d1 d1Var3 = (d1) t1Var.f3443v;
                g0 m4 = d1Var3.m();
                String str6 = m4.K;
            ...
            case 12:
                ...
                try {
                    k2 k2Var = (k2) this.f7236v;
                    if (k2Var == null) {
                        d0Var.j2(0L, null, null, ((d1) n2Var.f3443v).f16102u.getPackageName());
                    } else {
                        d0Var.j2(k2Var.f16208c, k2Var.f16206a, k2Var.f16207b, ((d1) n2Var.f3443v).f16102u.getPackageName());
                    }
                    n2Var.O();
                    return;
            ...
            case 13:
                o3 o3Var = (o3) this.f7236v;
                n2 n2Var2 = (n2) this.f7237w;
            ...
            case 14:
                n2 n2Var3 = ((r2) this.f7237w).f16355w;
                ...
                return;
            case 15:
                ((k) ((e2) this.f7236v).f17624m).addView((View) b.z1((a) this.f7237w));
                return;
            case 16:
                k kVar = (k) this.f7237w;
                o oVar = kVar.f18375x;
                try {
                    o oVar2 = (o) kVar.f18374w.g((o) this.f7236v);
                    if (oVar2 == null) {
            ...
            case 17:
                synchronized (((l) this.f7237w).f18378w) {
                    try {
                        e eVar = (e) ((l) this.f7237w).f18379x;
                        if (eVar != null) {
                            eVar.d(((o) this.f7236v).j());
                        }
                    } finally {
                    }
                }
                return;
            case 18:
                ((d) ((nx) this.f7236v).f8887x).f19064v.getWindow().setBackgroundDrawable((BitmapDrawable) this.f7237w);
                return;
            case 19:
                if (!(((q) this.f7237w).f19575u.f19962u instanceof a)) {
                    try {
                        h hVar3 = (h) ((j) this.f7236v).get();
                        if (hVar3 != null) {
                            q.d().a(q.A, "Updating notification for " + ((q) this.f7237w).f19577w.f18946c);
                            q qVar = (q) this.f7237w;
                            j jVar = qVar.f19575u;
                            r rVar = qVar.f19579y;
                        ...
                        throw new IllegalStateException("Worker was marked important (" + ((q) this.f7237w).f19577w.f18946c + ") but did not provide ForegroundInfo");
                    } catch (Throwable th2) {
                        ((q) this.f7237w).f19575u.l(th2);
                        return;
                    }
                }
                return;
            case 20:
                c0 c0Var = (c0) this.f7236v;
                ...
                try {
                    synchronized (c0Var.f19642a) {
                        try {
                            ...
                            if (((Boolean) pm.f9550g.p()).booleanValue() && r.e.f17698c.f9873j) {
                            ...
                            try {
                                ...
                                int i10 = a0.f19634b;
                                i.g("Could not convert native advanced settings to json object", e16);
                            }
                            c0Var.j();
                        } catch (Throwable th3) {
                            throw th3;
                    ...
                    k.C.f16817h.d("AdSharedPreferenceManagerImpl.initializeOnBackgroundThread", th4);
                    a0.l("AdSharedPreferenceManagerImpl.initializeOnBackgroundThread, errorMessage = ", th4);
                    return;
                }
            case gl.zzm /* 21 */:
                ((w0) this.f7236v).f20296b.b((Intent) this.f7237w);
                return;
            case 22:
                ((e) this.f7237w).f20411v.d((Bundle) this.f7236v);
                return;
            case 23:
                q.a((q) this.f7237w, (com.google.android.gms.internal.mlkit_vision_digital_ink.lw) this.f7236v);
                return;
            case 24:
                ((d) ((c) this.f7236v).f23625x).f23628c.remove((String) this.f7237w);
                return;
            case 25:
                a();
                return;
            case 26:
                d dVar3 = (d) this.f7236v;
                Bundle bundle4 = (Bundle) this.f7237w;
                try {
                    g gVar = (g) dVar3.f23627b.f23655k;
                    if (gVar != null) {
                        c cVar2 = dVar3.f23629d;
                        e eVar2 = (e) gVar;
                        Parcel o12 = eVar2.o1();
                        int i11 = a.f32013a;
                        o12.writeInt(1);
            ...
            case 27:
                ...
                return;
            case 28:
                a aVar = (a) this.f7236v;
                String str7 = (String) this.f7237w;
                WebView webView = aVar.f25037b;
                Context context2 = aVar.f25036a;
                Uri parse = Uri.parse(str7);
                try {
                    if (((Boolean) r.e.f17698c.a(sl.f10988vd)).booleanValue() && (cq0Var = aVar.f25039d) != null) {
                    ...
                    int i12 = a0.f19634b;
                    i.b("Failed to append the click signal to URL: ", e19);
                    k.C.f16817h.d("TaggingLibraryJsInterface.recordClick", e19);
                }
                aVar.i.b(parse.toString(), null, null, null);
                return;
            default:
                e eVar3 = (e) this.f7236v;
                try {
                    eVar3.f31982b.I3(b3.a(eVar3.f31981a, (d2) this.f7237w));
                    return;
                } catch (RemoteException e20) {
                    i.d("Failed to load ad.", e20);
                    return;
                }
        }
    }
