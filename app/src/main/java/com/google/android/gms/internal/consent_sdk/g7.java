    ...
    public final void run() {
        ...
        switch (this.f13421u) {
            case 0:
                ...
                c cVar = (c) this.f13425y;
                final d dVar = (d) this.f13426z;
                try {
                    Log.i("UserMessagingPlatform", "Use new ConsentDebugSettings.Builder().addTestDeviceHashedId(\"" + a((Application) lwVar.f14643u) + "\") to set this as a debug device.");
                    ...
                    y yVar2 = (y) lwVar.C;
                    yVar2.a((Queue) yVar2.f13611f.get(), 8, 9, a.l("RequestConsentUpdate exception. Error: ", e.getMessage(), ", cause: ", String.valueOf(e.getCause())));
                    final int i10 = 0;
            ...
            case 5:
                try {
                    if (!(((j) this.f13422v).f19962u instanceof a)) {
                        String uuid = ((UUID) this.f13423w).toString();
                        p j10 = ((r) this.f13426z).f19583c.j(uuid);
                        if (j10 != null && !a.a(j10.f18945b)) {
                            ((r) this.f13426z).f19582b.g(uuid, (h) this.f13424x);
                            ((Context) this.f13425y).startService(a.a((Context) this.f13425y, y8.a(j10), (h) this.f13424x));
                        } else {
                            throw new IllegalStateException("Calls to setForegroundAsync() must complete before a ListenableWorker signals completion of work by returning an instance of Result.");
                        }
                    }
                    ((j) this.f13422v).j(null);
                    return;
                } catch (Throwable th) {
                    ((j) this.f13422v).l(th);
                    return;
