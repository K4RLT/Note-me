...
public abstract class n9 extends s9 {
    ...
    public static void s(Runnable runnable, Executor executor) {
        try {
            ...
            s9.f14966y.a().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "executeListener", a.l("RuntimeException while executing runnable ", String.valueOf(runnable), " with executor ", String.valueOf(executor)), (Throwable) e);
        }
    }
    ...
    */
    public java.lang.String toString() {
        ...
        L99:
            ...
            goto Ld2
        L9d:
            java.lang.String r3 = d()     // Catch: java.lang.Throwable -> Lac
            r4 = 0
            if (r3 == 0) goto Laa
