...
public final class tf implements r0, b71, qb, nv0, b, c, ay, zx, b, s81, n80, a10, xg0, s90 {
    ...
    public void g0() {
        ...
        synchronized (k60Var.f7669d) {
            try {
                ...
                int i = a0.f19634b;
                i.d("Unable to obtain a cache service instance.", e);
                ((k60) this.f11339v).h();
            }
    ...
    */
    public void i(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.i(int):void");
    }
    ...
    public /* synthetic */ void mo202r(Object obj) {
        switch (this.f11338u) {
            case 13:
                mw.f8437l.remove((b) this.f11339v);
                return;
            case 15:
            ...
            default:
                try {
                    ...
                    int i = a0.f19634b;
                    i.c("Error executing function on offline buffered ping database: ".concat(valueOf));
                    return;
                }
        }
    }
    ...
    public void t(Throwable th) {
        switch (this.f11338u) {
            ...
            default:
                ...
                int i = a0.f19634b;
                i.c("Failed to get offline buffered ping database: ".concat(valueOf));
                return;
        }
    }
    ...
    public void mo212zza() {
        a0.k("Rejecting reference for JS Engine.");
        boolean booleanValue = ((Boolean) r.e.f17698c.a(sl.C8)).booleanValue();
