    ...
    public final ac.b l(Object obj) {
        ...
        switch (this.f5480a) {
            ...
            case 1:
                ...
                if (map != null) {
                    try {
                        ...
                        if (((Boolean) en.f5728a.p()).booleanValue()) {
                            ...
                            l9.i.b("Failed to get SafeBrowsing metadata", e);
                        }
                ...
                if ((z10 && mwVar.f8443g.A) || ((mwVar.f8446k && mwVar.f8443g.f8883z) || (!z10 && mwVar.f8443g.f8881x))) {
                    synchronized (mwVar.f8444h) {
                        try {
                            ...
                            k9.p a10 = new k9.r(mwVar.e).a(1, mwVar.f8443g.f8879v, null, ((qq1) pp1Var3.c()).b());
                            if (((Boolean) en.f5728a.p()).booleanValue()) {
                ...
                return v81.f11836v;
            case 2:
                String str2 = (String) g9.r.e.f17698c.a(sl.Eb);
            ...
            case 8:
                ...
                if (((Boolean) g9.r.e.f17698c.a(sl.Y2)).booleanValue()) {
