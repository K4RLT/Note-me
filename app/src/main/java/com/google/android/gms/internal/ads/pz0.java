...
public final class pz0 {
    ...
    public final ExecutorService f9676b;

    /* renamed from: c, reason: collision with root package name */
    public final hz0 f9677c;

    /* renamed from: d, reason: collision with root package name */
    public final oz0 f9678d;
    public final h21 e;

    /* renamed from: f, reason: collision with root package name */
    public final j51 f9679f;

    /* renamed from: g, reason: collision with root package name */
    public final HashMap f9680g = new HashMap();
    ...
    public DexClassLoader f9684l;

    public pz0(Context context, ExecutorService executorService, hz0 hz0Var, oz0 oz0Var, File file, h21 h21Var, long j10, j51 j51Var) {
        this.f9675a = context;
        this.f9676b = executorService;
        this.f9677c = hz0Var;
        this.f9678d = oz0Var;
        this.e = h21Var;
        this.f9679f = j51Var;
    ...
    /* JADX WARN: Not initialized variable reg: 0, insn: 0x027c: INVOKE (r0 I:com.google.android.gms.internal.ads.g21) VIRTUAL call: com.google.android.gms.internal.ads.g21.c():void A[Catch: all -> 0x027a, MD:():void (m), TRY_ENTER] (LINE:637), block:B:126:0x027c */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:41:0x01a3 -> B:24:0x01c3). Please report as a decompilation issue!!! */
    public final synchronized void a() {
        ...
        try {
            g21 a10 = this.e.a(201);
            try {
                a10.a();
                try {
                    try {
                        t3 = ay0.t("iKHMntktcfofy0pndIy1zXoYKP/mAP25GxAfIXnQTdI=", false);
            ...
            if (t3.length == 32) {
                ...
                ByteBuffer.wrap(t3, 4, 16).get(bArr);
                for (int i = 0; i < 16; i++) {
                ...
                try {
                    ...
                    StringBuilder sb2 = new StringBuilder(obj.length() + 18);
                    sb2.append(obj);
                    sb2.append("/");
                    ...
                    if (!file2.exists()) {
                        ...
                        try {
                            ...
                            fileOutputStream2.write(a11, 0, a11.length);
                    ...
                    if (file4.exists()) {
                        ...
                        StringBuilder sb4 = new StringBuilder(obj3.length() + 18);
                        sb4.append(obj3);
                        sb4.append("/");
                        sb4.append("1779220303675");
                        sb4.append(".dex");
                        File file5 = new File(sb4.toString());
                        if (!file5.exists()) {
                            try {
                                length = file4.length();
                            } catch (nz0 | IOException | NullPointerException unused) {
                            ...
                            if (length <= 0) {
                                ...
                                try {
                                    try {
                                    } catch (nz0 | IOException | NullPointerException unused2) {
                                        fileOutputStream = null;
                                    }
                                    if (fileInputStream.read(bArr3) <= 0) {
                                        ...
                                        int i10 = em1.f5727a;
                                        ne D = ne.D(bArr3, wm1.f12303b);
                                        if ("1779220303675".equals(new String(D.B().a())) && Arrays.equals(D.A().a(), this.f9677c.c(D.z().a())) && Arrays.equals(D.C().a(), Build.VERSION.SDK.getBytes())) {
                                            oz0 oz0Var2 = this.f9678d;
                                            byte[] bArr4 = this.f9683k;
                                            String str = new String(D.z().a());
                                            oz0Var2.getClass();
                                            byte[] a12 = oz0.a(str, bArr4);
                                            file5.createNewFile();
                                            fileOutputStream = new FileOutputStream(file5);
                                            try {
                                                fileOutputStream.write(a12, 0, a12.length);
                                            } catch (nz0 | IOException | NullPointerException unused3) {
                                            } catch (Throwable th4) {
                                                th = th4;
                    ...
                    try {
                        this.f9684l = new DexClassLoader(file2.getAbsolutePath(), this.i.getAbsolutePath(), null, this.f9675a.getClassLoader());
                        for (qz0 qz0Var : this.f9679f) {
                            Pair create = Pair.create(qz0Var.f10042a, qz0Var.f10043b);
                            HashMap hashMap = this.f9680g;
                            if (!hashMap.containsKey(create)) {
                                hashMap.put(create, this.f9676b.submit(new xe(this, 11, qz0Var)));
                            }
                        }
                        this.f9682j = true;
                        a10.c();
    ...
    public final Method b(String str, String str2) {
        Future future = (Future) this.f9680g.get(new Pair(str, str2));
        h21 h21Var = this.e;
        if (future == null) {
            h21Var.b(302);
            return null;
        ...
        try {
            return (Method) future.get(this.f9681h, TimeUnit.MILLISECONDS);
