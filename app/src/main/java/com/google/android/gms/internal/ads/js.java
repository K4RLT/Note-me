...
public final class js implements n9.f {
    ...
    /* JADX WARN: Type inference failed for: r1v4, types: [ig.h, java.lang.Object] */
    public ig.i e(SSLSocket sSLSocket) {
        boolean z3;
        ig.i iVar;
        ...
        if (iVar != null) {
            ...
            while (true) {
                if (i10 < list.size()) {
                    if (((ig.i) list.get(i10)).a(sSLSocket)) {
                        break;
                    }
                    i10++;
                } else {
            ...
            if (r02 != 0) {
                enabledProtocols = jg.b.m(jg.b.f19203f, sSLSocket.getEnabledProtocols(), r02);
            } else {
                enabledProtocols = sSLSocket.getEnabledProtocols();
            }
            String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
            ig.e eVar = ig.f.f18478b;
    ...
    public void f(Object obj, String str) {
        ((eb.k0) this.f7523d).B(this.f7520a, this.f7521b, this.f7522c, str, obj, null, null);
    }

    public void g(String str) {
        ((eb.k0) this.f7523d).B(this.f7520a, this.f7521b, this.f7522c, str, null, null, null);
    }

    public void h(String str, Object obj, Object obj2) {
        ((eb.k0) this.f7523d).B(this.f7520a, this.f7521b, this.f7522c, str, obj, obj2, null);
    }

    public void i(String str, Object obj, Object obj2, Object obj3) {
        ((eb.k0) this.f7523d).B(this.f7520a, this.f7521b, this.f7522c, str, obj, obj2, obj3);
    }

    public js(eb.k0 k0Var, int i, boolean z3, boolean z9) {
        this.f7523d = k0Var;
        this.f7520a = i;
        this.f7521b = z3;
        this.f7522c = z9;
