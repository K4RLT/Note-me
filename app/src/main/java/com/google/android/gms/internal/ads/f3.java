...
public final class f3 implements o2, p2, dr0, d {
    ...
    public static final void j(be0 be0Var, String str, long j10) {
        if (be0Var != null) {
            if (((Boolean) r.e.f17698c.a(sl.f10719ee)).booleanValue()) {
                s a10 = be0Var.a();
    ...
    public long d(t tVar, float f10) {
        float abs;
        long j10;
        long h3 = b.h(this.f5899v, b.g(tVar.f27343c, tVar.f27346g));
        this.f5899v = h3;
        z0 z0Var = (z0) this.f5900w;
        if (z0Var == null) {
            abs = b.d(h3);
        } else {
            abs = Math.abs(g(h3));
        ...
        if (abs >= f10) {
            ...
            if (z0Var == null) {
                return b.g(this.f5899v, b.i(b.b(j11, b.d(j11)), f10));
            }
    ...
    public void i(Context context, a aVar, boolean z3, mx mxVar, String str, String str2, Runnable runnable, final vr0 vr0Var, final be0 be0Var, final Long l10, boolean z9) {
        PackageInfo c10;
        k kVar = k.C;
        a aVar2 = kVar.f16819k;
        a aVar3 = kVar.f16819k;
        aVar2.getClass();
        if (SystemClock.elapsedRealtime() - this.f5899v < 5000) {
            int i = a0.f19634b;
            i.f("Not retrying to fetch app settings");
            return;
        }
        aVar3.getClass();
        ...
        if (mxVar != null && !TextUtils.isEmpty(mxVar.e)) {
            ...
            aVar3.getClass();
            if (System.currentTimeMillis() - j10 <= ((Long) r.e.f17698c.a(sl.f10648a5)).longValue() && mxVar.f8477h) {
                return;
            }
        }
        if (context == null) {
            int i10 = a0.f19634b;
            i.f("Context not provided to fetch application settings");
            return;
        }
        if (TextUtils.isEmpty(str) && TextUtils.isEmpty(str2)) {
            int i11 = a0.f19634b;
            i.f("App settings could not be fetched. Required parameters missing");
            return;
        }
        ...
        try {
            ...
            try {
                ...
                if (applicationInfo != null && (c10 = b.a(context).c(0, applicationInfo.packageName)) != null) {
                ...
                public final b l(Object obj) {
                    ...
                    if (optBoolean) {
                        ...
                        if (l11 != null) {
                            ...
                            j(be0Var2, "cld_s", SystemClock.elapsedRealtime() - l11.longValue());
                        }
                    }
            ...
            int i14 = a0.f19634b;
            i.d("Error requesting application settings", e);
            d2.b(e);
            d2.a(false);
            vr0Var.b(d2.m());
        }
    ...
    public Object l(Object obj) {
        ...
        if (!((c0) ((mh0) this.f5900w).f3468b).t()) {
    ...
    public void w(Exception exc) {
        switch (this.f5898u) {
            case 6:
                e eVar = (e) this.f5900w;
                ((AtomicLong) eVar.f18919v).set(this.f5899v);
                return;
            default:
                m mVar = (m) this.f5900w;
