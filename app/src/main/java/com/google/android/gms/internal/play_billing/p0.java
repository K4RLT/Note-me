        ...
        try {
            if (r0Var.isDone()) {
                ...
                if (intValue > 0) {
                    ...
                    b0Var.getClass();
                    c7.f a10 = c7.a(intValue2, "Billing override value was set by a license tester.");
                    b0Var.J(93, i, a10);
                    ((a) qVar.f3158v).accept(a10);
                    return;
                }
                ((Runnable) qVar.f3159w).run();
                return;
            }
            throw new IllegalStateException(wa.a("Future was expected to be done: %s", r0Var));
