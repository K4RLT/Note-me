...
public final class pu0 extends WebViewClient {
    ...
    public void onReceivedError(WebView webView, int i, String str, String str2) {
        switch (this.f9612a) {
            case 1:
                u uVar = ((com.google.android.gms.internal.consent_sdk.q) this.f9613b).f13529v;
                uVar.getClass();
    ...
    public boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        switch (this.f9612a) {
            case 0:
                ...
                Log.w("NativeBridge", a.l(new StringBuilder(String.valueOf(obj).length() + 36 + valueOf.length()), "WebView renderer gone: ", obj, "for WebView: ", valueOf));
            ...
            case 2:
                ...
                if (str.startsWith("gmsg://adResized")) {
                    ...
                    if (!TextUtils.isEmpty(queryParameter)) {
                        try {
                            ...
                            i10 = d.b(context, Integer.parseInt(queryParameter));
                ...
                if (xVar6 != null) {
                    try {
                        ...
                        int i17 = a0.f19634b;
                        i.i(e13, "#007 Could not call remote method.");
                    }
                }
