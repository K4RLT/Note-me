...
public class r61 {
    ...
    public int b(byte[] bArr, CharSequence charSequence) {
        ...
        throw new IOException(a.f(length2, "Invalid input length ", new StringBuilder(String.valueOf(length2).length() + 21)));
    }
                            ...
                            for (int i12 = 65; i12 <= 90; i12++) {
                                ...
                                if (b10 == -1) {
                                    ...
                                    if (b11 == -1) {
                                        ...
                                        x.o(ay0.B("Can't ignoreCase() since '%s' and '%s' encode different values", Character.valueOf(c12), Character.valueOf(c13)));
                                        return null;
                                    }
                                }
                            }
