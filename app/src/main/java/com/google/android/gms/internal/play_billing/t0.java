...
public final class t0 extends k0 implements r0 {
    ...
    public static void l(Runnable runnable, Executor executor) {
        try {
            ...
            k0.f15471y.a().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "executeListener", p.a.l("RuntimeException while executing runnable ", String.valueOf(runnable), " with executor ", String.valueOf(executor)), (Throwable) e);
        }
    }
    ...
    */
    ...
    public final String e() {
        ...
        if (r0Var != null) {
            String k3 = p.a.k("inputFuture=[", r0Var.toString(), "]");
            if (scheduledFuture != null) {
