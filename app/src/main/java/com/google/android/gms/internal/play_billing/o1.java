...
public abstract class o1 {
    public static a4.b a(String str, u.c cVar) {
        wf.e eVar = pf.l0.f22767a;
        wf.d dVar = wf.d.f29913w;
        pf.t1 d2 = pf.b0.d();
        dVar.getClass();
        uf.c b10 = pf.b0.b(lc.c(dVar, d2));
        str.getClass();
        return new a4.b(str, cVar, a4.a.f237u, b10);
    }
    ...
    */
    public static com.google.android.gms.internal.play_billing.k1 b() {
        ...
        La4:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.o1.b():com.google.android.gms.internal.play_billing.k1");
    }
}
