...
public final class e60 implements k70, c70, b70 {
    ...
    public final la.a f5602z;

    public e60(Context context, qp0 qp0Var, h00 h00Var, wp0 wp0Var, la.a aVar, be0 be0Var, b60 b60Var) {
        this.f5597u = context;
        this.f5600x = qp0Var;
        this.f5601y = h00Var;
        this.f5602z = aVar;
    ...
    public final void a(long j10, Bundle bundle, String str, String str2) {
        ...
        String str4 = null;
        if (bundle != null) {
            str3 = new l9.d().l(bundle, new JSONObject()).toString();
        } else {
            str3 = null;
        }
    ...
    public final void c(Context context) {
        du duVar = this.f5600x.f9931d0;
        if (duVar != null && g()) {
            if (((Boolean) g9.r.e.f17698c.a(sl.f10928re)).booleanValue()) {
                String str = duVar.e;
                if (!TextUtils.isEmpty(str)) {
                    try {
                        b60 b60Var = this.C;
                        Context context2 = this.f5597u;
                        h9.c a10 = b60Var.a(context2);
                        if (a10 != null) {
                            a10.endSession(new oa.b(context2), str);
                        }
                    } catch (Throwable th) {
    ...
    public final void d(String str, Bundle bundle) {
        try {
            ...
            h9.c a10 = b60Var.a(context);
            if (a10 != null) {
                a10.prewarm(new oa.b(context), arrayList, d60Var);
            }
        } catch (Throwable th) {
    ...
    public final void e() {
        ...
        if (duVar != null && duVar.f5515a) {
            if (g()) {
                if (h(1)) {
                    b(h(2), ((Boolean) g9.r.e.f17698c.a(sl.f10989ve)).booleanValue());
                    return;
                }
                return;
            }
    ...
    public final void f(String str, Throwable th) {
        boolean booleanValue = ((Boolean) g9.r.e.f17698c.a(sl.f10958te)).booleanValue();
        Context context = this.f5597u;
        if (booleanValue) {
            if (this.f5599w == null) {
    ...
    public final boolean g() {
        du duVar;
        if (((Boolean) g9.r.e.f17698c.a(sl.f10913qe)).booleanValue() && (duVar = this.f5600x.f9931d0) != null && duVar.f5518d) {
            return true;
        }
        return false;
    }
    ...
    public final void y() {
        ...
        if (duVar != null && duVar.f5515a) {
            if (g()) {
                if (h(4)) {
                    b(h(8), ((Boolean) g9.r.e.f17698c.a(sl.f10974ue)).booleanValue());
                    return;
                }
                return;
            }
