    ...
    public final boolean u4(int i, Parcel parcel, Parcel parcel2) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                qh.f(parcel);
                i iVar = (i) this;
                if (((Boolean) r.e.f17698c.a(sl.f11016x8)).booleanValue()) {
                    MotionEvent motionEvent = (MotionEvent) b.z1(v13);
                    nu nuVar = iVar.C;
                    if (nuVar != null) {
                        view = nuVar.f8865u;
                    }
            ...
            case 5:
                ...
                qh.f(parcel);
                ((i) this).v4(createTypedArrayList, v14, v4, false);
                parcel2.writeNoException();
                return true;
            case 6:
                ...
                qh.f(parcel);
                ((i) this).w4(createTypedArrayList2, v15, v42, false);
                parcel2.writeNoException();
                return true;
            case 7:
            ...
            case 8:
                ...
                if (((Boolean) qlVar.a(nlVar)).booleanValue()) {
                    ...
                    WebView webView = (WebView) b.z1(v16);
                    if (webView == null) {
                        int i11 = a0.f19634b;
                        i.c("The webView cannot be null.");
                    } else {
                        b bVar2 = iVar3.f25069a0;
                        o oVar = new o(webView, bVar2, xx.f12655f);
                        webView.addJavascriptInterface(new a(webView, iVar3.f25072x, iVar3.F, iVar3.G, iVar3.f25073y, iVar3.Z, bVar2, oVar), "gmaSdk");
                        if (((Boolean) qlVar.a(sl.f10749gb)).booleanValue()) {
                            k.C.f16817h.f9641l.incrementAndGet();
                        }
                        if (((Boolean) bn.f4838c.p()).booleanValue()) {
                            bVar2.a(webView);
                            if (((Boolean) bn.f4839d.p()).booleanValue()) {
                                oVar.f25093d = xx.f12654d.scheduleWithFixedDelay(new n(oVar, i10), 0L, ((Integer) qlVar.a(sl.f10765hb)).intValue(), TimeUnit.MILLISECONDS);
                            }
                        }
                        if (((Boolean) qlVar.a(nlVar2)).booleanValue()) {
                            iVar3.x4();
            ...
            case 9:
                ...
                qh.f(parcel);
                ((i) this).v4(createTypedArrayList3, v17, v43, true);
                parcel2.writeNoException();
                return true;
            case 10:
                ...
                qh.f(parcel);
                ((i) this).w4(createTypedArrayList4, v18, v44, true);
                parcel2.writeNoException();
                return true;
            case 11:
                ...
                qh.f(parcel);
                i iVar4 = (i) this;
                if (!((Boolean) r.e.f17698c.a(sl.f10812kb)).booleanValue()) {
                    bVar = new b(null);
                } else {
                    Context context = (Context) b.z1(v19);
                    f fVar = (f) b.z1(v110);
                    a aVar = (a) b.z1(v111);
                    fm fmVar = iVar4.Y;
                    fmVar.getClass();
                    if (context != null) {
                        if (!TextUtils.isEmpty(readString)) {
                            if (fVar != null) {
                                ...
                                if (c10 == null) {
                                    int i12 = a0.f19634b;
                                    i.c("CustomTabsClient failed to create new session.");
                                }
                                zb.d(fe0Var, "pact_action", new Pair("pe", "pact_init"));
                                ...
                                bVar = new b(fmVar.f6112g);
                            } else {
                                x.n("CustomTabsClient parameter is null");
                                return false;
                            }
                        } else {
                            x.n("Origin parameter is empty or null");
                            return false;
                        }
                    } else {
                        x.n("App Context parameter is null");
                        return false;
                    }
                }
                parcel2.writeNoException();
