    ...
    public static int a(Context context, Map map, String str, int i) {
        ...
        if (str2 != null) {
            try {
                ...
                i = d.b(context, Integer.parseInt(str2));
            } catch (NumberFormatException unused) {
                String l10 = a.l(new StringBuilder(str.length() + 34 + str2.length()), "Could not parse ", str, " in a video GMSG: ", str2);
                int i10 = a0.f19634b;
                i.f(l10);
            }
        }
        if (a0.m()) {
            ...
            a.t(sb2, "Parse pixels for ", str, ", got string ", str2);
            sb2.append(", int ");
            sb2.append(i);
            sb2.append(".");
            a0.k(sb2.toString());
    ...
    public static void b(ly lyVar, Map map) {
        ...
        if (str != null) {
            try {
                ...
                String h3 = a.h("Could not parse buffer parameters in loadControl video GMSG: (", str, ", ", str2, ")");
                int i = a0.f19634b;
                i.f(h3);
                return;
            }
