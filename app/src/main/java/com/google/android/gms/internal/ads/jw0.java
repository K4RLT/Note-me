...
public final class jw0 implements Closeable {
    ...
    public final HttpURLConnection f(x91 x91Var) {
        ...
        x91Var2.getClass();
        Set set = kz.f7905z;
        fp fpVar = k.C.f16825q;
        int intValue = ((Integer) r.e.f17698c.a(sl.f10786j0)).intValue();
        ...
        while (true) {
            ...
            if (i <= 20) {
                ...
                if (openConnection instanceof HttpURLConnection) {
                        ...
                        if (headerField != null) {
                            ...
                            if (protocol != null) {
                                if (!protocol.equals("http") && !protocol.equals("https")) {
                                    x.p("Unsupported scheme: ".concat(protocol));
                                    return null;
                                }
                                ...
                                x.p("Protocol is null");
                                return null;
                            }
                        } else {
                            x.p("Missing Location header in redirect");
                            return null;
                        }
                    } else {
                    ...
                    x.p("Invalid protocol.");
                    return null;
                }
            } else {
                x.p("Too many redirects (20)");
                return null;
            }
        }
    }
