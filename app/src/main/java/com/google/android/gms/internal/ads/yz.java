        ...
        if (!TextUtils.isEmpty(headerField)) {
            ...
            if (matcher.find()) {
                try {
                    ...
                    String o10 = a.o(new StringBuilder(String.valueOf(headerField).length() + 27), "Unexpected Content-Range [", headerField, "]");
                    int i = a0.f19634b;
                    i.c(o10);
                }
            }
    ...
    public final HttpURLConnection l(long j10, int i, long j11) {
        ...
        try {
            ...
            try {
                ...
                o();
                int i10 = this.H;
                throw new co1(a.f(i10, "Response code: ", new StringBuilder(String.valueOf(i10).length() + 15)), AdError.SERVER_ERROR_CODE, i);
        ...
        while (true) {
            ...
            if (!arrayDeque.isEmpty()) {
                try {
                    ...
                    int i = a0.f19634b;
                    i.d("Unexpected error while disconnecting", e);
                }
            } else {
                this.D = null;
                return;
