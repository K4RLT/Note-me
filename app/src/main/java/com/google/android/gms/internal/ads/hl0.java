...
public final class hl0 implements qn0 {
    ...
    public final b zza() {
        ...
        switch (this.f6835a) {
            case 0:
                if (u6.a((Context) this.f6836b, "com.google.android.gms.permission.AD_ID") == 0) {
                    z3 = true;
                } else {
                    z3 = false;
                }
            ...
            default:
                return ed1.d0(ed1.Y(ed1.e(new Bundle()), ((Long) r.e.f17698c.a(sl.f10696d5)).longValue(), TimeUnit.MILLISECONDS, (ScheduledExecutorService) this.f6836b), i6.f7010o, xx.f12651a);
        }
    }
