...
public final class ca0 implements ua0 {
    ...
    public ca0(Context context, wa0 wa0Var, JSONObject jSONObject, rc0 rc0Var, ra0 ra0Var, of ofVar, a70 a70Var, q60 q60Var, e90 e90Var, qp0 qp0Var, l9.a aVar, aq0 aq0Var, u30 u30Var, eb0 eb0Var, la.a aVar2, d90 d90Var, xs0 xs0Var, ur0 ur0Var, wh0 wh0Var, jd0 jd0Var, cb0 cb0Var, s70 s70Var, f9.a aVar3, c60 c60Var) {
        this.f5058u = context;
        this.f5059v = wa0Var;
    ...
    public final boolean A(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z3, View view) {
        ...
        try {
            ...
            jSONObject6.put("screen", wa.h9.h(context));
            ...
            if (!this.O) {
                this.O = f9.k.C.f16823o.d(context, this.E.f20029u, qp0Var.C.toString(), this.F.f4583g);
            }
            return true;
        } catch (JSONException e) {
            int i = k9.a0.f19634b;
            l9.i.d("Unable to create impression JSON.", e);
            return false;
        }
    }

    public final String B(View view) {
        if (!((Boolean) g9.r.e.f17698c.a(sl.f10935s4)).booleanValue()) {
            return null;
        }
        try {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:69:0x0113, code lost:
        ...
        r7 = k9.a0.f19634b;
        l9.i.d("Exception obtaining click signals", r0);
        r13 = null;
     */
    ...
    */
    ...
    public final void a(View view, Map map, Map map2, View.OnTouchListener onTouchListener, View.OnClickListener onClickListener) {
        ...
        boolean a10 = wa.h9.a(this.E.f20031w);
        if (map != null) {
    ...
    public final void b(View view) {
        if (!this.f5060w.optBoolean("custom_one_point_five_click_enabled", false)) {
            int i = k9.a0.f19634b;
            l9.i.f("setClickConfirmingView: Your account need to be in the allow list to use this feature.\nContact your account manager for more information.");
        } else {
            if (view == null) {
                return;
            }
    ...
    public final JSONObject f(View view, Map map, Map map2, ImageView.ScaleType scaleType) {
        Context context = this.f5058u;
        JSONObject e = wa.h9.e(context, map, map2, view, scaleType);
        JSONObject b10 = wa.h9.b(context, view);
        JSONObject c10 = wa.h9.c(view);
        JSONObject d2 = wa.h9.d(context, view);
        try {
            ...
            int i = k9.a0.f19634b;
            l9.i.d("Unable to create native ad view signals JSON.", e8);
            return null;
        }
    }
    ...
    public final void g(Bundle bundle) {
        ...
        if (bundle == null) {
            int i = k9.a0.f19634b;
            l9.i.a("Click data is null. No click is reported.");
        } else {
            if (!r("click_reporting")) {
                int i10 = k9.a0.f19634b;
                l9.i.c("The ad slot cannot handle external click events. You must be part of the allow list to be able to report your click events.");
                return;
            }
            ...
            C(null, null, null, null, null, str, null, g9.p.f17688g.f17689a.l(bundle, null), false, false);
        }
    }
    ...
    public final void h(vo voVar) {
        if (!this.f5060w.optBoolean("custom_one_point_five_click_enabled", false)) {
            int i = k9.a0.f19634b;
            l9.i.f("setUnconfirmedClickListener: Your account need to be in the allow list to use this feature.\nContact your account manager for more information.");
            return;
        }
        eb0 eb0Var = this.H;
    ...
    public final void i(View view, View view2, Map map, Map map2, boolean z3, ImageView.ScaleType scaleType) {
        View view3;
        Context context = this.f5058u;
        JSONObject e = wa.h9.e(context, map, map2, view2, scaleType);
        JSONObject b10 = wa.h9.b(context, view2);
        JSONObject c10 = wa.h9.c(view2);
        JSONObject d2 = wa.h9.d(context, view2);
        String w10 = w(view, map);
        JSONObject f10 = wa.h9.f(w10, context, this.T, this.S);
        if (true == ((Boolean) g9.r.e.f17698c.a(sl.f11043z4)).booleanValue()) {
            view3 = view2;
        } else {
            view3 = view;
        }
    ...
    public final JSONObject m(View view, Map map, Map map2, ImageView.ScaleType scaleType) {
        ...
        try {
            ...
            int i = k9.a0.f19634b;
            l9.i.d("Unable to create native click meta data JSON.", e);
            return jSONObject;
        }
    }
    ...
    */
    ...
    public final void p(Bundle bundle) {
        if (bundle == null) {
            int i = k9.a0.f19634b;
            l9.i.a("Touch event data is null. No touch event is reported.");
        } else {
            if (!r("touch_reporting")) {
                int i10 = k9.a0.f19634b;
                l9.i.c("The ad slot cannot handle external touch events. You must be in the allow list to be able to report your touch events.");
                return;
            }
    ...
    public final void s(View view, Map map, Map map2, ImageView.ScaleType scaleType) {
        ...
        JSONObject c10 = wa.h9.c(view);
        JSONObject d2 = wa.h9.d(context, view);
        boolean g8 = wa.h9.g(context, this.D);
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("ad", this.f5060w);
            jSONObject.put("asset_view_signal", e);
            ...
            jSONObject.put("screen", wa.h9.h(context));
            ...
            int i = k9.a0.f19634b;
            l9.i.d("Unable to create native ad signals logging JSON.", e8);
        }
    }
    ...
    public final void t(View view, Map map, Map map2, ImageView.ScaleType scaleType) {
        Context context = this.f5058u;
        A(wa.h9.b(context, view), wa.h9.e(context, map, map2, view, scaleType), wa.h9.c(view), wa.h9.d(context, view), B(view), null, wa.h9.g(context, this.D), view);
    }
    ...
    public final boolean u(Bundle bundle) {
        if (!r("impression_reporting")) {
            int i = k9.a0.f19634b;
            l9.i.c("The ad slot cannot handle external impression events. You must be in the allow list to be able to report your impression events.");
            return false;
        }
        String str = null;
        JSONObject l10 = g9.p.f17688g.f17689a.l(bundle, null);
        if (((Boolean) g9.r.e.f17698c.a(sl.Qc)).booleanValue()) {
            str = B(null);
        }
    ...
    public final void y() {
        f9.a aVar;
        if (((Boolean) g9.r.e.f17698c.a(sl.f10846mf)).booleanValue() && (aVar = this.Z) != null) {
            aVar.f16785b = true;
        }
    }
