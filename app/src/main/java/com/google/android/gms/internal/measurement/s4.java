...
public class s4 implements Serializable, Iterable {
    ...
    public static int b(int i, int i10, int i11) {
        ...
        if ((i | i10 | i12 | (i11 - i10)) < 0) {
            if (i >= 0) {
                if (i10 < i) {
                    x.l(i1.c("Beginning index larger than ending index: ", i, i10, ", "));
                    return 0;
                }
                x.l(i1.c("End index: ", i10, i11, " >= "));
                return 0;
            }
            x.l(a.i("Beginning index: ", i, " < 0"));
            return 0;
        }
        return i12;
    }
                    ...
                    if (obj instanceof s4) {
                        ...
                        if (i == 0 || i10 == 0 || i == i10) {
                            ...
                            if (k3 <= s4Var.k()) {
                                ...
                                x.n(i1.c("Ran off end of other: 0, ", k3, s4Var.k(), ", "));
                                return false;
                            }
                            androidx.datastore.preferences.protobuf.c(k3, k());
                            return false;
                        }
                        return false;
                    }
