...
public final class qi0 implements ji0 {
    ...
    public final Object a(wp0 wp0Var, qp0 qp0Var, gi0 gi0Var) {
        switch (this.f9850a) {
            case 0:
                tw twVar = new tw(qp0Var, (zs) gi0Var.f6407b, b.APP_OPEN_AD);
                ...
                u4 u4Var = new u4(qp0Var.f9925a0, 2);
                ...
                return z10Var.l0();
            case 1:
                tw twVar2 = new tw(qp0Var, (zs) gi0Var.f6407b, b.INTERSTITIAL);
                ...
                return g20Var.l0();
            default:
                tw twVar3 = new tw(qp0Var, (zs) gi0Var.f6407b, b.REWARDED);
        ...
        switch (this.f9850a) {
            case 0:
                try {
                    ...
                    zsVar.Z2(qp0Var.Z);
                    zsVar.q3(qp0Var.U, qp0Var.f9962v.toString(), ((aq0) wp0Var.f12312a.f4819v).f4581d, new b(this.f9851b), new pi0(gi0Var), (as) gi0Var.f6408c);
                    return;
                } catch (RemoteException e) {
                    a0.l("Remote exception loading an app open RTB ad", e);
            ...
            case 1:
                try {
                    ...
                    zsVar2.Z2(qp0Var.Z);
                    zsVar2.Q2(qp0Var.U, qp0Var.f9962v.toString(), ((aq0) wp0Var.f12312a.f4819v).f4581d, new b(this.f9851b), new dj0(this, gi0Var), (as) gi0Var.f6408c);
                    return;
                } catch (RemoteException e8) {
                    a0.l("Remote exception loading a interstitial RTB ad", e8);
            ...
            default:
                try {
                    ...
                    if (i == 3) {
                        zsVar3.C0(str2, jSONObject.toString(), aq0Var.f4581d, new b(context), new xj0(this, gi0Var), (as) iInterface);
                    } else {
                        zsVar3.F2(str2, jSONObject.toString(), aq0Var.f4581d, new b(context), new xj0(this, gi0Var), (as) iInterface);
                    }
                    return;
                } catch (RemoteException e10) {
                    a0.l("Remote exception loading a rewarded RTB ad", e10);
                    return;
                }
        }
    }
