...
public final class pu implements qu {
    ...
    */
    public pu(android.content.Context r4, l9.a r5) {
        /*
            r3 = this;
            r3.<init>()
        ...
        L52:
            ...
            goto L63
        L54:
            c4.n r5 = na.b.a(r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L52
            ...
            r1 = 0
            android.content.pm.PackageInfo r4 = r5.c(r1, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L52
        L63:
            r3.A = r4
        ...
        L85:
            ...
            goto Lb3
        L9c:
            c4.n r4 = na.b.a(r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> Lb3
        ...
        Lce:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.pu.<init>(android.content.Context, l9.a):void");
    }
    ...
    public static qu b(Context context, l9.a aVar) {
        synchronized (F) {
            try {
                if (I == null) {
                    boolean z3 = false;
                    if (((Boolean) pm.f9547c.p()).booleanValue()) {
                        if (!((Boolean) g9.r.e.f17698c.a(sl.f11047z8)).booleanValue() || ((Boolean) pm.f9545a.p()).booleanValue()) {
                            z3 = true;
                        }
                    }
                    if (h(context)) {
    ...
    public static boolean h(Context context) {
        ...
        if (context != null) {
            synchronized (F) {
                try {
                    if (J == null) {
                        if (g9.p.f17688g.e.nextInt(100) < ((Integer) g9.r.e.f17698c.a(sl.f10768he)).intValue()) {
                            z3 = true;
                        } else {
                            z3 = false;
                        }
            ...
            if (J.booleanValue()) {
                if (!((Boolean) g9.r.e.f17698c.a(sl.f11047z8)).booleanValue()) {
                    return true;
                }
            }
        }
        ...
        if (!this.f9607v) {
            ...
            if (((Boolean) fn.e.p()).booleanValue()) {
                ...
                while (!linkedList.isEmpty()) {
                    ...
                    if (((Boolean) g9.r.e.f17698c.a(sl.f10662b3)).booleanValue() && stackTrace != null && stackTrace.length == 0 && l9.d.o(th5.getClass().getName())) {
                        z3 = true;
                    } else {
                        z3 = false;
                    }
                    ...
                    for (StackTraceElement stackTraceElement : stackTrace) {
                        if (l9.d.o(stackTraceElement.getClassName())) {
            ...
            if (th2 != null) {
                ...
                String f11 = f(th);
                String str5 = "";
                if (!((Boolean) g9.r.e.f17698c.a(sl.Y9)).booleanValue() || (str2 = l9.d.d(f(th), "SHA-256")) == null) {
                    str2 = "";
                }
                double d2 = f10;
                ...
                if (random < d2) {
                    ...
                    try {
                        ...
                        l9.i.d("Error fetching instant app info", th6);
                        z9 = false;
                    }
                    try {
                        str3 = context.getPackageName();
                    } catch (Throwable unused) {
                        l9.i.f("Cannot obtain package name, proceeding.");
                        str3 = "unknown";
                    }
                    ...
                    if (!str7.startsWith(str6)) {
                        str7 = p.a.o(new StringBuilder(String.valueOf(str6).length() + 1 + str7.length()), str6, " ", str7);
                    }
                    Uri.Builder appendQueryParameter3 = appendQueryParameter2.appendQueryParameter("device", str7);
                    l9.a aVar2 = (l9.a) this.f9611z;
                    ...
                    Uri.Builder appendQueryParameter6 = appendQueryParameter5.appendQueryParameter("gmscv", String.valueOf(ca.f.a(context)));
                    String str8 = "1";
                    ...
                    if (((Boolean) qlVar.a(sl.G8)).booleanValue() && (i10 = l9.d.i(context)) != null) {
                    ...
                    if (((Boolean) qlVar.a(sl.F8)).booleanValue()) {
                        ...
                        if (i11 >= 26) {
                            ...
                            if (context != null) {
                                try {
                                    c10 = na.b.a(context).c(128, "com.android.webview");
                    ...
                    if (((Boolean) g9.r.e.f17698c.a(sl.Tc)).booleanValue()) {
                        String j10 = l9.d.j(context);
                        if (j10 != null) {
                            str5 = j10;
                        }
                    ...
                    while (i12 < size) {
                        ...
                        i12++;
                        ((ExecutorService) this.f9610y).execute(new ac.a(new l9.l(context, null), 7, (String) obj));
                    }
                }
            }
        }
        ...
        if (th != null) {
            ...
            for (Throwable th2 = th; th2 != null; th2 = th2.getCause()) {
                for (StackTraceElement stackTraceElement : th2.getStackTrace()) {
                    z3 |= l9.d.o(stackTraceElement.getClassName());
                    z9 |= pu.class.getName().equals(stackTraceElement.getClassName());
                }
            }
            int intValue = ((Integer) g9.r.e.f17698c.a(sl.B8)).intValue();
            if (intValue > 0) {
                if (hashSet.size() < intValue) {
                    String d2 = l9.d.d(f(th), "SHA-256");
                    if (d2 == null) {
                        d2 = "";
                    }
