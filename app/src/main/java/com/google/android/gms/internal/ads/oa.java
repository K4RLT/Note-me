    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        switch (this.f9047u) {
            case 0:
                ...
                return;
            default:
                k0 k0Var = ((t0) this.f9049w).f16373b.C;
                d1.d(k0Var);
