...
public final class r10 implements sr1 {
    ...
    public final Object zzb() {
        switch (this.f10055a) {
            case 0:
                try {
                    return b.a(this.f10056b.a()).c(0, ((ApplicationInfo) this.f10057c.zzb()).packageName);
                } catch (PackageManager.NameNotFoundException unused) {
                    return null;
                }
            case 1:
                return new l(this.f10056b.a(), (String) this.f10057c.zzb());
            case 2:
                return a();
            default:
