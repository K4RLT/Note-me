        ...
        switch (i) {
            case 0:
                ...
                try {
                    ...
                    i.d("Error creating PACT Error Response JSON: ", e);
                    return;
                }
            default:
                a aVar = (a) obj;
                int i11 = a0.f19634b;
                i.f("Failed to generate query info for the tagging library, error: ".concat(String.valueOf(str)));
                ...
                if (((Boolean) nbVar.p()).booleanValue()) {
                    try {
                        ...
                        k.C.f16817h.e("TaggingLibraryJsInterface.getQueryInfo.onFailure", e8);
                    }
                } else {
                ...
                if (((Boolean) bn.f4838c.p()).booleanValue() && ((Boolean) bn.f4839d.p()).booleanValue()) {
                    o oVar = aVar.f25045l;
                    oVar.getClass();
                    oVar.f25091b.execute(new n(oVar, 0));
                    return;
                }
                return;
        }
    ...
    public final void b(c cVar) {
        ...
        switch (i) {
            case 0:
                try {
                    fm fmVar = (fm) obj;
                    fmVar.f6112g.a(fmVar.c(str2, ((s) cVar.f25764v).f3857v).toString());
                    return;
                } catch (JSONException e) {
                    int i10 = a0.f19634b;
                    i.d("Error creating PACT Signal Response JSON: ", e);
                    return;
                }
            default:
                a aVar = (a) obj;
                String str3 = ((s) cVar.f25764v).f3857v;
                long j11 = 0;
                try {
                    ...
                    Locale locale = Locale.getDefault();
                    String str4 = ((s) cVar.f25764v).f3857v;
                    if (((Boolean) bn.e.p()).booleanValue()) {
                ...
                if (((Boolean) bn.e.p()).booleanValue()) {
                    try {
                        ...
                        k.C.f16817h.e("TaggingLibraryJsInterface.getQueryInfo.onSuccess", e8);
                    }
                } else {
                    aVar.f25037b.evaluateJavascript(format, null);
                }
