...
public final class ow implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public ow(Context context, c0 c0Var) {
    ...
    public final void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str) {
        try {
            ...
            k.C.f16817h.d("AdMobPlusIdlessListener.onSharedPreferenceChanged", th);
            a0.l("onSharedPreferenceChanged, errorMessage = ", th);
        }
    }
}
