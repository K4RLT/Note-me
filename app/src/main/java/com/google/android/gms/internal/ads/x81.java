...
public abstract class x81 extends AtomicReference implements Runnable {
    ...
    public final String toString() {
        ...
        if (runnable == f12490u) {
            ...
            str = a.o(new StringBuilder(String.valueOf(name).length() + 21), "running=[RUNNING ON ", name, "]");
        } else {
            str = "running=[NOT STARTED YET]";
        }
        String c10 = c();
        return a.o(new StringBuilder(str.length() + 2 + String.valueOf(c10).length()), str, ", ", c10);
    }
}
