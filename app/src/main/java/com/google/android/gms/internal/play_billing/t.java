...
public abstract class t {
    ...
    public static Bundle d(String str, String str2, ArrayList arrayList, p1 p1Var, long j10) {
        ...
        wa.a(objArr, 2);
        bundle.putStringArrayList("PRODUCT_TYPES_TO_RETURN_MULTIPLE_OFFERS", new ArrayList<>(p(objArr, 2)));
        Object[] objArr2 = {"inapp"};
        wa.a(objArr2, 1);
        bundle.putStringArrayList("PRODUCT_TYPES_TO_RETURN_PREORDER_OFFERS", new ArrayList<>(p(objArr2, 1)));
        Object[] objArr3 = {"inapp"};
        wa.a(objArr3, 1);
        bundle.putStringArrayList("PRODUCT_TYPES_TO_RETURN_RENT_OFFERS", new ArrayList<>(p(objArr3, 1)));
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (mVar.f3973b.equals("first_party")) {
                g5.h("Serialized DocId is required for constructing ExtraParams to query ProductDetails for all first party products.");
                return null;
            }
        }
        if (z3) {
