...
public final /* synthetic */ class xb0 implements j81 {
    ...
    public final /* synthetic */ g9.c3 f12539b;
    ...
    public /* synthetic */ xb0(Object obj, g9.c3 c3Var, qp0 qp0Var, sp0 sp0Var, f9.a aVar, mw mwVar, String str, String str2, int i) {
        this.f12538a = i;
        this.i = obj;
        this.f12539b = c3Var;
        this.f12540c = qp0Var;
        ...
        switch (this.f12538a) {
            case 0:
                ...
                if (!((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
                    aVar = new f9.a(ac0Var.f4439a, null);
                } else {
                    aVar = aVar3;
                }
