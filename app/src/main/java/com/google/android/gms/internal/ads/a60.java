...
public final class a60 implements s60, w80, g80, z60, ai {
    ...
    public final void F() {
        ...
        if (qp0Var.e != 3) {
            int i = qp0Var.Y;
            if (i == 0 || i == 1) {
                if (((Boolean) r.e.f17698c.a(sl.Uc)).booleanValue() && this.C.equals("com.google.ads.mediation.admob.AdMobAdapter")) {
                    return;
                }
                this.f4370u.l();
            }
    ...
    public final void e() {
        ...
        if (i != 3) {
            ...
            if (((Boolean) r.e.f17698c.a(sl.d2)).booleanValue() && qp0Var.Y == 2) {
    ...
    public final void k(zh zhVar) {
        if (((Boolean) r.e.f17698c.a(sl.Uc)).booleanValue() && this.C.equals("com.google.ads.mediation.admob.AdMobAdapter") && zhVar.f13171j && this.B.compareAndSet(false, true) && this.f4372w.e != 3) {
            a0.k("Full screen 1px impression occurred");
            this.f4370u.l();
        }
    }

    @Override // com.google.android.gms.internal.ads.z60
    public final synchronized void o(y1 y1Var) {
        try {
            d91 d91Var = this.f4375z;
            if (d91Var.isDone()) {
                return;
