...
public final class mz extends jz implements as1 {
    ...
    public final boolean b(String str) {
        ...
        this.f8498x = str3;
        String str4 = "error";
        String concat = "cache:".concat(String.valueOf(d.d(str3, "MD5")));
        try {
            ...
            while (true) {
                try {
                    ...
                    if (e == -1) {
                        this.H = true;
                        str3 = str;
                        d.f20036b.post(new hz((jz) this, str3, concat, (int) this.B.a(this.C)));
                        return true;
                    }
                    str3 = str;
                    str2 = str4;
                    try {
                        ...
                        try {
                            ...
                            String o10 = a.o(new StringBuilder(String.valueOf(canonicalName).length() + 1 + String.valueOf(message).length()), canonicalName, ":", message);
                            String l10 = a.l(new StringBuilder(o10.length() + String.valueOf(str3).length() + 34), "Failed to preload url ", str3, " Exception: ", o10);
                            int i = a0.f19634b;
                            i.f(l10);
                        ...
                        String o102 = a.o(new StringBuilder(String.valueOf(canonicalName2).length() + 1 + String.valueOf(message2).length()), canonicalName2, ":", message2);
                        String l102 = a.l(new StringBuilder(o102.length() + String.valueOf(str3).length() + 34), "Failed to preload url ", str3, " Exception: ", o102);
                        int i10 = a0.f19634b;
                        i.f(l102);
                    ...
                    String o1022 = a.o(new StringBuilder(String.valueOf(canonicalName22).length() + 1 + String.valueOf(message22).length()), canonicalName22, ":", message22);
                    String l1022 = a.l(new StringBuilder(o1022.length() + String.valueOf(str3).length() + 34), "Failed to preload url ", str3, " Exception: ", o1022);
                    int i102 = a0.f19634b;
                    i.f(l1022);
    ...
    public final void o() {
        ...
        String concat = "cache:".concat(String.valueOf(d.d(str, "MD5")));
        long j10 = round;
        if (round > 0) {
            z3 = true;
        } else {
        ...
        d.f20036b.post(new fz(this, str, concat, position, i, j10, a10, z3, i10, i11));
    }
