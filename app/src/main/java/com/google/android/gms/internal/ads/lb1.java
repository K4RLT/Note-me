...
public final class lb1 extends ca1 {
    ...
    public static lb1 h0(w91 w91Var, bl0 bl0Var, Integer num) {
        ...
        throw new GeneralSecurityException(a.f(length, "XChaCha20Poly1305 key must be constructed with key of length 32 bytes, not ", new StringBuilder(String.valueOf(length).length() + 75)));
    }
