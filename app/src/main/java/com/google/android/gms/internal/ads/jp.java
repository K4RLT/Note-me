...
public final /* synthetic */ class jp implements mp {
    ...
    public jp(ca0 ca0Var, View view) {
        ...
        if (((Boolean) g9.r.e.f17698c.a(sl.f11037ye)).booleanValue()) {
        ...
        switch (this.f7503u) {
            ...
            case 1:
                ...
                if (wwVar.a(context)) {
                    ...
                    l9.i.c("logScionEvent gmsg contained unsupported eventName");
                    return;
                }
                return;
            case 2:
            ...
            case 4:
                ...
                try {
                    ...
                    l9.i.c("Failed to call parse unconfirmedClickTimestamp.");
                }
                ...
                if (voVar == null) {
                    ...
                    l9.i.a("Received unconfirmed click but UnconfirmedClickListener is null.");
                    return;
                }
                try {
                    Parcel g22 = voVar.g2();
            ...
            default:
                ...
                if (str11 == null) {
                    ...
                    l9.i.f("URL missing from httpTrack GMSG.");
                    return;
                }
                qp0 J = h00Var3.J();
                if (J != null && !J.f9939i0) {
                ...
                sp0 A0 = h00Var3.A0();
                if (A0 == null) {
                    f9.k.C.f16817h.d("BufferingGmsgHandlers.getBufferingHttpTrackGmsgHandler", new IllegalArgumentException("Common configuration cannot be null"));
                    return;
                }
