            ...
            case 0:
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        if (orVar.D().equals(fhVar.w())) {
                            ...
                            if (mnVar.f14671a == ((nn) fhVar.q(6, null))) {
                                ...
                                if (fhVar.zza.f14195a.get(lnVar) != null) {
                                    ...
                                    x.n("This extension is for a different message type.  Please make sure that you are not suppressing any generics type warnings.");
                                } else {
                                    return orVar;
                                }
                            } else {
                        ...
                        x.n("DataFileGroupInternal does not contain DataFile with fileId: ".concat(String.valueOf(fhVar.w())));
                    }
                }
                return null;
            default:
