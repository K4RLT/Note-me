...
public final class ok1 implements z91 {
    ...
    public static String b(uj1 uj1Var) {
        ...
        q.x.n("Unsupported hash: ".concat(String.valueOf(uj1Var)));
        return null;
    }
    ...
    public static PSSParameterSpec c(uj1 uj1Var, uj1 uj1Var2, int i) {
        ...
        if (uj1Var == uj1Var5) {
            ...
            q.x.n("Unsupported MD hash: ".concat(String.valueOf(uj1Var)));
            return null;
        }
        if (uj1Var2 == uj1Var5) {
            ...
            q.x.n("Unsupported MGF1 hash: ".concat(String.valueOf(uj1Var2)));
            return null;
        }
    ...
    */
    public static com.google.android.gms.internal.ads.ok1 d(com.google.android.gms.internal.ads.xj1 r10) {
        ...
        L32:
            ...
            com.google.android.gms.internal.ads.uj1 r5 = r3.e
            int r6 = r3.f11927f
