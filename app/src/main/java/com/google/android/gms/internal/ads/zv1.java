                        ...
                        switch (nextString.hashCode()) {
                            case -2058725357:
                                if (nextString.equals("CONSENT_SIGNAL_COLLECT_CONSENT")) {
                                    ...
                                    x.p("Failed to parse contentads.contributor.direct.serving.appswitchboard.proto.ApplicationGdprResponse.ConsentSignalfrom: ".concat(nextString));
                                    return null;
                                }
                            case -1969035850:
                    ...
                    if (nextName.equals("privacy_options_required")) {
                        ...
                        if (hashCode != -1888946261) {
                            if (hashCode != 389487519) {
                                ...
                                x.p("Failed to parse contentads.contributor.direct.serving.appswitchboard.proto.ApplicationGdprResponse.PrivacyOptionsRequirementStatusfrom: ".concat(nextString2));
                                return null;
                            }
                                    ...
                                    if (hashCode2 == 1583758243 && nextName2.equals("action_type")) {
                                        ...
                                        if (hashCode3 != 64208429) {
                                            if (hashCode3 != 82862015) {
                                                ...
                                                x.p("Failed to parse contentads.contributor.direct.serving.appswitchboard.proto.ApplicationGdprResponse.Action.ActionTypefrom: ".concat(nextString3));
                                                return null;
                                            }
