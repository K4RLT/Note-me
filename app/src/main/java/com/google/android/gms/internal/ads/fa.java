...
public final class fa {
    ...
    public fa(int i, int i10, int i11) {
        ...
        if (i == Integer.MIN_VALUE) {
            ...
            str = a.j(i, "/", new StringBuilder(String.valueOf(i).length() + 1));
        }
        this.f5995a = str;
        this.f5996b = i10;
        this.f5997c = i11;
    ...
    public final void a() {
        ...
        this.e = a.f(i, str, new StringBuilder(str.length() + length));
    }
    ...
    public final void b() {
        ...
        x.o("generateNewId() must be called before retrieving ids.");
    }
}
