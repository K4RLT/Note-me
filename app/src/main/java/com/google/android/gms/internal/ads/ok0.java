...
public final class ok0 {
    ...
    public final synchronized d61 a(String str, String str2) {
        Map map;
        try {
            if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && !TextUtils.isEmpty(k.C.f16817h.g().n().e) && (map = (Map) this.f9144c.get(str)) != null) {
                List<pk0> list = (List) map.get(str2);
                if (list == null) {
                    String u9 = xy.u(this.f9147g, str2, str);
                    if (((Boolean) r.e.f17698c.a(sl.f10877oc)).booleanValue()) {
    ...
    public final synchronized void d() {
        ...
        if (!((Boolean) cn.f5131g.p()).booleanValue()) {
            if (((Boolean) r.e.f17698c.a(sl.f10933s2)).booleanValue() && (jSONObject = k.C.f16817h.g().n().f8476g) != null) {
                try {
                    ...
                    a0.l("Malformed config loading JSON.", e);
                }
            }
        }
    }
    ...
    public final synchronized void e() {
        ...
        try {
            if (!((Boolean) cn.f5127b.p()).booleanValue()) {
                if (((Boolean) r.e.f17698c.a(sl.f10948t2)).booleanValue() && (jSONObject = k.C.f16817h.g().n().f8476g) != null) {
    ...
    public final synchronized void f() {
        ...
        try {
            JSONObject jSONObject = k.C.f16817h.g().n().f8476g;
            if (jSONObject != null) {
                try {
    ...
    public final synchronized d61 i(String str) {
        HashMap hashMap;
        try {
            if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(k.C.f16817h.g().n().e)) {
