...
public final class vy extends iy implements TextureView.SurfaceTextureListener, my {
        ...
        if (this.D != null && this.B != null) {
            if (z3) {
                if (D()) {
                    ...
                    int i = a0.f19634b;
                    i.f("No valid ExoPlayerAdapter exists when switch source.");
                    return;
                }
            }
            if (this.D.startsWith("cache:")) {
                ...
                if (d12 instanceof oz) {
                    ...
                    if (wzVar2.A == null) {
                        int i10 = a0.f19634b;
                        i.f("Precached video player has been released.");
                        return;
                    }
                } else if (d12 instanceof mz) {
                    mz mzVar = (mz) d12;
                    h00 h00Var = this.f12067w;
                    k.C.f16813c.E(h00Var.getContext(), h00Var.A().f20029u);
                    ...
                    int i12 = a0.f19634b;
                    i.e("ExoPlayerAdapter initialized.");
                    this.C = wzVar3;
                    wzVar3.u(new Uri[]{Uri.parse(str)}, byteBuffer2, z9);
                } else {
                    String valueOf = String.valueOf(this.D);
                    int i13 = a0.f19634b;
                    i.f("Stream cache miss: ".concat(valueOf));
                    return;
                }
            } else {
                ...
                k.C.f16813c.E(h00Var4.getContext(), h00Var4.A().f20029u);
    ...
    public final void H(Surface surface) {
        ...
        int i11 = a0.f19634b;
        i.f("Trying to set surface before player is initialized.");
    }

    public final void I() {
        if (!this.J) {
            this.J = true;
            f0.f19676l.post(new ty(this, 0));
            t();
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (!socket.isClosed()) {
                            try {
                                ...
                                int i10 = a0.f19634b;
                                i.g("Failed to update receive buffer size.", e);
                            }
                        }
                    }
                }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i10) {
        ...
        be0 be0Var;
        if (this.I) {
            if (((Boolean) r.e.f17698c.a(sl.Qe)).booleanValue() && (be0Var = this.f12070z) != null) {
                s a10 = be0Var.a();
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i10) {
        ...
        f0.f19676l.post(new gy(this, i, i10, 1));
    }
    ...
    public final void onWindowVisibilityChanged(int i) {
        ...
        sb2.append(i);
        a0.k(sb2.toString());
        f0.f19676l.post(new i(this, i, 5));
    ...
    @Override // com.google.android.gms.internal.ads.iy
    public final void t() {
        f0.f19676l.post(new ty(this, 7));
    }

    @Override // com.google.android.gms.internal.ads.my
    public final void u() {
        f0.f19676l.post(new ty(this, 1));
    }
    ...
    public final void x(IOException iOException) {
        ...
        int i = a0.f19634b;
        i.f(concat);
        k.C.f16817h.e("AdExoPlayerView.onException", iOException);
        f0.f19676l.post(new com.google.android.gms.internal.mlkit_vision_digital_ink.ra(this, 10, J));
    }
    ...
    public final void y(Exception exc, String str) {
        ...
        f0.f19676l.post(new a(this, 9, J));
        k.C.f16817h.e("AdExoPlayerView.onError", exc);
    }
