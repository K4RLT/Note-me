...
public abstract class ed1 implements q2 {
    ...
    public static i71 S(b bVar, Class cls, f31 f31Var, Executor executor) {
        int i = j71.E;
        j71 j71Var = new j71(bVar, cls, f31Var);
    ...
    public static h71 U(b bVar, Class cls, j81 j81Var, Executor executor) {
        int i = j71.E;
        j71 j71Var = new j71(bVar, cls, j81Var);
        bVar.a(j71Var, an1.G(executor, j71Var));
        return j71Var;
    }

    /* JADX WARN: Type inference failed for: r0v4, types: [java.lang.Object, com.google.android.gms.internal.ads.mf] */
    public static void V(b bVar, ur0 ur0Var, rr0 rr0Var, boolean z3) {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [java.lang.Object, b, com.google.android.gms.internal.ads.f91] */
    public static b Y(b bVar, long j10, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        if (bVar.isDone()) {
            return bVar;
        }
        Object obj = new Object();
    ...
    public static b81 c0(b bVar, j81 j81Var, Executor executor) {
        int i = d81.D;
        d81 d81Var = new d81(bVar, j81Var);
    ...
    public static c81 d0(b bVar, f31 f31Var, Executor executor) {
        int i = d81.D;
        d81 d81Var = new d81(bVar, f31Var);
        bVar.a(d81Var, an1.G(executor, d81Var));
        return d81Var;
    }
    ...
    public static gl1 f(x91 x91Var, Integer num) {
        ...
        throw new GeneralSecurityException(a.o(new StringBuilder(str.length() + 40), "idRequirement must be non-null for ", str, " type"));
    }
    ...
    public static void i0(b bVar, s81 s81Var, Executor executor) {
    ...
    public static Object j0(Future future) {
        ...
        x.o(ay0.B("Future was expected to be done: %s", future));
        return null;
    }
    ...
    public static void k(Object obj, Object obj2) {
        if (obj != null) {
            ...
            q.h(a.o(new StringBuilder(obj3.length() + 26), "null value in entry: ", obj3, "=null"));
            return;
        }
        q.h("null key in entry: null=".concat(String.valueOf(obj2)));
    }
    ...
    public static Object k0(yx yxVar) {
        try {
            ...
            throw new b(5, e.getCause());
        }
    }

    public static boolean l(xk0 xk0Var, s2 s2Var, int i, a aVar) {
        boolean z3;
        boolean z9;
        boolean z10;
        long P = xk0Var.P();
    ...
    public static byte[] m(byte[] bArr) {
        ...
        x.o("arithmetic error in scalar multiplication");
        return null;
    }
    ...
    public static void v(b bVar, rr0 rr0Var) {
        if (!((Boolean) rm.f10240c.p()).booleanValue()) {
            return;
        }
        q81 t3 = q81.t(bVar);
