...
public final class it0 {
    ...
    public it0(pt0 pt0Var, bl0 bl0Var, Context context, a aVar) {
        this.f7215c = pt0Var;
        this.f7216d = bl0Var;
        this.e = context;
        this.f7219h = aVar;
    ...
    public static String a(String str, b bVar) {
        ...
        return a.o(new StringBuilder(String.valueOf(str).length() + 1 + String.valueOf(name).length()), str, "#", name);
    }

    public final void b(boolean z3) {
        synchronized (this) {
            if (((Boolean) r.e.f17698c.a(sl.C)).booleanValue()) {
                c(z3);
            }
        }
    }
    ...
    */
    ...
    public final synchronized boolean e(String str, b bVar) {
        boolean z3;
        Long l10;
        int s10;
        try {
    ...
    public final synchronized Object f(Class cls, String str, b bVar) {
        Object cast;
        jt0 jt0Var = new jt0(new hq0(str, 19, bVar));
        bl0 bl0Var = this.f7216d;
        this.f7219h.getClass();
    ...
    public final synchronized dt0 g(String str, b bVar) {
