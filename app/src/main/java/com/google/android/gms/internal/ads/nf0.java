...
public final class nf0 {
    ...
    public nf0(qf0 qf0Var, xf0 xf0Var, ef0 ef0Var, Context context, a aVar, jf0 jf0Var, wf0 wf0Var, xw xwVar, xw xwVar2, String str) {
        this.f8688a = qf0Var;
        this.f8689b = xf0Var;
        this.f8690c = ef0Var;
        this.e = new g1(context, 2);
        this.i = aVar.f20029u;
        this.f8696k = str;
        this.f8691d = jf0Var;
        this.f8692f = wf0Var;
    ...
    public final synchronized void c(String str, gf0 gf0Var) {
        ...
        if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue() && f()) {
            if (this.f8705t >= ((Integer) rVar.f17698c.a(sl.f10841ma)).intValue()) {
                int i = a0.f19634b;
                i.f("Maximum number of ad requests stored reached. Dropping the current request.");
                return;
            }
    ...
    public final synchronized void e(n1 n1Var, mf0 mf0Var) {
        if (!f()) {
            try {
                ...
                int i = a0.f19634b;
                i.f("Ad inspector cannot be opened because the device is not in test mode. See https://developers.google.com/admob/android/test-ads#enable_test_devices for more information.");
                return;
            }
        }
        int i10 = 1;
    ...
    public final synchronized boolean f() {
        boolean booleanValue = ((Boolean) r.e.f17698c.a(sl.f11048za)).booleanValue();
    ...
    */
    public final synchronized void g(boolean r2, boolean r3) {
        ...
        L6:
            ...
            r r0 = r.e     // Catch: java.lang.Throwable -> L27
            com.google.android.gms.internal.ads.ql r0 = r0.f17698c     // Catch: java.lang.Throwable -> L27
            java.lang.Object r2 = a(r2)     // Catch: java.lang.Throwable -> L27
            java.lang.Boolean r2 = (java.lang.Boolean) r2     // Catch: java.lang.Throwable -> L27
            boolean r2 = r2.booleanValue()     // Catch: java.lang.Throwable -> L27
            if (r2 == 0) goto L29
            k r2 = k.C     // Catch: java.lang.Throwable -> L27
            j r2 = r2.f16823o     // Catch: java.lang.Throwable -> L27
            boolean r2 = g()     // Catch: java.lang.Throwable -> L27
            if (r2 != 0) goto L2d
            goto L29
        L27:
            r2 = move-exception
                ...
                synchronized (ef0Var) {
                    try {
                        if (ef0Var.f5682j && (sensorManager = ef0Var.f5675a) != null && (sensor = ef0Var.f5676b) != null) {
                            ...
                            ef0Var.f5682j = false;
                            a0.k("Stopped listening for flick gestures.");
                        }
                    } finally {
                    }
                }
                ...
                try {
                    if (xf0Var.f12568g) {
                        ...
                        if (sensorManager2 != null) {
                            ...
                            a0.k("Stopped listening for shake gestures.");
                        }
