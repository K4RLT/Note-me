    ...
    public final Object zzb() {
        ...
        switch (this.f11685a) {
            case 0:
                ...
                if (((Boolean) r.e.f17698c.a(sl.X4)).booleanValue()) {
            ...
            case 1:
                ...
                lo1.b(wxVar2);
                return new nl0(new om0(wxVar2, 1), ((Integer) r.e.f17698c.a(sl.Id)).intValue(), (ScheduledExecutorService) this.f11686b.zzb());
            case 2:
