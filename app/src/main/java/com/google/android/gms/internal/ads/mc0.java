...
public final class mc0 extends ph implements xo {
    ...
    public final void U2(Bundle bundle) {
        if (((Boolean) r.e.f17698c.a(sl.Ce)).booleanValue()) {
            na0 na0Var = this.f8320v;
            h00 h3 = na0Var.f8615m.h();
            if (h3 == null) {
                int i = a0.f19634b;
                i.c("Video webview is null");
                return;
            }
            try {
                ...
                na0Var.f8614l.execute(new a(h3, 15, jSONObject));
            } catch (JSONException e) {
                int i10 = a0.f19634b;
                i.d("Error reading event signals", e);
            }
        }
    }
    ...
    @Override // com.google.android.gms.internal.ads.xo
    public final v1 l0() {
        if (!((Boolean) r.e.f17698c.a(sl.F7)).booleanValue()) {
            return null;
        }
    ...
    public final boolean u4(int i, Parcel parcel, Parcel parcel2) {
        ...
        switch (i) {
            ...
            case 24:
                ...
                return true;
            case 25:
                k1 v4 = k2.v4(parcel.readStrongBinder());
                qh.f(parcel);
                v4(v4);
                parcel2.writeNoException();
                return true;
            ...
            case 28:
                ...
                synchronized (na0Var5) {
                    ...
                    if (phVar == null) {
                        int i11 = a0.f19634b;
                        i.a("Ad should be associated with an ad view before calling recordCustomClickGesture()");
                    } else {
            ...
            case 31:
                ...
                return true;
            case 32:
                q1 v42 = s2.v4(parcel.readStrongBinder());
                qh.f(parcel);
                try {
                    if (!v42.b()) {
                        this.f8322x.b();
                    ...
                    int i12 = a0.f19634b;
                    i.b("Error in making CSI ping for reporting paid event callback", e8);
                }
