        ...
        while (xk0Var.B() > 0) {
            ...
            if (i24 != 0) {
                ...
                if (i24 != i20) {
                    ...
                    i12 = 1;
                    if (h14 != 1) {
                        a.t(new StringBuilder(String.valueOf(h14).length() + 30), "Unexpected start code prefix: ", h14, "PesReader");
                        i11 = -1;
                        this.f12499j = -1;
                        i13 = 0;
                        i19 = 2;
                        ...
                        if (h15 == 0) {
                            ...
                            this.f12499j = i29;
                            if (i29 < 0) {
                                a.t(new StringBuilder(String.valueOf(i29).length() + 36), "Found negative packet payload size: ", i29, "PesReader");
                                i11 = -1;
                                this.f12499j = -1;
                            } else {
                                i11 = -1;
