...
public final class i8 {
    ...
    public i8 a() {
        boolean z3;
        if (((ea.h) this.f14470d) != null) {
            z3 = true;
        } else {
            z3 = false;
        }
        fa.y.a("execute parameter required", z3);
        return new i8(this, (ca.d[]) this.e, this.f14468b, this.f14469c);
    }
    ...
    public i8(i8 i8Var, ca.d[] dVarArr, boolean z3, int i) {
        this.f14467a = 2;
        this.e = i8Var;
