                ...
                if (ct.i(1)) {
                    try {
                        ...
                        if (ct.i(1)) {
                            ...
                            x.n("Given private key's length is not 32");
                            return null;
                        }
    ...
    public v91 c(zd1 zd1Var) {
        switch (this.f6677u) {
            case 9:
                ...
                x.n("Wrong type URL in call to AesCmacProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var.z())));
                return null;
            case 13:
                c cVar = ve1.f11893a;
                ...
                if (ih1Var2.z().equals("type.googleapis.com/google.crypto.tink.HmacKey")) {
                    try {
                        ...
                        int B3 = C2.B();
                        throw new GeneralSecurityException(a.f(B3, "Parsing HmacParameters failed: unknown Version ", new StringBuilder(String.valueOf(B3).length() + 47)));
                    } catch (pn1 e8) {
                        throw new GeneralSecurityException("Parsing HmacParameters failed: ", e8);
                    }
                }
                x.n("Wrong type URL in call to HmacProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var2.z())));
                return null;
            default:
                ...
                x.n("Wrong type URL in call to EcdsaProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var3.z())));
                return null;
        }
    }
    ...
    public xy d(yd1 yd1Var) {
        ...
        switch (this.f6677u) {
            case 0:
                ...
                x.n("Wrong type URL in call to XChaCha20Poly1305ProtoSerialization.parseKey");
                return null;
            case 11:
                nd1 nd1Var2 = te1.f11333a;
                ...
                x.n("Wrong type URL in call to AesCmacProtoSerialization.parseKey");
                return null;
            default:
                c cVar = ve1.f11893a;
                ...
                x.n("Wrong type URL in call to HmacProtoSerialization.parseKey");
                return null;
        }
    }
