...
public final class pt extends mu implements mp {
    ...
    public final void d(Object obj, Map map) {
        ...
        if (((Boolean) k9.a(context, kl.f7794b)).booleanValue() && b.a(context).f3851u.checkCallingOrSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") == 0) {
            z3 = true;
        } else {
            z3 = false;
        }
        try {
            ...
            int i = a0.f19634b;
            i.d("Error occurred while obtaining the MRAID capabilities.", e);
            jSONObject = null;
        }
    ...
    public final void u(int i, int i10) {
        ...
        if (s00Var.l0() == null || !s00Var.l0().b()) {
            ...
            if (((Boolean) r.e.f17698c.a(sl.A0)).booleanValue()) {
                if (width == 0) {
                    if (s00Var.l0() != null) {
        ...
        try {
            ...
            int i14 = a0.f19634b;
            i.d("Error occurred while dispatching default position.", e);
        }
        mt mtVar = s00Var.H.R;
        if (mtVar != null) {
            mtVar.A = i;
