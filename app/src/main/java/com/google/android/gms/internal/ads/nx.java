        ...
        switch (this.f8886w) {
            case 0:
                ...
                synchronized (pxVar.f9632a) {
                    try {
                        s6 s6Var = k.C.f16821m;
                        q(pxVar.f9638h, twVar);
                    } catch (IllegalArgumentException e) {
                        int i = a0.f19634b;
                        i.g("Cannot config CSI reporter.", e);
                    }
                }
                return;
            case 1:
                d dVar = (d) this.f8887x;
                c cVar = k.C.f16831w;
                Bitmap bitmap = (Bitmap) ((ConcurrentHashMap) cVar.f18393v).get(Integer.valueOf(dVar.f19065w.I.f16803z));
                if (bitmap != null) {
                    f fVar = dVar.f19065w.I;
                    ...
                    f0.f19676l.post(new iv1(this, 18, bitmapDrawable));
                    return;
                }
                return;
            default:
                try {
                    z3 = b.b((Context) this.f8887x);
                } catch (g | IOException | IllegalStateException e8) {
                    int i10 = a0.f19634b;
                    i.d("Fail to get isAdIdFakeForDebugLogging", e8);
                }
