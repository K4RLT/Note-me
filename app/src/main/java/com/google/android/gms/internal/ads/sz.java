...
public final class sz extends qb1 {
    ...
    public sz(Context context, pf1 pf1Var, String str, int i, as1 as1Var, lx0 lx0Var) {
        ...
        this.N = null;
        this.D = ((Boolean) g9.r.e.f17698c.a(sl.f11010x2)).booleanValue();
        b(as1Var);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:66:0x0244  */
    /* JADX WARN: Type inference failed for: r2v23, types: [f9.k] */
    ...
    */
    ...
    public final int e(byte[] bArr, int i, int i10) {
        ...
        q.x.p("Attempt to read closed GcacheDataSource.");
        return 0;
    }
    ...
    public final void k() {
        ...
        q.x.p("Attempt to close an already closed GcacheDataSource.");
    }
