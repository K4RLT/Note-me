...
public final class d6 implements h7, l, n1 {
    ...
    public static d6 l(f0 f0Var, byte[] bArr, boolean z3) {
        String str;
        f0Var.o();
        ((dd) f0Var.f3950v).f5404c.f11315v = e(bArr);
        ...
        String o10 = a.o(new StringBuilder(str.length() + length + 12), "3.904631200.", g8, str);
    ...
    public long d(long j10) {
        ...
        long j14 = j12 / j13;
        if (((o0) this.f5318x) != o0.f22960u && j14 % 2 != 0) {
    ...
    public boolean h(long j10, s sVar) {
        x xVar = (x) ((i) this.f5317w).invoke();
        if (xVar != null) {
            a1 a1Var = (a1) this.f5318x;
            long j11 = this.f5316v;
            if (!xVar.i() || !b1.a(a1Var, j11)) {
                return false;
            }
    ...
    public q i(long j10, q qVar, q qVar2, q qVar3) {
        return ((p1) this.f5317w).i(d(j10), qVar, qVar2, k(j10, qVar, qVar3, qVar2));
    }
    ...
    public boolean j(long j10, s sVar) {
        ...
        if (xVar != null) {
            ...
            long j11 = this.f5316v;
            if (xVar.i()) {
                m mVar = a1Var.f19221f;
                if (mVar != null) {
                    mVar.d(Boolean.FALSE, xVar, new b(j10), sVar);
                }
                this.f5315u = j10;
                return b1.a(a1Var, j11);
            }
            return false;
        }
        return false;
    ...
    public q k(long j10, q qVar, q qVar2, q qVar3) {
        long j11 = this.f5316v;
        long j12 = j10 + j11;
        long j13 = this.f5315u;
        if (j12 > j13) {
            return ((p1) this.f5317w).m(j13 - j11, qVar, qVar3, qVar2);
        }
        return qVar2;
    }
    ...
    public q m(long j10, q qVar, q qVar2, q qVar3) {
        return ((p1) this.f5317w).m(d(j10), qVar, qVar2, k(j10, qVar, qVar3, qVar2));
    }

    public boolean n(long j10, boolean z3, boolean z9) {
        z2 z2Var = (z2) this.f5317w;
        v2 v2Var = (v2) this.f5318x;
        v2Var.u();
        v2Var.y();
        ...
        l3.Y(v2Var.w().B(!d1Var.A.I()), bundle, true);
        if (!z9) {
            v2Var.v().c0("auto", bundle, "_e");
        }
        this.f5315u = j10;
        z2Var.a();
        z2Var.b(((Long) v.f16390a0.a(null)).longValue());
        return true;
    }
