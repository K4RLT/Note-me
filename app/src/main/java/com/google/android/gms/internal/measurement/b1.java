        ...
        switch (this.f13646y) {
            case 0:
                try {
                    ...
                    try {
                        p0Var = s0.asInterface(pa.c((Context) this.A, pa.d.f22622c, ModuleDescriptor.MODULE_ID).b("com.google.android.gms.measurement.internal.AppMeasurementDynamiteService"));
                    } catch (pa.a e) {
                    ...
                    int a10 = pa.a((Context) this.A, ModuleDescriptor.MODULE_ID);
                    int d2 = pa.d((Context) this.A, ModuleDescriptor.MODULE_ID, false);
                    ...
                    a1 a1Var = new a1(97001L, max, z3, null, null, null, (Bundle) this.B, eb.b((Context) this.A));
