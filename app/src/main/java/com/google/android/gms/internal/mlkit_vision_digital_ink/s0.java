...
public final class s0 {
    ...
    public final j6.c f14948d;
    public final g9.n e;

    /* renamed from: f, reason: collision with root package name */
    public final g9.n f14949f = new g9.n(new gw(this));
    ...
    public s0(com.google.android.gms.internal.consent_sdk.c cVar, w9 w9Var) {
        ...
        this.e = new g9.n(new z0(cVar, 0));
        this.f14948d = new j6.c(11);
    ...
    public final ya a() {
        ...
        if (((fb) nVar.A).isDone()) {
            ...
            try {
                ...
                int i = g2.f14354a;
                w9 q10 = n5.q(z3, new r0(q1.b(), 3, e1Var), ia.f14473u);
                e.f(q10);
                e.close();
                w9Var = q10;
            } catch (Throwable th) {
    ...
    public final x9 b(m2 m2Var, Executor executor) {
        ...
        int i = g2.f14354a;
        int i10 = 3;
        r0 r0Var = new r0(q1.b(), i10, p0Var);
        y2.b(i2.f14454a);
        ...
        try {
            ...
            j6.c cVar = this.f14948d;
            s5 s5Var = new s5(5, z3);
            ia iaVar = ia.f14473u;
            cVar.p(s5Var, iaVar);
            try {
                ya p10 = cVar.p(g2.a(new b1(this, z3, r0Var, executor, 1)), iaVar);
                if (!z3.isDone()) {
                    if (p10.isDone()) {
