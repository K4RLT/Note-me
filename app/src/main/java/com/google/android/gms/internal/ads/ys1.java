...
public final class ys1 extends um1 {
    ...
    /* JADX WARN: Type inference failed for: r2v7, types: [d2, java.lang.Object] */
    ...
    public ys1(os1 os1Var, eu1 eu1Var) {
        ...
        try {
            ...
            if (i14 >= 31) {
                os1Var2 = os1Var;
                callback = null;
                s6Var.x(looper2, null).e(new k(this.f12961z, os1Var2.f9226u, this, tu1Var));
            } else {
                os1Var2 = os1Var;
                callback = null;
            }
    ...
    public final void Q0() {
        ...
        if (currentThread != looper.getThread()) {
            ...
            String h3 = a.h("Player is accessed on the wrong thread.\nCurrent thread: '", name, "'\nExpected thread: '", name2, "'\nSee https://developer.android.com/guide/topics/media/issues/player-accessed-on-wrong-thread");
            if (!this.m0) {
                if (this.f12950n0) {
    ...
    public final void X1() {
        ...
        a.t(sb2, "Release ", hexString, " [AndroidXMedia3/1.10.1] [", str2);
        sb2.append("] [");
        sb2.append(str);
        sb2.append("]");
        x21.D("ExoPlayerImpl", sb2.toString());
    ...
    */
    ...
    public final void i2(Surface surface) {
        ...
        if (!z9) {
            Y1(new ns1(2, new b("Detaching surface timed out.", 7), 1003));
        }
    }
