...
public final class p20 extends e1 {
    public final ww A;
    public final qd0 B;
    public final nf0 C;
    public final ju0 D;
    ...
    public p20(Context context, a aVar, od0 od0Var, fi0 fi0Var, ok0 ok0Var, af0 af0Var, ww wwVar, qd0 qd0Var, nf0 nf0Var, ju0 ju0Var, vr0 vr0Var, hq0 hq0Var, r50 r50Var, be0 be0Var, zf0 zf0Var) {
        this.f9326u = context;
        this.f9327v = aVar;
        this.f9328w = od0Var;
        this.f9329x = fi0Var;
    ...
    public final void E3(u2 u2Var) {
        ...
        ((a) j10.f11470v).getClass();
        qwVar.a(-1, System.currentTimeMillis());
        if (((Boolean) r.e.f17698c.a(sl.Y0)).booleanValue() && wwVar.a(context) && ww.g(context)) {
    ...
    public final void T(String str) {
        if (((Boolean) r.e.f17698c.a(sl.La)).booleanValue()) {
            k.C.f16817h.f9637g = str;
        }
    }
    ...
    */
    public final void W1(a r17, java.lang.String r18) {
        /*
            r16 = this;
            r1 = r16
            ...
            if (r2 == 0) goto L2e
            k r2 = k.C     // Catch: android.os.RemoteException -> L22 java.lang.RuntimeException -> L24
            f0 r2 = r2.f16813c     // Catch: android.os.RemoteException -> L22 java.lang.RuntimeException -> L24
            java.lang.String r0 = f0.M(r0)     // Catch: android.os.RemoteException -> L22 java.lang.RuntimeException -> L24
            goto L30
        L22:
            r0 = move-exception
            goto L25
        ...
        L9b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.p20.W1(a, java.lang.String):void");
    }
                    ...
                    switch (i13) {
                        ...
                        case 1:
                            ...
                            if (!bmVar.f4824v.getAndSet(true)) {
                                ...
                                if (bmVar.f4828z == null && context2 != null && (b10 = f.b(context2)) != null && !b10.equals(context2.getPackageName())) {
                                    f.a(context2, b10, bmVar);
                                    return;
                                }
                                return;
                            }
                        ...
                        case 2:
                            ...
                            try {
                                try {
                                    IBinder b11 = m0.a(ju0Var.f7543u).b("com.google.android.gms.ads.flags.FlagRetrieverSupplierProxy");
                                    if (b11 == null) {
                                        ohVar = null;
                                    } else {
                                ...
                                i.f("Error calling setFlagsAccessedBeforeInitializedListener: ".concat(String.valueOf(e8.getMessage())));
                                return;
                            } catch (j e10) {
                                i.f("Could not load com.google.android.gms.ads.flags.FlagRetrieverSupplierProxy:".concat(String.valueOf(e10.getMessage())));
                                return;
                            }
                        default:
                            p20 p20Var3 = this.f8925v;
                            k kVar2 = k.C;
                            c0 g11 = kVar2.f16817h.g();
                            g11.i();
                            synchronized (g11.f19642a) {
                                z3 = g11.f19664y;
                            }
                            if (z3) {
                                c0 g12 = kVar2.f16817h.g();
                                g12.i();
    ...
    public final synchronized void r3(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            if (((Boolean) r.e.f17698c.a(sl.S4)).booleanValue()) {
                k.C.f16820l.i(context, this.f9327v, true, null, str, null, null, this.E, null, null, this.C.f());
            }
        }
    }
