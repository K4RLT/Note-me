...
public final class hi {
    ...
    public static void a(String str, int i, String str2, String str3) {
        ...
        g3.a.t(sb2, "Different ", str, " combined in one TrackGroup: '", str2);
    ...
    public final String toString() {
        ...
        return p.a.o(new StringBuilder(String.valueOf(str).length() + 2 + String.valueOf(arrays).length()), str, ": ", arrays);
    }
}
