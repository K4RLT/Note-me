...
public final class qx {
    ...
    public qx(String str, c0 c0Var) {
        this.f10017h = str;
        this.i = c0Var;
    }

    public final void a(z2 z2Var, long j10) {
        long j11;
        long j12;
        Bundle bundle;
        int i;
        synchronized (this.f10015f) {
            try {
                ...
                if (this.f10012b == -1) {
                    if (currentTimeMillis - j11 > ((Long) r.e.f17698c.a(sl.C1)).longValue()) {
                        this.f10014d = -1;
                    } else {
                        c0Var.i();
                        synchronized (c0Var.f19642a) {
                ...
                if (!((Boolean) r.e.f17698c.a(sl.f10995w4)).booleanValue() && (bundle = z2Var.f17723w) != null && bundle.getInt("gw", 2) == 1) {
                    return;
                }
                this.f10013c++;
