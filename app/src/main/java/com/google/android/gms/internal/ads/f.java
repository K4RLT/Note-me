...
public final /* synthetic */ class f implements Runnable {
    ...
    private final void c() {
        ...
        while (true) {
            try {
                ...
                int i = a0.f19634b;
                i.g("CsiReporter:reporter interrupted", e);
                return;
            }
        }
    }
    ...
    private final void d() {
        ...
        try {
            ...
            String l10 = a.l(new StringBuilder(String.valueOf(str).length() + 34 + String.valueOf(message).length()), "Failed to preload url ", str, " Exception: ", message);
            int i = a0.f19634b;
            i.f(l10);
            k.C.f16817h.e("VideoStreamExoPlayerCache.preload", e);
            ozVar.a();
                        ...
                        if (z3) {
                            ...
                            if (V1 > 0) {
                                ...
                                if (X1 != ozVar.D) {
                                    ...
                                    j12 = X1;
                                    j11 = V1;
                                    d.f20036b.post(new ez(ozVar, str2, o10, X1, V1, j13, j16, j15, z9, wz.O.get(), wz.P.get()));
                                    ozVar.D = j12;
                                } else {
                                    rVar2 = rVar;
                                    j10 = intValue;
                                ...
                                if (j12 >= j11) {
                                    d.f20036b.post(new hz(ozVar, ozVar.f9285y, o10, j11));
                                } else if (ozVar.f9284x.E >= j10 && j12 > 0) {
                                }
                            } else {
                                rVar2 = rVar;
                            }
                            f0.f19676l.postDelayed(new f(21, ozVar), ((Long) rVar2.f17698c.a(sl.f10770i0)).longValue());
                            return;
                        }
                        throw new IOException("ExoPlayer was released during preloading.");
                    }
                    k.C.A.f5226u.remove(ozVar.B);
                    return;
                }
    ...
    private final void e() {
        ...
        try {
            ...
            if (((Boolean) r.e.f17698c.a(sl.Q5)).booleanValue()) {
        ...
        switch (this.f5873u) {
            ...
            case 18:
                ...
                while (txVar.e.get()) {
                    ...
                    f0.f19676l.post(new f(17, atomicBoolean));
                    try {
                        ...
                        if (!atomicBoolean.get()) {
                            ...
                            if (((Boolean) qlVar.a(nlVar)).booleanValue() && (be0Var = txVar.f11480b) != null) {
                                s a10 = be0Var.a();
                                a10.k("action", "panr");
                                if (((Boolean) qlVar.a(sl.Wf)).booleanValue() && (i = d.i(txVar.f11481c)) != null) {
                            ...
                            if (((Boolean) qlVar.a(sl.vf)).booleanValue()) {
                                ...
                                p pVar = new p("Potential ANR detected", 3);
                                ...
                                if (((Boolean) qlVar.a(sl.f11006wf)).booleanValue()) {
                                    ...
                                    k.C.f16817h.d("AnrWatchdog", pVar);
                                }
                            }
                        }
                        do {
            ...
            case 19:
                ...
                return;
            case 20:
                k.C.A.f5226u.remove((bz) this.f5874v);
                return;
            case gl.zzm /* 21 */:
                d();
                return;
            case 22:
                ...
                z zVar = q00Var.f9696u.m0;
                zVar.f19733c = true;
                if (zVar.f19732b) {
                    zVar.b();
                }
                d z02 = q00Var.f9696u.z0();
                if (z02 != null) {
            ...
            case 23:
                ...
                com.google.android.gms.internal.consent_sdk.c a11 = k.C.f16817h.a();
            ...
            case 25:
                ...
                if (ee.a("MULTI_PROFILE")) {
                    try {
                        ...
                        int i12 = a0.f19634b;
                        i.a("Unable to get ProfileStore instance: ".concat(valueOf));
                        try {
                            ...
                            i.a("Unable to get ProfileStore instance: ".concat(String.valueOf(e10.getMessage())));
                        }
                    }
                    if (profileStore != null) {
                        c10Var.f4942a = profileStore.getOrCreateProfile("GMA_WEBVIEW_PROFILE");
                        if (((Boolean) r.e.f17698c.a(sl.Df)).booleanValue()) {
                            k.C.f16819k.getClass();
                    ...
                    int i13 = a0.f19634b;
                    i.f("WebViewCompat failure: No instance");
                    if (((Boolean) r.e.f17698c.a(sl.Df)).booleanValue()) {
                        s a13 = be0Var2.a();
                ...
                int i14 = a0.f19634b;
                i.a("WebViewFeature.MULTI_PROFILE is not supported");
                return;
            case 26:
                ((h10) this.f5874v).b();
                return;
