...
public final class xf0 extends kw0 {
    ...
    public final void b() {
        ...
        synchronized (this) {
            try {
                if (!((Boolean) r.e.f17698c.a(sl.f10875oa)).booleanValue()) {
                    return;
                }
                if (this.f12564b == null) {
                    ...
                    if (sensorManager2 == null) {
                        int i = a0.f19634b;
                        i.f("Shake detection failed to initialize. Failed to obtain accelerometer.");
                        return;
                    }
                ...
                if (!this.f12568g && (sensorManager = this.f12564b) != null && (sensor = this.f12565c) != null) {
                    ...
                    this.f12568g = true;
                    a0.k("Listening for shake gestures.");
                }
            } catch (Throwable th) {
                throw th;
            }
