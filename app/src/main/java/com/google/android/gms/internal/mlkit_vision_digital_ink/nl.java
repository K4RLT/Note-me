...
public final class nl {
    ...
    public static final e5 f14707j = f(1, new Object[]{"optional-module-barcode", "com.google.android.gms.vision.barcode"}, null);
    ...
    public nl(Context context, k kVar, ll llVar) {
        int i10;
        new HashMap();
        new HashMap();
        this.f14708a = context.getPackageName();
        this.f14709b = c.a(context);
        this.f14711d = kVar;
        this.f14710c = llVar;
        jm.h();
        ...
        a11.getClass();
        this.f14712f = e.b(f1Var2);
        e5 e5Var = f14707j;
        if (e5Var.containsKey("digital-ink-recognition")) {
            i10 = d.d(context, (String) e5Var.get("digital-ink-recognition"), false);
        } else {
            i10 = -1;
        }
        this.f14714h = i10;
