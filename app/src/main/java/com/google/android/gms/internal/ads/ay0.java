...
public abstract /* synthetic */ class ay0 implements q2 {
    ...
    public static void Q(tk0 tk0Var) {
        ...
        throw b(String.format("Invalid language tag bytes number: %d. Must be between 2 and 42.", Integer.valueOf(h3)));
    }
    ...
    public static void h(int i, String str, Throwable th) {
        String f10 = a.f(i, "Ad failed to load : ", new StringBuilder(String.valueOf(i).length() + 20));
        int i10 = a0.f19634b;
        i.e(f10);
        a0.l(str, th);
        if (i == 3) {
        ...
        if ((str.length() & 1) == 0) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (digit != -1 && digit2 != -1) {
                    ...
                    x.n("input is not hexadecimal");
                    return null;
                }
            }
            return bArr;
        }
        x.n("Expected a string of even length");
        return null;
    }
    ...
    */
    ...
    public static void p(Context context, boolean z3) {
        ...
        String o10 = a.o(new StringBuilder(String.valueOf(c10).length() + FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH), "Use RequestConfiguration.Builder().setTestDeviceIds(Arrays.asList(\"", c10, "\")) to get test ads on this device.");
        int i10 = a0.f19634b;
        i.e(o10);
    }
    ...
    */
    ...
    public static byte[] t(String str, boolean z3) {
        ...
        if (h3.length == 0 && str.length() > 0) {
            x.n("Unable to decode ".concat(str));
            return null;
        }
        return h3;
    }
    ...
    */
    ...
    public static long y(ByteBuffer byteBuffer) {
        ...
        n.b("I don't know how to deal with UInt64! long is not sufficient and I don't want to use BigInt");
        return 0L;
    }
