...
public final class jx1 implements by1, kw1 {
    ...
    public jx1(lx1 lx1Var, Object obj) {
        this.f7564d = lx1Var;
        Object obj2 = null;
        this.f7562b = new i0.m((CopyOnWriteArrayList) lx1Var.f6917c.f18054v, 11, obj2);
    ...
    public final boolean a(yx1 yx1Var) {
        ...
        lx1Var.u(obj);
        i0.m mVar = this.f7562b;
        mVar.getClass();
        if (!Objects.equals((yx1) mVar.f18055w, yx1Var2)) {
            this.f7562b = new i0.m((CopyOnWriteArrayList) lx1Var.f6917c.f18054v, 11, yx1Var2);
        }
