...
public final class wm extends ym {
    ...
    public wm(byte[] bArr, int i, int i10) {
        if (bArr != null) {
            ...
            if ((i | i10 | (length - i11)) >= 0) {
                ...
                StringBuilder n10 = g3.a.n("Array range is invalid. Buffer.length=", length, ", offset=", ", length=", i);
                n10.append(i10);
    ...
    public final void C(byte[] bArr, int i) {
        try {
            ...
            throw new af.c(this.f15191f, this.e, i, e, 7);
        }
    }
    ...
    public final void m(int i) {
        ...
        try {
            ...
            throw new af.c(i10, this.e, 4, e, 7);
        }
    }
        ...
        while (true) {
            ...
            if (i12 == 0) {
                ...
                try {
                    ...
                    throw new af.c(i10, this.e, 1, e, 7);
                }
            }
            throw new af.c(i10, this.e, 1, e, 7);
        }
