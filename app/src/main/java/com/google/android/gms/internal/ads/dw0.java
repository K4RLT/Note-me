...
public final class dw0 {
    ...
    public static dw0 a(Context context, String str) {
        ...
        try {
            try {
                try {
                    IBinder b10 = pa.d.c(context, pa.d.f22621b, ModuleDescriptor.MODULE_ID).b("com.google.android.gms.gass.internal.clearcut.GassDynamiteClearcutLogger");
                    if (b10 == null) {
                        ohVar = 0;
                    } else {
