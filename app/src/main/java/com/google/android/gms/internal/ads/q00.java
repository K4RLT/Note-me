...
public final class q00 extends FrameLayout implements h00 {
    ...
    public final void B0() {
        ...
        if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue() && (H0 = s00Var.H0()) != null) {
            synchronized (H0) {
                ...
                if (xt0Var != null) {
                    ...
                    v80.p(new ac.a(xt0Var, 19, textView));
                    return;
                }
                return;
            }
        ...
        if (((Boolean) rVar.f17698c.a(sl.f10792j6)).booleanValue() && (E0 = s00Var.E0()) != null && ((st0) E0.f4802b.A) == st0.HTML) {
            ...
            v80Var.getClass();
            v80.p(new ac.a(tt0Var, 18, textView));
        }
    }
    ...
    @Override // com.google.android.gms.internal.ads.h00
    public final int I() {
        if (((Boolean) g9.r.e.f17698c.a(sl.K4)).booleanValue()) {
    ...
    public final void O(int i) {
        ...
        if (lyVar != null) {
            if (((Boolean) g9.r.e.f17698c.a(sl.f10882p0)).booleanValue()) {
    ...
    @Override // com.google.android.gms.internal.ads.h00
    public final void Y0(j9.d dVar) {
        this.f9696u.Y0(dVar);
    }
    ...
    public final void destroy() {
        ...
        if (E0 != null) {
            ...
            b0Var.postDelayed(new p00(s00Var, 1), ((Integer) g9.r.e.f17698c.a(sl.f10776i6)).intValue());
        } else if (((Boolean) g9.r.e.f17698c.a(sl.f10807k6)).booleanValue() && (H0 = s00Var.H0()) != null) {
            k9.f0.f19676l.post(new com.google.android.gms.internal.mlkit_vision_digital_ink.ra(this, 11, H0));
        } else {
            s00Var.destroy();
        }
    }
    ...
    public final void onPause() {
        ...
        p8Var.getClass();
        fa.y.d("onPause must be called from the UI thread.");
    ...
    public final void r() {
        p8 p8Var = this.f9697v;
        p8Var.getClass();
        fa.y.d("onDestroy must be called from the UI thread.");
        ly lyVar = (ly) p8Var.f9423z;
        if (lyVar != null) {
            lyVar.f8183y.a();
            iy iyVar = lyVar.A;
    ...
    @Override // com.google.android.gms.internal.ads.h00
    public final void w0(j9.d dVar) {
        this.f9696u.w0(dVar);
    }
