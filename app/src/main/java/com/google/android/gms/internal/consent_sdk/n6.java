...
public abstract class n6 {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (z3) {
                ...
                for (int i14 = 0; i14 < list.size(); i14++) {
                    ...
                    i13 += h((intValue >> 31) ^ (intValue + intValue));
                }
                i5Var.z(i13);
                while (i10 < list.size()) {
            ...
            if (!(list instanceof z5)) {
                ...
                if (z3) {
                    ...
                    for (int i12 = 0; i12 < list.size(); i12++) {
                        ...
                        i11 += i((longValue >> 63) ^ (longValue + longValue));
                    }
                    i5Var.z(i11);
                    while (i10 < list.size()) {
    ...
    public static void c(int i, List list, a6 a6Var, boolean z3) {
        if (list != null && !list.isEmpty()) {
            ...
            if (z3) {
                ...
                int i13 = 0;
                for (int i14 = 0; i14 < list.size(); i14++) {
                    i13 += h(((Integer) list.get(i14)).intValue());
                }
                i5Var.z(i13);
                while (i10 < list.size()) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!(list instanceof z5)) {
                ...
                if (z3) {
                    ...
                    int i11 = 0;
                    for (int i12 = 0; i12 < list.size(); i12++) {
                        i11 += i(((Long) list.get(i12)).longValue());
                    }
                    i5Var.z(i11);
                    while (i10 < list.size()) {
    ...
    public static int f(List list) {
        ...
        int i11 = 0;
        while (i < size) {
            i11 += i(((Integer) list.get(i)).intValue());
            i++;
        }
        return i11;
    }
    ...
    public static int j(List list) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            i += i(((Long) list.get(i10)).longValue());
        }
        return i;
    }
    ...
    public static int k(List list) {
        ...
        while (i < size) {
            ...
            i11 += h((intValue >> 31) ^ (intValue + intValue));
            i++;
        }
        return i11;
    }
    ...
    public static int l(List list) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            i += i((longValue >> 63) ^ (longValue + longValue));
        }
        return i;
    }
    ...
    public static int m(List list) {
        ...
        int i11 = 0;
        while (i < size) {
            i11 += h(((Integer) list.get(i)).intValue());
            i++;
        }
        return i11;
    }
    ...
    public static void r(int i, List list, a6 a6Var, boolean z3) {
        if (list != null && !list.isEmpty()) {
            ...
            if (z3) {
                ...
                int i13 = 0;
                for (int i14 = 0; i14 < list.size(); i14++) {
                    i13 += i(((Integer) list.get(i14)).intValue());
                }
                i5Var.z(i13);
                while (i10 < list.size()) {
