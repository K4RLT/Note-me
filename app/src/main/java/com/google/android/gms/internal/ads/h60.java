    ...
    public final Object call() {
        ...
        switch (i) {
            case 0:
                ...
                String str = (String) ((b) ((pr1) i60Var.f7029h).zzb()).get();
                if (((Boolean) r.e.f17698c.a(sl.U7)).booleanValue() && ((c0) i60Var.f7030j).t()) {
                    i10 = 1;
                }
                ...
                return new dv(bundle3, (a) i60Var.f7024b, (ApplicationInfo) i60Var.f7025c, str3, arrayList, packageInfo, str, str2, null, null, i10, ((aq0) i60Var.f7031k).a(), bundle2);
            case 1:
                ev evVar = (ev) ((hr0) obj2).f6877w.get();
                if (((Boolean) r.e.f17698c.a(sl.J2)).booleanValue() && (bundle = ((dv) obj3).G) != null) {
