...
public final class fp implements zx, ay, gr, hr, qu, q2, s81, n80 {
    ...
    public static final h00 e(final Context context, final x0 x0Var, final String str, final boolean z3, final boolean z9, final of ofVar, final hm hmVar, final a aVar, final jk0 jk0Var, final l lVar, final jj jjVar, final qp0 qp0Var, final sp0 sp0Var, final wh0 wh0Var, final cq0 cq0Var, final be0 be0Var) {
        sl.a(context);
        try {
            r31 r31Var = new r31() { // from class: com.google.android.gms.internal.ads.l00
                ...
                public final Object zza() {
                    ...
                    try {
                        ...
                        q00Var.setWebViewClient(k.C.f16815f.f(q00Var, jjVar2, z11, wh0Var2));
    ...
    public void mo205l(Object obj) {
        switch (this.f6143u) {
            case 2:
                a0.k("Ending javascript session.");
                fr frVar = (fr) ((er) obj);
                HashSet hashSet = frVar.f6152v;
                Iterator it = hashSet.iterator();
                while (it.hasNext()) {
                    AbstractMap.SimpleEntry simpleEntry = (AbstractMap.SimpleEntry) it.next();
                    a0.k("Unregistering eventhandler: ".concat(String.valueOf(((mp) simpleEntry.getValue()).toString())));
