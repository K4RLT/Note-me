...
public final class ry {
    ...
    static {
        boolean z3;
        if (p.f17688g.e.nextInt(100) < ((Integer) r.e.f17698c.a(sl.f10752ge)).intValue()) {
            z3 = true;
        } else {
            z3 = false;
        }
    ...
    public ry(Context context, a aVar, String str, wl wlVar, ul ulVar) {
        i0 i0Var = new i0(2);
        ...
        this.e = wlVar;
        this.f10340d = ulVar;
        String str2 = (String) r.e.f17698c.a(sl.f10803k0);
        if (str2 == null) {
        ...
        for (int i = 0; i < split.length; i++) {
            try {
                ...
                int i10 = a0.f19634b;
                i.g("Unable to parse frame hash target time number.", e);
                this.f10342g[i] = -1;
            }
        }
    }
    ...
    public final void b() {
        ...
        if (f10336r && !this.f10349o) {
            ...
            while (i < strArr.length) {
                ...
                double d10 = dArr2[i];
                int i10 = iArr[i];
                arrayList.add(new n(str, d2, d10, i10 / f0Var.f47b, i10));
                i++;
                f0Var = f0Var;
                strArr = strArr;
            }
                ...
                if (!f0Var2.f19680d.getAndSet(true)) {
                    SharedPreferences.OnSharedPreferenceChangeListener onSharedPreferenceChangeListener = new SharedPreferences.OnSharedPreferenceChangeListener() { // from class: k9.d0
                        ...
                        public final /* synthetic */ void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str6) {
                            f0.this.f19679c.set(b(context, str5));
                        }
                    };
            ...
            d.a(context, str4, bundle, new x90(context, 16, str4));
            this.f10349o = true;
        }
    }
    ...
    public final void c(iy iyVar) {
        ...
        if (this.f10345k && !this.f10346l) {
            if (a0.m() && !this.f10346l) {
                a0.k("VideoMetricsMixin first frame");
            }
        ...
        long longValue = ((Long) r.e.f17698c.a(sl.l0)).longValue();
        long k3 = iyVar.k();
        int i10 = 0;
        while (true) {
