...
public abstract class lp {
    ...
    public static b a(h00 h00Var, String str) {
        String str2;
        Uri parse = Uri.parse(str);
        try {
            of T0 = h00Var.T0();
            cq0 i02 = h00Var.i0();
            if (((Boolean) r.e.f17698c.a(sl.f10988vd)).booleanValue() && i02 != null) {
    ...
    public static void b(Map map, f90 f90Var) {
        if (((Boolean) r.e.f17698c.a(sl.f10734fc)).booleanValue() && map.containsKey("sc") && ((String) map.get("sc")).equals("1") && f90Var != null) {
            f90Var.M();
        }
    }
}
