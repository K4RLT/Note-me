...
public final class va1 extends ca1 {
    ...
    public static va1 h0(q91 q91Var, bl0 bl0Var, Integer num) {
        ...
        throw new GeneralSecurityException(a5.a.f(length, "ChaCha20Poly1305 key must be constructed with key of length 32 bytes, not ", new StringBuilder(String.valueOf(length).length() + 74)));
    }
