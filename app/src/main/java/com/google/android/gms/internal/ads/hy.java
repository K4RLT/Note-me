...
public final class hy extends iy implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public final void D() {
        ...
        be0 be0Var;
        a0.k("AdMediaPlayerView init MediaPlayer");
        ...
        if (this.D != null && surfaceTexture2 != null) {
            ...
            try {
                ...
                this.G = 0;
                if (this.I) {
                    if (((Boolean) r.e.f17698c.a(sl.Qe)).booleanValue() && (be0Var = this.f6925z) != null) {
                        s a10 = be0Var.a();
                ...
                e = e;
                i.g("Failed to initialize MediaPlayer at ".concat(String.valueOf(this.D)), e);
                onError(this.C, 1, 0);
    ...
    public final void E(boolean z3) {
        a0.k("AdMediaPlayerView release");
        py pyVar = this.H;
        if (pyVar != null) {
            pyVar.b();
            this.H = null;
    ...
    @Override // com.google.android.gms.internal.ads.iy
    public final void h() {
        a0.k("AdMediaPlayerView play");
        if (F()) {
            this.C.start();
            G(3);
            this.f7251u.f8892c = true;
            f0.f19676l.post(new fy(this, 3));
        }
        this.B = 3;
    }
    ...
    @Override // com.google.android.gms.internal.ads.iy
    public final void i() {
        a0.k("AdMediaPlayerView pause");
        if (F() && this.C.isPlaying()) {
            this.C.pause();
            G(4);
            f0.f19676l.post(new fy(this, 4));
        }
        this.B = 4;
    }
    ...
    public final void onCompletion(MediaPlayer mediaPlayer) {
        a0.k("AdMediaPlayerView completion");
        G(5);
        this.B = 5;
        f0.f19676l.post(new fy(this, 0));
    }
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i, int i10) {
        ...
        String l10 = a.l(new StringBuilder(String.valueOf(str).length() + 38 + String.valueOf(str2).length()), "AdMediaPlayerView MediaPlayer error: ", str, ":", str2);
        int i11 = a0.f19634b;
        i.f(l10);
        G(-1);
        this.B = -1;
        f0.f19676l.post(new r1(this, str, str2));
        return true;
    }
    ...
    */
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        a0.k("AdMediaPlayerView prepared");
        G(2);
        ry ryVar = this.f6923x;
        ...
        f0.f19676l.post(new a(8, this, mediaPlayer, false));
        ...
        if (this.f6924y && F() && this.C.getCurrentPosition() > 0 && this.B != 3) {
            a0.k("AdMediaPlayerView nudging MediaPlayer");
            ...
            if (mediaPlayer2 != null) {
                ...
                i.f("AdMediaPlayerView setMediaPlayerVolume() called before onPrepared().");
            }
            this.C.start();
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i10) {
        a0.k("AdMediaPlayerView surface created");
        D();
        f0.f19676l.post(new fy(this, 1));
    }

    @Override // android.view.TextureView.SurfaceTextureListener
    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        a0.k("AdMediaPlayerView surface destroyed");
        MediaPlayer mediaPlayer = this.C;
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i10) {
        a0.k("AdMediaPlayerView surface changed");
        int i11 = this.B;
        boolean z3 = false;
        ...
        f0.f19676l.post(new gy(this, i, i10, 0));
    }
    ...
    public final void onWindowVisibilityChanged(int i) {
        ...
        sb2.append(i);
        a0.k(sb2.toString());
        f0.f19676l.post(new i(this, i, 4));
    ...
    public final String toString() {
        ...
        return a.o(new StringBuilder(name.length() + 1 + String.valueOf(hexString).length()), name, "@", hexString);
    }
}
