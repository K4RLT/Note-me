                ...
                switch (c10) {
                    case 1718776947:
                        if (i12 == 2) {
                            ...
                            if (str3 == null) {
                                a.t(new StringBuilder(String.valueOf(c14).length() + 44), "Ignoring track with unsupported compression ", c14, "StreamFormatChunk");
                                break;
                            } else {
                                rv1 rv1Var = new rv1();
                                rv1Var.f10314u = c12;
                            ...
                            if (str2 == null) {
                                a.t(new StringBuilder(String.valueOf(M).length() + 43), "Ignoring track with unsupported format tag ", M, "StreamFormatChunk");
                                break;
                            } else {
                                int M2 = xk0Var.M();
                                int c15 = xk0Var.c();
