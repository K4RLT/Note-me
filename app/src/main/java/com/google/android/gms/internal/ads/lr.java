...
public final class lr implements j81 {
    ...
    public b a(Object obj) {
        yx yxVar = new yx();
        br d2 = ((dr) this.e).d();
        a0.k("callJs > getEngine: Promise created");
    ...
    public final b l(Object obj) {
        ...
        switch (this.f8108a) {
            ...
            case 1:
                ...
                builder.appendQueryParameter((String) r.e.f17698c.a(sl.Eb), "10");
            ...
            case 2:
                ...
                if (((Boolean) r.e.f17698c.a(sl.f10846mf)).booleanValue()) {
                    if (mwVar != null) {
                        e10.j0().S = mwVar;
                    }
                    e10.j0().Q = aVar;
            ...
            case 4:
                ...
                d2.j(qp0Var.E);
                d2.zza();
                b Y = ed1.Y(di0Var.a(wp0Var, qp0Var), qp0Var.R, TimeUnit.MILLISECONDS, uj0Var.f11646f);
    ...
    public /* synthetic */ lr(ac0 ac0Var, String str, mw mwVar, a aVar) {
        this.f8108a = 2;
        this.f8110c = ac0Var;
        this.f8109b = str;
        this.f8111d = mwVar;
