...
public final /* synthetic */ class ho0 implements so0, s81, a, r31, p31, wd1, td1, md1, xc1, vc1, od1 {
    ...
    public v91 c(zd1 zd1Var) {
        ...
        switch (this.f6853u) {
            case 24:
                ...
                x.n("Wrong type URL in call to LegacyKmsAeadProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var.z())));
                return null;
            default:
                ...
                x.n("Wrong type URL in call to LegacyKmsEnvelopeAeadProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var2.z())));
                return null;
        }
    }
    ...
    public xy d(yd1 yd1Var) {
        ...
        x.n("Wrong type URL in call to LegacyKmsAeadProtoSerialization.parseKey");
        return null;
    }
    ...
    public /* synthetic */ void mo202r(Object obj) {
        a0.k("Notification of cache hit successful.");
    }

    @Override // com.google.android.gms.internal.ads.s81
    public void t(Throwable th) {
        a0.k("Notification of cache hit failed.");
    }
