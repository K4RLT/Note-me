...
public final class ef0 extends kw0 {
    ...
    public final void b() {
        ...
        synchronized (this) {
            try {
                if (!((Boolean) g9.r.e.f17698c.a(sl.f10955ta)).booleanValue()) {
                    return;
                }
                if (!this.f5682j && (sensorManager = this.f5675a) != null && (sensor = this.f5676b) != null) {
                    sensorManager.registerListener(this, sensor, 2);
                    this.f5682j = true;
                    k9.a0.k("Listening for flick gestures.");
                }
                if (this.f5675a != null && this.f5676b != null) {
                    return;
                }
                int i = k9.a0.f19634b;
                l9.i.f("Flick detection failed to initialize. Failed to obtain gyroscope.");
            } catch (Throwable th) {
                throw th;
            }
        }
