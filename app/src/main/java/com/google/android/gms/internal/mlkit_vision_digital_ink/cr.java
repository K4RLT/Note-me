...
public final class cr extends HttpsURLConnection {
    ...
    */
    public cr(java.net.URL r2, q r3) {
        /*
            r1 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_vision_digital_ink.cr.<init>(java.net.URL, q):void");
    }
    ...
    public final k a() {
        ...
        x.o("Connection has not yet been established");
        return null;
    }
    ...
    public final void setHostnameVerifier(HostnameVerifier hostnameVerifier) {
        br brVar = this.f14166b;
        q qVar = brVar.f14102a;
        qVar.getClass();
        p pVar = new p(qVar);
        if (hostnameVerifier != null) {
            pVar.f18552m = hostnameVerifier;
            brVar.f14102a = new q(pVar);
        } else {
            q.h("hostnameVerifier == null");
        }
    }
