...
public final class bi implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    public static final long I = ((Long) g9.r.e.f17698c.a(sl.U1)).longValue();
    ...
    public final void b() {
        k9.f0.f19676l.post(new f(8, this));
    }
    ...
    */
    ...
    public final void e(View view) {
        ...
        if (application != null) {
            try {
                ...
                int i = k9.a0.f19634b;
                l9.i.d("Error registering activity lifecycle callbacks.", e);
            }
        }
    }
    ...
    public final void f(View view) {
        try {
            ...
            int i = k9.a0.f19634b;
            l9.i.d("Error while unregistering listeners from the last ViewTreeObserver.", e);
        }
        try {
            ...
            l9.i.d("Error while unregistering listeners from the ViewTreeObserver.", e8);
        }
        hg hgVar = this.f4799y;
        if (hgVar != null) {
            try {
                f9.k.C.f16834z.d(this.f4795u, hgVar);
            } catch (IllegalStateException e10) {
                int i11 = k9.a0.f19634b;
                l9.i.d("Failed trying to unregister the receiver", e10);
            } catch (Exception e11) {
                f9.k.C.f16817h.d("ActiveViewUnit.stopScreenStatusMonitoring", e11);
            }
            this.f4799y = null;
        }
        Application application = this.f4796v;
        if (application != null) {
            try {
                ...
                l9.i.d("Error registering activity lifecycle callbacks.", e12);
            }
        }
    }
