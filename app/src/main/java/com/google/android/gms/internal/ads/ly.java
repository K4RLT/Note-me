...
public final class ly extends FrameLayout {
    ...
    public final void f() {
        boolean z3 = false;
        if (((Boolean) r.e.f17698c.a(sl.f11042z2)).booleanValue()) {
    ...
    public final void l(int i, int i10, int i11, int i12) {
        if (a0.m()) {
            ...
            a.r(i, i10, "Set video bounds to x:", ";y:", sb2);
            sb2.append(";w:");
            sb2.append(i11);
            sb2.append(";h:");
            sb2.append(i12);
    ...
    public final void onWindowFocusChanged(boolean z3) {
        ...
        f0.f19676l.post(new ky(this, z3, 1));
    }
    ...
    public final void onWindowVisibilityChanged(int i) {
        ...
        f0.f19676l.post(new ky(this, z3, 0));
    }
}
