...
public final class q40 implements k70, b70 {
    ...
    public q40(Context context, h00 h00Var, qp0 qp0Var, a aVar, ai0 ai0Var) {
        this.f9737u = context;
        this.f9738v = h00Var;
        this.f9739w = qp0Var;
        this.f9740x = aVar;
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [java.util.Map, r0] */
    ...
    */
    public final synchronized void e() {
        /*
            ...
            r r1 = r.e     // Catch: java.lang.Throwable -> L2c
            com.google.android.gms.internal.ads.ql r1 = r1.f17698c     // Catch: java.lang.Throwable -> L2c
            java.lang.Object r0 = a(r0)     // Catch: java.lang.Throwable -> L2c
        ...
        L23:
            if (r0 == 0) goto L2e
            com.google.android.gms.internal.ads.ai0 r0 = r2.A     // Catch: java.lang.Throwable -> L2c
            b()     // Catch: java.lang.Throwable -> L2c
            monitor-exit(r2)
            return
        L2c:
            r0 = move-exception
        ...
        L2e:
            ...
            return
        L34:
            a()     // Catch: java.lang.Throwable -> L2c
            monitor-exit(r2)
            return
        L39:
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [java.util.Map, r0] */
    ...
    */
    public final synchronized void y() {
        /*
            ...
            r r1 = r.e     // Catch: java.lang.Throwable -> L2d
            com.google.android.gms.internal.ads.ql r1 = r1.f17698c     // Catch: java.lang.Throwable -> L2d
            java.lang.Object r0 = a(r0)     // Catch: java.lang.Throwable -> L2d
        ...
        L24:
            if (r0 == 0) goto L2f
            com.google.android.gms.internal.ads.ai0 r0 = r3.A     // Catch: java.lang.Throwable -> L2d
            c()     // Catch: java.lang.Throwable -> L2d
            monitor-exit(r3)
            return
        L2d:
            r0 = move-exception
        ...
        L2f:
            ...
            if (r0 != 0) goto L36
            a()     // Catch: java.lang.Throwable -> L2d
        L36:
            ...
            if (r0 == 0) goto L50
            e r2 = new e     // Catch: java.lang.Throwable -> L2d
            r2.<init>(r1)     // Catch: java.lang.Throwable -> L2d
            java.lang.String r1 = "onSdkImpression"
            b(r1, r2)     // Catch: java.lang.Throwable -> L2d
            monitor-exit(r3)
            return
        L50:
            monitor-exit(r3)
