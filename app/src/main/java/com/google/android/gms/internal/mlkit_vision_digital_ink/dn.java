...
public final class dn {
    ...
    public static int a(gp gpVar, int i, Object obj) {
        ...
        switch (gpVar.ordinal()) {
            ...
            case 17:
                ...
                return c11 + i10;
            default:
                n.b("There is no way to get here, but the compiler thinks otherwise.");
                return 0;
        }
    }
    ...
    public static boolean i(Map.Entry entry) {
        if (((ln) entry.getKey()).f14605v.f14377u == hp.C) {
            ...
            x.n("Wrong object type used with protocol message reflection.");
            return false;
        }
        return true;
    }
    ...
    */
    public final boolean g() {
        ...
        L6:
            if (r3 >= r1) goto L16
            com.google.android.gms.internal.mlkit_vision_digital_ink.uo r4 = c(r3)
            boolean r4 = i(r4)
            if (r4 != 0) goto L13
            goto L30
        L13:
