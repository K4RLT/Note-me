    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        switch (this.f5567a) {
            case 0:
                ...
                return;
            default:
                g gVar = (g) this.f5568b;
                String str = (String) this.f5569c;
                f0 f0Var = k.C.f16813c;
                f0.s(gVar.f19686a, Intent.createChooser(new Intent("android.intent.action.SEND").setType("text/plain").putExtra("android.intent.extra.TEXT", str), "Share via"));
                return;
        }
    }
}
