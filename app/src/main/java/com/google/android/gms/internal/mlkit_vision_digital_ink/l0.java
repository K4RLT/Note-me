                    ...
                    if (i10 != 1) {
                        if (i10 != 2) {
                            if (i10 != 3) {
                                ...
                                sq x9 = oqVar.x();
                                pa.p(x9.x());
                                str = a.k("zip(target=", b(x9.v()), ")");
                            }
                        } else {
                            mq v2 = oqVar.v();
                            if (v2.v()) {
                                str = a.k("integrity(sha256=", b(v2.u()), ")");
                            } else {
                                str = "integrity";
                            }
                        }
                        ...
                        lq u9 = oqVar.u();
                        if (u9.x()) {
                            str = a.k("encrypt(aes_gcm_key=", b(u9.v()), ")");
                        } else if (u9.w()) {
                            str = a.k("encrypt(aes_gcm_hkdf_key=", b(u9.u()), ")");
                        } else {
                            str = "encrypt";
                        }
                    }
