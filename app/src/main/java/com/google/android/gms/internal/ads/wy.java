...
public final class wy implements pf1 {
    ...
    public wy(Context context, tl1 tl1Var, String str, int i) {
        ...
        this.f12367x = i;
        new AtomicLong(-1L);
        this.f12368y = ((Boolean) r.e.f17698c.a(sl.f11010x2)).booleanValue();
    }
    ...
    public final long a(dj1 dj1Var) {
        ...
        x.p("Attempt to open an already open CacheDataSource.");
        return 0L;
    }
    ...
    public final int e(byte[] bArr, int i, int i10) {
        ...
        x.p("Attempt to read closed CacheDataSource.");
        return 0;
    }
    ...
    public final void k() {
        ...
        x.p("Attempt to close an already closed CacheDataSource.");
    }
}
