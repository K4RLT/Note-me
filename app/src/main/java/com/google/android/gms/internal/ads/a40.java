...
public final class a40 extends z40 {
    ...
    public a40(hb hbVar, Context context, h00 h00Var, int i, e eVar, s90 s90Var, jr0 jr0Var, y60 y60Var, sx sxVar, be0 be0Var) {
        super(hbVar);
        this.f4354v = false;
        this.f4344l = h00Var;
        this.f4346n = context;
        ...
        this.f4349q = jr0Var;
        this.f4350r = y60Var;
        this.f4351s = ((Boolean) r.e.f17698c.a(sl.f10937s6)).booleanValue();
        this.f4352t = sxVar;
        this.f4353u = be0Var;
    }
    ...
    public final void c(Activity activity, boolean z3) {
        ...
        if (!f0.m(s90Var.zzb())) {
            ...
            if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
                f0.l(activity2, this.f13068b, this.f4353u);
            }
            if (((Boolean) rVar.f17698c.a(sl.f10787j1)).booleanValue() && f0.g(activity2)) {
                int i10 = a0.f19634b;
        ...
        if (((Boolean) r.e.f17698c.a(sl.f10912qd)).booleanValue() && (h00Var = this.f4344l) != null && (J = h00Var.J()) != null && J.f9955r0) {
            int i11 = J.f9957s0;
            ...
            if (i11 != i) {
                int i12 = a0.f19634b;
                i.f("The app open consent form has been shown.");
        ...
        if (this.f4354v) {
            int i13 = a0.f19634b;
            i.f("App open interstitial ad is already visible.");
