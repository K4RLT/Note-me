...
public final class c11 implements w01 {
            ...
            synchronized (this.f4948g) {
                try {
                    ...
                    if (d6Var != null) {
                        ...
                        ((f0) d6Var.f5318x).w(d6Var.f5316v, Optional.of(hashMap));
                    } else {
                        this.f4947f.b(20105);
                    }
                } finally {
    ...
    */
    ...
    public final void g(f0 f0Var, byte[] bArr, boolean z3) {
            ...
            synchronized (this.f4948g) {
                try {
                    ...
                    if (d6Var == null) {
                        ...
                        byte[] bArr = (byte[]) ((f0) d6Var.f5318x).w(d6Var.f5315u, Optional.of(hashMap));
                        p61 p61Var = r61.e;
