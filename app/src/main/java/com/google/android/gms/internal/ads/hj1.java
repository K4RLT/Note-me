...
public final class hj1 extends ak1 {
    ...
    public static hj1 h0(jj1 jj1Var, bl0 bl0Var) {
        ...
        throw new GeneralSecurityException(a.f(length, "Ed25519 key must be constructed with key of length 32 bytes, not ", new StringBuilder(String.valueOf(length).length() + 65)));
    }
