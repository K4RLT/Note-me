...
public final class x70 extends um1 {
    ...
    public x70(ScheduledExecutorService scheduledExecutorService, la.a aVar, be0 be0Var) {
    ...
    public final synchronized void V1(int i) {
        ...
        if (i > 0) {
            ...
            this.f12483x.getClass();
            long elapsedRealtime = SystemClock.elapsedRealtime();
            boolean booleanValue = ((Boolean) g9.r.e.f17698c.a(sl.Pe)).booleanValue();
            long j11 = this.A;
            if (booleanValue) {
                if (elapsedRealtime == j11) {
                    k9.a0.k("In scheduleShowRefreshedAd: currentTimeMs = scheduledShowTimeMs");
                }
                long j12 = this.A;
