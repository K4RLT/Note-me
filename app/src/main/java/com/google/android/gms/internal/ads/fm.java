...
public final class fm {
    ...
    public final s9.p f6108b;

    /* renamed from: c, reason: collision with root package name */
    public final s9.b f6109c;
    ...
    public fm(ScheduledExecutorService scheduledExecutorService, s9.p pVar, s9.b bVar, fe0 fe0Var) {
    ...
    public final void a(String str) {
        try {
            ...
            u.c.g(this.f6116l, new z8.g((z8.f) new c1.a(6).g(bundle)), emVar);
        } catch (JSONException e) {
            int i = k9.a0.f19634b;
            l9.i.d("Error creating JSON: ", e);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x004c, code lost:
        ...
        if (((java.lang.Boolean) g9.r.e.f17698c.a(com.google.android.gms.internal.ads.sl.f10842mb)).booleanValue() != false) goto L23;
     */
    /*
    ...
    */
    public final void d() {
        ...
        L7a:
            com.google.android.gms.internal.ads.f r1 = r7.e
    ...
    public final void e(JSONObject jSONObject) {
        try {
            if (this.f6115k == null) {
                this.f6115k = new JSONArray((String) g9.r.e.f17698c.a(sl.f10893pb));
            }
            jSONObject.put("eids", this.f6115k);
        } catch (JSONException e) {
            int i = k9.a0.f19634b;
            l9.i.d("Error fetching the PACT active eids JSON: ", e);
        }
    }
}
