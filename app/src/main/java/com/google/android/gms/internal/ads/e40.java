    ...
    private final void b() {
        ...
        synchronized (mg0Var.f9515v) {
            try {
                ...
                mg0Var.f9516w = true;
                cj cjVar = new cj(mg0Var.A, k.C.f16828t.a(), mg0Var, mg0Var, 2);
                mg0Var.f9519z = cjVar;
                cjVar.m();
            } catch (Throwable th) {
                throw th;
    ...
    public final void run() {
        ...
        switch (this.f5588u) {
            case 0:
                ...
                if (soVar != null) {
                    try {
                        k0 k0Var = (k0) f40Var.f5927s.zzb();
                        b bVar = new b(f40Var.f5920l);
                        Parcel g22 = soVar.g2();
                        qh.e(g22, k0Var);
                        qh.e(g22, bVar);
                        soVar.v2(g22, 1);
            ...
            case 5:
                ...
                synchronized (y60Var) {
                    int i10 = a0.f19634b;
                    i.c("Timeout waiting for show call succeed to be called.");
                ...
                synchronized (nf0Var) {
                    try {
                        ...
                        if (((Boolean) rVar.f17698c.a(nlVar)).booleanValue()) {
                            String str3 = k.C.f16817h.f9637g;
                        ...
                        jSONObject.put("isSimulator", d.q());
                        ...
                        k.C.f16817h.e("Inspector.toJson", e10);
                        int i13 = a0.f19634b;
                        i.g("Ad inspector encountered an error", e10);
                    } finally {
                    }
                }
            ...
            case 19:
                ...
                return;
            case 20:
                boolean booleanValue = ((Boolean) r.e.f17698c.a(sl.Pb)).booleanValue();
                Throwable th = (Throwable) this.f5589v;
                if (booleanValue) {
                    k.C.f16817h.f("TopicsSignalUnsampled.fetchTopicsSignal", th);
                    return;
                } else {
                    k.C.f16817h.e("TopicsSignal.fetchTopicsSignal", th);
                    return;
                }
            case gl.zzm /* 21 */:
