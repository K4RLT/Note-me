...
public final /* synthetic */ class yh0 implements zh0 {
    ...
    public yh0(Class cls, Class[] clsArr) {
        ...
        for (Class cls2 : clsArr) {
            ...
            ((HashSet) this.f12881x).add(r.a(cls2));
        }
    }
    ...
    public void a(j jVar) {
        if (!((HashSet) this.f12881x).contains(jVar.f18407a)) {
            ...
            x.n("Components are not allowed to depend on interfaces they themselves provide.");
        }
    }

    public a b() {
        boolean z3;
        if (((d) this.f12883z) != null) {
            z3 = true;
        } else {
            z3 = false;
        }
        if (z3) {
            return new a(this.f12878u, new HashSet((HashSet) this.f12881x), new HashSet((HashSet) this.f12882y), this.f12879v, this.f12880w, (d) this.f12883z, (HashSet) this.A);
        }
        x.o("Missing required property: factory.");
        return null;
    }
    ...
    public void c(int i) {
        ...
        if (z3) {
            ...
            x.o("Instantiation type has already been set.");
        }
    }
    ...
    public Object zza() {
        ...
        if (!TextUtils.isEmpty(str)) {
            if (!TextUtils.isEmpty(str2)) {
                ...
                if (k3 == yt0Var) {
                    int i11 = a0.f19634b;
                    i.f("Omid js session error; Unable to parse impression owner: javascript");
                    return null;
                }
                if (n10 == null) {
                    String x9 = wd0.x(i);
                    int i12 = a0.f19634b;
                    i.f("Omid js session error; Unable to parse creative type: ".concat(x9));
                    return null;
                }
                if (n10 == ut0.VIDEO && k4 == yt0Var) {
                    String valueOf = String.valueOf(str3);
                    int i13 = a0.f19634b;
                    i.f("Omid js session error; Video events owner unknown for video creative: ".concat(valueOf));
                    return null;
                }
