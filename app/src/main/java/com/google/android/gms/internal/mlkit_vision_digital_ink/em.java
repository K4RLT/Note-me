...
public class em implements ya {
    ...
    public static void e(Runnable runnable, Executor executor) {
        try {
            ...
            f14256y.logp(Level.SEVERE, "com.google.mlkit.shared.mdd.concurrent.AbstractResolvableFuture", "executeListener", a.l("RuntimeException while executing runnable ", String.valueOf(runnable), " with executor ", String.valueOf(executor)), (Throwable) e);
        }
    }
