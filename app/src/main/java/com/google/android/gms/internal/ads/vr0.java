...
public final class vr0 implements Runnable {
    ...
    public vr0(Context context, l9.a aVar, nd0 nd0Var, fp fpVar, h10 h10Var) {
        this.f11972u = context;
        this.f11973v = aVar;
        this.f11977z = nd0Var;
        this.B = h10Var;
        if (((Boolean) g9.r.e.f17698c.a(sl.Z9)).booleanValue()) {
            this.A = k9.f0.H();
        } else {
            ...
            synchronized (obj) {
                try {
                    ...
                    try {
                        ...
                        fh0 fh0Var = new fh0((String) g9.r.e.f17698c.a(sl.T9), 60000, new HashMap(), b10, "application/x-protobuf");
                        ...
                        f9.k.C.f16817h.e("CuiMonitor.sendCuiPing", e);
                    }
                } catch (Throwable th) {
                    throw th;
                }
