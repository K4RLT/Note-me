...
public final class ms extends ph implements gs {
    ...
    @Override // com.google.android.gms.internal.ads.gs
    public final void V2(a aVar, a aVar2, a aVar3) {
        switch (this.f8406u) {
            case 0:
                HashMap hashMap = (HashMap) b.z1(aVar2);
                View view = (View) b.z1(aVar);
                e eVar = (e) ((z) this.f8407v);
                eVar.i = true;
                ...
                return;
            default:
                View view3 = (View) b.z1(aVar);
                ((com.google.ads.mediation.a) this.f8407v).getClass();
                if (g.f4017a.get(view3) != null) {
                    q.b();
                    return;
                }
                return;
    ...
    public final List b() {
        switch (this.f8406u) {
            case 0:
                ArrayList arrayList = ((z) this.f8407v).f21214b;
    ...
    public final a j() {
        switch (this.f8406u) {
            case 0:
                View view = ((z) this.f8407v).f21218g;
                if (view == null) {
                    return null;
                }
                return new b(view);
    ...
    public final z1 n() {
        ...
        switch (this.f8406u) {
            case 0:
                return null;
            default:
                s sVar = ((com.google.ads.mediation.a) this.f8407v).f4198j;
                if (sVar != null) {
