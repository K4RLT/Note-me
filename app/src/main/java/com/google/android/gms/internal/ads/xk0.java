...
public final class xk0 {
    ...
    public final int J() {
        ...
        x.l(a.f(i, i10, "position=", ", limit=", new StringBuilder(String.valueOf(i).length() + 17 + String.valueOf(i10).length())));
        return 0;
    }
    ...
    public final int h() {
        ...
        x.o(a.f(b10, "Top bit not zero: ", new StringBuilder(String.valueOf(b10).length() + 18)));
        return 0;
    }
    ...
    public final int i() {
        ...
        x.o(a.f(c10, "Top bit not zero: ", new StringBuilder(String.valueOf(c10).length() + 18)));
        return 0;
    }
    ...
    public final String n(Charset charset) {
        ...
        if (!charset.equals(StandardCharsets.UTF_8) && !charset.equals(charset2)) {
            ...
            if (!charset.equals(StandardCharsets.UTF_16) && !charset.equals(StandardCharsets.UTF_16LE) && !charset.equals(StandardCharsets.UTF_16BE)) {
                x.n("Unsupported charset: ".concat(String.valueOf(charset)));
                return null;
            }
        }
        int i10 = this.f12581b;
    ...
    public final long p() {
        ...
        for (int i = 0; i < 9; i++) {
            if (this.f12581b != this.f12582c) {
                ...
                x.o("Attempting to read a byte over the limit.");
                return 0L;
            }
        }
        return j10;
    ...
    public final int t(Charset charset) {
        ...
        x.l(a.f(i18, i19, "position=", ", limit=", new StringBuilder(String.valueOf(i18).length() + 17 + String.valueOf(i19).length())));
        return 0;
    }
    ...
    public final void v(int i) {
        if (f12579g.get() && B() < i) {
            int B = B();
            x.l(a.f(i, B, "bytesNeeded= ", ", bytesLeft=", new StringBuilder(String.valueOf(i).length() + 25 + String.valueOf(B).length())));
        }
    }
