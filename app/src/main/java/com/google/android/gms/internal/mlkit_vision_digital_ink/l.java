...
public abstract class l {
    ...
    public static void a(String str) {
        Set set = f14584d;
        pa.h(set.contains(str), "The only supported locations are %s: %s", set, str);
    }

    public static void b(String str) {
        pa.h(f14581a.matcher(str).matches(), "Module must match [a-z]+(_[a-z]+)*: %s", str);
        pa.h(!f14583c.contains(str), "Module name is reserved and cannot be used: %s", str);
    }
}
