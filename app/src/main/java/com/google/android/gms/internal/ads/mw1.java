...
public final class mw1 {
    ...
    public mw1(rv1 rv1Var) {
        ...
        if (i13 != -1 && i14 != -1 && Integer.bitCount(i14) != i13) {
            q.x.o(ay0.B("channelCount and channelMask are inconsistent. channelCount=%s, channelMask=%s", Integer.valueOf(i13), Integer.valueOf(i14)));
            throw null;
        }
        this.J = rv1Var.I;
        this.K = rv1Var.J;
    ...
    public static String c(mw1 mw1Var) {
        ...
        if (i13 != -1 && (i10 = mw1Var.f8467w) != -1) {
            g3.a.r(i13, i10, ", res=", "x", sb2);
        }
        int i14 = mw1Var.f8468x;
        if (i14 != -1 && (i = mw1Var.f8469y) != -1) {
            g3.a.r(i14, i, ", decRes=", "x", sb2);
        }
        float f10 = mw1Var.C;
        int i15 = z61.f13094a;
        double d2 = f10;
        ...
        if (mk1Var != null) {
            ...
            if ((i17 != -1 && i16 != -1) || mk1Var.d()) {
                ...
                if (i17 != -1 && i16 != -1) {
                    StringBuilder sb4 = new StringBuilder(g3.a.d(i17, 1) + String.valueOf(i16).length());
                    sb4.append(i17);
                    sb4.append("/");
                    sb4.append(i16);
                    str3 = sb4.toString();
                    ...
                    if (i26 != 2) {
                        if (i26 != 3) {
                            if (i26 == 4) {
                                ...
                                q.x.o("Unsupported auxiliary track type");
                                return null;
                            }
                        } else {
                            str = "depth-inverse";
    ...
    public final String toString() {
        ...
        g3.a.t(sb2, "Format(", str, ", ", str2);
        g3.a.t(sb2, ", ", str3, ", ", str4);
        sb2.append(", ");
        sb2.append(str5);
        sb2.append(", ");
        sb2.append(i);
