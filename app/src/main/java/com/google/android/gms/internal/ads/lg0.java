    ...
    public lg0(Context context, wx wxVar, int i) {
        ...
        switch (i) {
            case 1:
                this.B = context;
                this.C = wxVar;
                this.f9519z = new cj(context, f9.k.C.f16828t.a(), this, this, 2);
                return;
            default:
                this.B = context;
                this.C = wxVar;
                    ...
                    try {
                        if (!this.f9517x) {
                            ...
                            try {
                                ...
                                f9.k.C.f16817h.d("RemoteAdRequestClientTask.onConnected", th);
                                this.f9514u.c(new cg0(1));
                            }
                        }
                    } catch (Throwable th2) {
                    ...
                    try {
                        if (!this.f9517x) {
                            ...
                            try {
                                ...
                                f9.k.C.f16817h.d("RemoteSignalsClientTask.onConnected", th3);
                                this.f9514u.c(new cg0(1));
                            }
                        }
                    } catch (Throwable th4) {
