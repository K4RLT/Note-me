                                        ...
                                        if (i13 != 1342177280) {
                                            if (i13 != 1610612736) {
                                                if (i13 != 1879048192) {
                                                    if (i13 != 1895825408) {
                                                        if (i13 != 1912602624) {
                                                            x.o(a.f(i13, "Unexpected encoding: ", new StringBuilder(String.valueOf(i13).length() + 21)));
                                                            return;
                                                        }
                                                    }
                                                }
        ...
        if (bq0.d(i)) {
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                ...
                if (a10 < i11) {
                    ...
                    throw new i10(a.o(new StringBuilder(d71Var2.length() + 59), "Channel map (", d71Var2, ") trying to access non-existent input channel."), a00Var);
                }
            }
            if (z3) {
