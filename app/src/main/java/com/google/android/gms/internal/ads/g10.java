...
public final class g10 implements sr1 {
    ...
    public final Object zzb() {
        ...
        switch (this.f6252a) {
            ...
            case 2:
                if (((Boolean) r.e.f17698c.a(sl.E3)).booleanValue()) {
            ...
            case 11:
                ...
                CookieManager b10 = k.C.f16815f.b();
                ...
                return new k60(kr0Var2, k60Var.f7666a, (String) k60Var.f7667b, (b) k60Var.f7668c, (List) k60Var.f7669d, ed1.U((b) k60Var.e, Exception.class, x20Var, wxVar7)).j();
            case 12:
                wx wxVar8 = xx.f12651a;
                lo1.b(wxVar8);
                om0 om0Var = new om0(wxVar8, 2);
                a aVar = (a) this.f6253b.zzb();
                lo1.b(wxVar8);
                return new nm0(om0Var, ((Long) nm.f8761f.p()).longValue(), aVar, wxVar8, (be0) this.f6254c.zzb());
            case 13:
                return new pp0((a) this.f6253b.zzb(), (be0) this.f6254c.zzb());
            case 14:
                return new ht0((it0) this.f6253b.zzb(), (ct0) this.f6254c.zzb());
            case 15:
                f fVar = (f) this.f6253b.zzb();
