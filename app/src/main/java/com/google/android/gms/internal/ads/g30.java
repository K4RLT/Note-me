...
public final class g30 {
    ...
    public g30(Context context, c0 c0Var, ci0 ci0Var, jd0 jd0Var, wx wxVar, wx wxVar2, ScheduledExecutorService scheduledExecutorService) {
        this.f6280a = context;
        this.f6281b = c0Var;
        this.f6282c = ci0Var;
        this.f6283d = jd0Var;
    ...
    public static boolean b(String str) {
        ...
        return str.contains((CharSequence) r.e.f17698c.a(sl.Cb));
    }

    public final b a(String str, Random random) {
        if (TextUtils.isEmpty(str)) {
            return ed1.e(str);
        }
    ...
    public final b c(String str, MotionEvent motionEvent, Random random) {
        Exception exc;
        b A;
        try {
            nl nlVar = sl.Cb;
