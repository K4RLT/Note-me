...
public final class mu0 implements q7 {
    ...
    */
    ...
    public final String toString() {
                ...
                if (i != 23) {
                    if (i != 67) {
                        ...
                        if (z9) {
                            ...
                            q.x.n(ay0.B("array too small: %s < %s", Integer.valueOf(length), 4));
                            return null;
                        }
                    }
                } else {
                    ...
                    if (z3) {
                        ...
                        q.x.n(ay0.B("array too small: %s < %s", Integer.valueOf(length2), 4));
                        return null;
                    }
                }
            } else {
        ...
        return a5.a.l(new StringBuilder(String.valueOf(str).length() + 18 + String.valueOf(sb2).length()), "mdta: key=", str, ", value=", sb2);
    }
}
