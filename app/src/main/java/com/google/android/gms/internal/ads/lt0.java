        ...
        switch (this.f8134u) {
            case 0:
                ...
                if (obj != null) {
                    ...
                    g9.v1 j12 = dt0Var.j(obj2);
                    dt0Var.f5509r.getClass();
                    long currentTimeMillis = System.currentTimeMillis();
                    if (dt0Var.f5507p.get()) {
                        k9.f0.f19676l.post(new com.google.android.gms.internal.mlkit_vision_digital_ink.ra(dt0Var, j12));
                    }
                    ...
                    if (dt0Var.f5498f != null) {
                        if (((Boolean) g9.r.e.f17698c.a(sl.I)).booleanValue()) {
