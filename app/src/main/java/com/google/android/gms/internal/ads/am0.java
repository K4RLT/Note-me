...
public final class am0 implements qn0 {
    ...
    public final b zza() {
        switch (this.f4538a) {
            ...
            case 2:
                a0.k("HsdpMigrationSignal.produce");
                if (((Boolean) r.e.f17698c.a(sl.f10845me)).booleanValue()) {
                    boolean z3 = false;
                    try {
                        if (((Intent) this.f4540c).resolveActivity(((Context) this.f4539b).getPackageManager()) != null) {
                            a0.k("HSDP intent is supported");
                            z3 = true;
                        }
                    } catch (Exception e) {
                        k.C.f16817h.d("HsdpMigrationSignal.isHsdpMigrationSupported", e);
                    }
