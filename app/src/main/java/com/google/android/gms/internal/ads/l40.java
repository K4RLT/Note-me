    ...
    public final Object zzb() {
        switch (this.f7935a) {
            ...
            case 2:
                return new uw(((o10) this.f7936b).a(), ((o60) this.f7937c).a().f4583g);
            case 3:
                r rVar = (r) this.f7936b.zzb();
                a aVar = (a) this.f7937c.zzb();
                wx wxVar = xx.f12651a;
                lo1.b(wxVar);
            ...
            case 7:
                return new nl0((nm0) this.f7936b.zzb(), ((Integer) r.e.f17698c.a(sl.Ld)).intValue(), (ScheduledExecutorService) this.f7937c.zzb());
            case 8:
                return new nl0((nm0) this.f7936b.zzb(), ((Integer) r.e.f17698c.a(sl.yd)).intValue(), (ScheduledExecutorService) this.f7937c.zzb());
            case 9:
