                ...
                if (b10 != 1) {
                    if (b10 != 2) {
                        ...
                        try {
                            ...
                            ra.e eVar = dtVar.f14217f;
                            eVar.getClass();
                            cx.l("%s: submitting request to add in-progress download future with key: %s", f8Var);
                            int i11 = 0;
                            lx y10 = lx.w(((s5) eVar.f24675v).i(new ra.e(24, eVar, f8Var, x9), (Executor) eVar.f24676w)).y(new bt(zaVar, x9, 0), ebVar);
                            lx y11 = y10.y(new r0(dtVar, 7, htVar), ebVar).y(new vs(y10, i11), ebVar);
                            y11.g(new ra(y11, i11, new pw(q1.b(), 12, new x90(13, dtVar, htVar, false))), ebVar);
                            return y11;
                        } catch (xn e) {
                            return n5.l(e);
                        }
