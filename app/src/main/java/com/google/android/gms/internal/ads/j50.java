...
public final class j50 implements sr1 {
    ...
    public i60 b() {
        ...
        lo1.b(packageName);
        nl nlVar = sl.f10642a;
        return new i60(kr0Var, a10, applicationInfo, packageName, r.e.f17696a.F(), (PackageInfo) this.i.zzb(), rr1.b(this.f7326c), ((l10) this.f7331j).zzb(), (String) this.f7327d.zzb(), ((ee0) this.f7332k).a(), ((o60) this.f7328f).a(), (l80) ((rr1) this.f7333l).zzb());
    }
    ...
    public final Object zzb() {
        switch (this.f7324a) {
            case 0:
                ...
                m mVar = new m(5, ((ur1) axVar.f4622b).zzb(), ((ur1) axVar.f4623c).zzb(), false);
