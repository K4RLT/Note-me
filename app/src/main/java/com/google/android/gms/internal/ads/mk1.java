...
public final class mk1 {
    ...
    public static String e(int i) {
        if (i != -1) {
            if (i != 6) {
                if (i != 1) {
                    if (i != 2) {
                        return a5.a.f(i, "Undefined color space ", new StringBuilder(String.valueOf(i).length() + 22));
                    }
                    return "BT601";
                }
                return "BT709";
                ...
                if (i != 1) {
                    if (i != 2) {
                        if (i != 3) {
                            if (i != 6) {
                                if (i != 7) {
                                    return a5.a.f(i, "Undefined color transfer ", new StringBuilder(String.valueOf(i).length() + 25));
                                }
                                return "HLG";
                            }
                            return "ST2084 PQ";
    ...
    public static String g(int i) {
        if (i != -1) {
            if (i != 1) {
                if (i != 2) {
                    return a5.a.f(i, "Undefined color range ", new StringBuilder(String.valueOf(i).length() + 22));
                }
    ...
    public final String toString() {
        ...
        if (i == -1) {
            ...
            str = p.a.j(i, "bit Luma", new StringBuilder(String.valueOf(i).length() + 8));
        }
        int i10 = this.f8367f;
        if (i10 != -1) {
            str2 = p.a.j(i10, "bit Chroma", new StringBuilder(String.valueOf(i10).length() + 10));
        }
        if (this.f8366d != null) {
            z3 = true;
        } else {
        ...
        StringBuilder sb2 = new StringBuilder(g3.a.v(str2, g3.a.v(str, g3.a.v(String.valueOf(z3), g3.a.v(g8, e.length() + 12, 2) + f10.length() + 2, 2), 2), 1));
