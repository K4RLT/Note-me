...
public final class ob0 implements ua0, g80 {
    ...
    public ob0(ds dsVar, es esVar, gs gsVar, a70 a70Var, u70 u70Var, q60 q60Var, e90 e90Var, Context context, qp0 qp0Var, a aVar, aq0 aq0Var) {
        this.G = dsVar;
        this.H = esVar;
        this.f9078u = gsVar;
        this.f9079v = a70Var;
    ...
    public final void A(View view) {
        ...
        try {
            ...
            if (gsVar != null && !gsVar.H1()) {
                gsVar.V(new b(view));
                q60Var.L();
                if (((Boolean) r.e.f17698c.a(sl.f10750gc)).booleanValue()) {
                    e90Var.M();
                    return;
                }
                return;
            ...
            int i = a0.f19634b;
            i.g("Failed to call handleClick", e);
        }
    }
    ...
    public final void a(View view, Map map, Map map2, View.OnTouchListener onTouchListener, View.OnClickListener onClickListener) {
        ...
        try {
            ...
            boolean booleanValue = ((Boolean) r.e.f17698c.a(sl.f10708e2)).booleanValue();
            es esVar = this.H;
            ds dsVar = this.G;
            gs gsVar = this.f9078u;
            boolean z3 = true;
                ...
                loop0: while (keys.hasNext()) {
                    ...
                    if (optJSONArray != null) {
                        ...
                        if (weakReference != null && (obj = weakReference.get()) != null) {
                            ...
                            if (((Boolean) r.e.f17698c.a(sl.f10724f2)).booleanValue() && next.equals("3010")) {
                                Object obj2 = null;
                                if (gsVar != null) {
                                    try {
                                        j10 = gsVar.j();
            ...
            HashMap y11 = y(map2);
            if (gsVar != null) {
                gsVar.V2(bVar, new b(y10), new b(y11));
                return;
            }
            if (dsVar != null) {
                b bVar2 = new b(y10);
            ...
            int i10 = a0.f19634b;
            i.g("Failed to call trackView", e);
        }
    }
    ...
    public final void c(i1 i1Var) {
        int i = a0.f19634b;
        i.f("Mute This Ad is not supported for 3rd party ads");
    }
    ...
    public final void l(View view) {
        try {
            ...
            int i = a0.f19634b;
            i.g("Failed to call untrackView", e);
        }
    }
    ...
    public final void o(View view, View view2, Map map, Map map2, boolean z3, ImageView.ScaleType scaleType, int i) {
        if (!this.E) {
            int i10 = a0.f19634b;
            i.f("Custom click reporting for 3p ads failed. enableCustomClickGesture is not set.");
        } else if (!this.A.L) {
            int i11 = a0.f19634b;
            i.f("Custom click reporting for 3p ads failed. Ad unit id not in allow list.");
        } else {
            A(view2);
        }
    }
    ...
    public final void r() {
        try {
            ...
            int i = a0.f19634b;
            i.g("Failed to report impression from an adapter", e);
        }
    }
    ...
    public final void t(View view, Map map, Map map2, ImageView.ScaleType scaleType) {
        ...
        try {
            ...
            qp0 qp0Var = this.A;
            if (!z9) {
                this.D = k.C.f16823o.d(this.f9083z, this.B.f20029u, qp0Var.C.toString(), this.C.f4583g);
            }
            if (this.F) {
                gs gsVar = this.f9078u;
            ...
            int i = a0.f19634b;
            i.g("Failed to call recordImpression", e);
        }
    }
