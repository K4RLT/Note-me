...
public final /* synthetic */ class v80 implements n80, s81, o, dr0, gr, hr, y40, so0 {
    ...
    public static boolean d(Context context) {
        if (!((Boolean) r.e.f17698c.a(sl.f10760h6)).booleanValue()) {
            int i = a0.f19634b;
            i.f("Omid flag is disabled");
            return false;
        }
    ...
    public static bi0 f(int i, int i10, WebView webView, String str, String str2, String str3) {
        if (((Boolean) r.e.f17698c.a(sl.f10760h6)).booleanValue() && ct.D.f8992v) {
            return (bi0) o(new t(i10, i, webView, str, str2, str3));
        }
        return null;
    }
    ...
    public static final Object o(zh0 zh0Var) {
        try {
            ...
            k.C.f16817h.e("omid exception", e);
            return null;
        }
    }
            ...
            case 13:
                ...
                if (a2Var != null) {
                    try {
                        ...
                        int i10 = a0.f19634b;
                        i.g("Unable to call onVideoEnd()", e8);
                        return;
                    }
                }
                return;
    ...
    public JSONObject r(Object obj) {
        ...
        if (((Boolean) r.e.f17698c.a(sl.Da)).booleanValue()) {
        ...
        jSONObject3.put("headers", p.f17688g.f17689a.k(gh0Var.f6397b));
    ...
    public /* synthetic */ Object l(Object obj) {
        ...
        a0.k("Ad request signals:");
        a0.k(jSONObject.toString(2));
        return jSONObject;
    }
}
