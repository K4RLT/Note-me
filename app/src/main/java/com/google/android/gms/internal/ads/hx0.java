...
public final class hx0 implements qa, b10, zx, s81, dr0, n80, xg0, y40, a10, i81, el0 {
    ...
    public hx0(ko koVar) {
        ...
        if (context != null) {
            try {
                ((ko) this.f6914v).h2(new b(new FrameLayout(context)));
    ...
    */
    ...
    public void e(z40 z40Var) {
        ...
        synchronized (op0Var) {
            try {
                ...
                if (((Boolean) r.e.f17698c.a(sl.f10949t4)).booleanValue()) {
    ...
    /* JADX WARN: Type inference failed for: r12v1, types: [z, java.lang.Object] */
    ...
    public Object l(Object obj) {
        ...
        switch (this.f6913u) {
            case 12:
                ...
                while (i < size) {
                    ...
                    if (map.containsKey(str) && jSONObject != null) {
                        ...
                        switch (a30Var.f4330a) {
                            case 0:
                                if (((Boolean) r.e.f17698c.a(sl.Aa)).booleanValue()) {
                            ...
                            case 1:
                                if (jSONObject.has("AvailableMemoryTier")) {
                                    ...
                                    if (bVar != null) {
                                        ((d) a30Var.f4331b).f24670d.set(bVar);
                                    }
                                }
                ...
                return wp0Var;
            default:
                rh0.k((SQLiteDatabase) obj, (l) this.f6914v);
                return null;
        }
    }
    ...
    public void mo202r(Object obj) {
        switch (this.f6913u) {
            case 11:
                ...
                int i = 1;
                if (true == k.C.f16817h.i(n30Var.f8532u)) {
                    i = 2;
                }
                n30Var.B.b(i, b10);
                return;
            ...
            default:
                wp0 wp0Var2 = (wp0) obj;
                if (((Boolean) r.e.f17698c.a(sl.O2)).booleanValue()) {
    ...
    /* JADX WARN: Type inference failed for: r4v8, types: [com.google.android.gms.internal.ads.n81, b, com.google.android.gms.internal.ads.e81] */
        ...
        if (jSONArray != null) {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                try {
                    ...
                    k.C.f16817h.d("RecursiveRtbAdapterMap.parseAdapters", new JSONException("Malformed RTB adapter config."));
                    a0.l("Malformed RTB adapter config.", e);
                }
            }
            ...
            if (!booleanValue2) {
                ...
                synchronized (ok0Var) {
                    if (TextUtils.isEmpty(k.C.f16817h.g().n().e)) {
                        a10 = d61.A;
                    } else {
    ...
    public hx0(Context context) {
        this.f6913u = 0;
        if (s.f18979x == null) {
            s.f18979x = new s(context);
        }
        this.f6914v = s.f18979x;
    }
    ...
    public /* synthetic */ void mo205l(Object obj) {
        switch (this.f6913u) {
            case 13:
                ((z60) obj).o((y1) this.f6914v);
                return;
            case 14:
                ((t70) obj).c((d3) this.f6914v);
                return;
            case 15:
                ((k80) obj).G((nk) this.f6914v);
                return;
            default:
                ((j90) obj).a((m) this.f6914v);
                return;
        }
    }
    ...
    public void mo212zza() {
        switch (this.f6913u) {
            case 7:
                ...
                sb2.append(" ms.");
                a0.k(sb2.toString());
                f0.f19676l.postDelayed(new zq((dr) arVar.f4601b, (cr) arVar.f4603d, (uq) arVar.e, arrayList, j10, 1), ((Integer) r.e.f17698c.a(sl.f10691d)).intValue());
                return;
            case 8:
                ((br) this.f6914v).e.m();
                return;
            ...
            case 22:
                ...
                b a10 = ((a8) this.f6914v).a();
                if (!((Boolean) r.e.f17698c.a(sl.D8)).booleanValue()) {
