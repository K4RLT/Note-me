...
public abstract class ul1 implements Iterator {
    ...
    public xa.a1 b() {
        xa.b1 b1Var = (xa.b1) this.f11675y;
        xa.a1 a1Var = (xa.a1) this.f11673w;
    ...
    public final boolean hasNext() {
        switch (this.f11671u) {
            case 0:
                ...
                return false;
            default:
                if (((xa.a1) this.f11673w) != ((xa.b1) this.f11675y).f30366z) {
                    return true;
                }
                return false;
        }
    ...
    public final void remove() {
        switch (this.f11671u) {
            case 0:
                ...
                return;
            default:
                xa.a1 a1Var = (xa.a1) this.f11674x;
                if (a1Var != null) {
                    xa.b1 b1Var = (xa.b1) this.f11675y;
                    b1Var.b(a1Var, true);
                    this.f11674x = null;
