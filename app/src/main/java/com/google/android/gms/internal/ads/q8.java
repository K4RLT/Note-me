            ...
            if (b11 == 1937013100) {
                ...
                while (i29 < L2) {
                    ...
                    if (L4 > spannableStringBuilder.length()) {
                        ...
                        i15 = i27;
                        f11 = f12;
                        StringBuilder sb2 = new StringBuilder(a.v(String.valueOf(length4), String.valueOf(L4).length() + 44, 2));
                    ...
                    if (L3 >= L4) {
                        StringBuilder sb3 = new StringBuilder(a.v(String.valueOf(L4), String.valueOf(L3).length() + 36, 2));
