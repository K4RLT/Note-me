...
public final class l3 {
    ...
    public l3(CharSequence charSequence, int i, Locale locale) {
        ...
        if (charSequence.length() < 0) {
            s2.a.a("input start index is outside the CharSequence");
        }
        if (i < 0 || i > charSequence.length()) {
            s2.a.a("input end index is outside the CharSequence");
        }
        BreakIterator wordInstance = BreakIterator.getWordInstance(locale);
        this.e = wordInstance;
        this.f7925b = Math.max(0, -50);
        this.f7926c = Math.min(charSequence.length(), i + 50);
        wordInstance.setText(new n2.b(charSequence, i));
    }
    ...
    public static l3 o(xk0 xk0Var) {
        ...
        try {
            ...
            throw va.a(null, "Unsupported VVC version");
        } catch (ArrayIndexOutOfBoundsException e) {
            throw va.a(e, "Error parsing VVC configuration");
        }
    }
    ...
    public void a(int i) {
        new Handler(Looper.getMainLooper()).post(new i0.d(this, i, 1));
    }
    ...
    public void b(int i) {
        ...
        if (!z3) {
            StringBuilder n10 = g3.a.n("Invalid offset: ", i, ". Valid range is [", " , ", i10);
            n10.append(i11);
            n10.append(']');
            s2.a.a(n10.toString());
        }
    ...
    public boolean e(int i) {
        int i10 = this.f7925b + 1;
        if (i <= this.f7926c && i10 <= i) {
            return ya.l1.a(Character.codePointBefore((CharSequence) this.f7927d, i));
        }
        return false;
    }
    ...
    public boolean g(int i) {
        ...
        if (!kotlin.jvm.internal.l.a(of2, unicodeBlock) || !kotlin.jvm.internal.l.a(Character.UnicodeBlock.of(charSequence.charAt(i)), Character.UnicodeBlock.KATAKANA)) {
            if (kotlin.jvm.internal.l.a(Character.UnicodeBlock.of(charSequence.charAt(i)), unicodeBlock) && kotlin.jvm.internal.l.a(Character.UnicodeBlock.of(charSequence.charAt(i10)), Character.UnicodeBlock.KATAKANA)) {
                return true;
            }
            return false;
        }
    ...
    public boolean i(int i) {
        int i10 = this.f7925b;
        if (i < this.f7926c && i10 <= i) {
            return ya.l1.a(Character.codePointAt((CharSequence) this.f7927d, i));
        }
        return false;
    }
    ...
    public void l(Typeface typeface) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && (i = this.f7925b) != -1) {
            ...
            typeface = j.f.a(typeface, i, z3);
        }
        g9.c2 c2Var = (g9.c2) this.e;
        WeakReference weakReference = (WeakReference) this.f7927d;
        if (c2Var.f17580c) {
            c2Var.f17588m = typeface;
            TextView textView = (TextView) weakReference.get();
            if (textView != null) {
                boolean z9 = q3.p.f23420a;
                boolean isAttachedToWindow = textView.isAttachedToWindow();
                int i11 = c2Var.f17578a;
                if (isAttachedToWindow) {
                    textView.post(new d6.i(i11, i10, textView, typeface));
                } else {
    ...
    public void n(String str, int i, int i10) {
        if (i > i10) {
            s2.a.a("start index must be less than or equal to end index: " + i + " > " + i10);
        }
        if (i < 0) {
            s2.a.a("start must be non-negative, but was " + i);
        }
        androidx.datastore.preferences.protobuf.i iVar = (androidx.datastore.preferences.protobuf.i) this.f7927d;
        if (iVar == null) {
    ...
    public l3(g9.c2 c2Var, int i, int i10, WeakReference weakReference) {
        this.f7924a = 6;
        this.e = c2Var;
        this.f7925b = i;
        this.f7926c = i10;
