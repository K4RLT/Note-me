...
public final class pj0 {
    ...
    public final String toString() {
        ...
        if (!TextUtils.isEmpty(str2)) {
            sb3 = p.a.o(new StringBuilder(sb3.length() + 1 + String.valueOf(str2).length()), sb3, ".", str2);
        }
        if (((Boolean) g9.r.e.f17698c.a(sl.f10788j2)).booleanValue() && (num = this.e) != null && !TextUtils.isEmpty(str2)) {
