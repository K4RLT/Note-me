                ...
                switch (((ow) x0Var.f15220f.f14961v).f14768u) {
                    case 3:
                        ...
                        if (!z3) {
                            ...
                            k5 k3 = b(sharedPreferences.getAll()).entrySet().k();
                            while (k3.hasNext()) {
                                List b10 = a("|").b((CharSequence) ((Map.Entry) k3.next()).getKey());
                                if (b10.size() >= i11) {
                    ...
                    case 4:
                        zr t10 = cs.t();
                        k5 k4 = b(((SharedPreferences) s5Var.f14961v).getAll()).entrySet().k();
                        while (k4.hasNext()) {
                    ...
                    default:
                        ps u9 = rs.u();
                        k5 k10 = b(((SharedPreferences) s5Var.f14961v).getAll()).entrySet().k();
                        while (k10.hasNext()) {
