    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        switch (this.f6805a) {
            ...
            case 2:
                ...
                return;
            case 3:
                ((ik0) this.f6806b).f7154a.execute(new a(this, 20, context));
                return;
            case 4:
            ...
            case 7:
                ...
                com.google.android.gms.internal.measurement.a();
                if (d1Var.A.F(null, v.f16436z0)) {
                    k0 k0Var4 = d1Var.C;
                    d1.d(k0Var4);
            ...
            case 8:
                context.getClass();
                intent.getClass();
                a aVar = (a) this.f6806b;
                switch (aVar.f17852g) {
                    case 0:
                        String action2 = intent.getAction();
                        if (action2 != null) {
                            q.d().a(b.f17853a, "Received ".concat(action2));
                    ...
                    case 1:
                        if (intent.getAction() != null) {
                            q.d().a(c.f17854a, "Received " + intent.getAction());
                    ...
                    default:
                        if (intent.getAction() != null) {
                            q.d().a(i.f17864a, "Received " + intent.getAction());
