        ...
        while (true) {
            ...
            if (i < xx1VarArr.length) {
                if (xx1VarArr[i].b(b10) == b10) {
                    ...
                    x.o("Unexpected child seekToUs result.");
                    return 0L;
                }
            } else {
                return b10;
        ...
        for (int i12 = 0; i12 < xx1VarArr.length; i12++) {
            ...
            while (i14 < i13) {
                ...
                while (i16 < i15) {
                    ...
                    int i17 = i11;
                    StringBuilder sb2 = new StringBuilder(str.length() + a.d(i12, 1));
                    sb2.append(i12);
                    sb2.append(":");
                    sb2.append(str);
                    ...
                    if (str2 != null) {
                        StringBuilder sb3 = new StringBuilder(a.d(i12, 1) + str2.length());
                        sb3.append(i12);
                        sb3.append(":");
                        sb3.append(str2);
                ...
                StringBuilder sb4 = new StringBuilder(a.d(i12, 1) + String.valueOf(str3).length());
                sb4.append(i12);
                sb4.append(":");
                sb4.append(str3);
    ...
    public final long i(r[] rVarArr, boolean[] zArr, sy1[] sy1VarArr, boolean[] zArr2, long j10) {
        ...
        while (i11 < xx1VarArr.length) {
            ...
            if (i13 == 0) {
                ...
                x.o("Children enabled at different positions.");
                return 0L;
            }
            boolean z3 = false;
        ...
        for (xx1 xx1Var : this.B) {
            ...
            if (v2 != -9223372036854775807L) {
                if (j10 == -9223372036854775807L) {
                    ...
                    x.o("Conflicting discontinuities.");
                    return 0L;
                }
