...
public abstract class b80 implements q2 {
            ...
            if (!file.renameTo(file2)) {
                if (!file.equals(file2)) {
                    ...
                    try {
                        ...
                        if (!file.delete()) {
                            if (!file2.delete()) {
                                x.p("Unable to delete ".concat(file2.toString()));
                                return;
                            } else {
                                x.p("Unable to delete ".concat(file.toString()));
                                return;
                            }
                        }
                        return;
                ...
                x.n(ay0.B("Source %s and destination %s must be different", file, file2));
                return;
            }
            return;
        }
    ...
    public static void D(int i, String str, boolean z3) {
        ...
        x.n(ay0.B(str, Integer.valueOf(i)));
    }
    ...
    public static void G(long j10, String str, boolean z3) {
        ...
        x.n(ay0.B(str, Long.valueOf(j10)));
    }
    ...
    public static void N(int i, int i10) {
        ...
        if (i >= 0) {
            if (i10 < 0) {
                x.n(a.f(i10, "negative size: ", new StringBuilder(String.valueOf(i10).length() + 15)));
                return;
            }
    ...
    */
    ...
    public static long r(String str) {
        try {
            ...
            if (!"0".equals(str) && !"-1".equals(str)) {
                Log.e("Volley", d("Unable to parse dateStr: %s, falling back to 0", str), e);
                return 0L;
            }
            a("Unable to parse dateStr: %s, falling back to 0", str);
            return 0L;
        }
    }
    ...
    public static void v(File file) {
        ...
        if (parentFile != null) {
            ...
            x.p("Unable to create parent directories of ".concat(file.toString()));
        }
    }
    ...
    public static byte[] x(BigInteger bigInteger, int i) {
        ...
        x.n("integer must be nonnegative");
        return null;
    }
    ...
    public static String y(String[] strArr, int i, int i10) {
        ...
        if (strArr.length < i11) {
            int i12 = a0.f19634b;
            i.c("Unable to construct shingle");
            return "";
        }
