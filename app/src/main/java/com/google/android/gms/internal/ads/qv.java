...
public final class qv extends ga.a {
    ...
    public final boolean equals(Object obj) {
        ...
        qv qvVar = (qv) obj;
        if (!fa.y.l(this.f9994u, qvVar.f9994u) || !fa.y.l(Integer.valueOf(this.f9995v), Integer.valueOf(qvVar.f9995v))) {
            return false;
        }
        return true;
    }
