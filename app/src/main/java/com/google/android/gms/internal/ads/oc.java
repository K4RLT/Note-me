...
public final class oc {
    ...
    public static int f(byte b10) {
        ...
        int i14 = iArr[5];
        int i15 = iArr[6];
        return b10 & ((iArr[7] % 837626799) ^ a5.a.w((i10 & (~i)) | i11, (i & i12) | i13, i14, i15));
    }
    ...
    public final byte b(int i) {
        ...
        if (((length - (i + 1)) | i) < 0) {
            if (i < 0) {
                StringBuilder sb2 = new StringBuilder(g3.a.d(i, 11));
                sb2.append(nc.a("Akelqh1fajntGgo="));
                sb2.append(i);
                throw new ArrayIndexOutOfBoundsException(sb2.toString());
            }
            StringBuilder sb3 = new StringBuilder(g3.a.d(length, g3.a.d(i, 18)));
            String a10 = nc.a("Akelqh1faDmxRUSK1T9GeQ==");
            String a11 = nc.a("Zwk=");
            sb3.append(a10);
            sb3.append(i);
            sb3.append(a11);
    ...
    public final String c() {
        Charset forName = Charset.forName(nc.a("Hn2H4l0="));
        byte[] bArr = this.f9089a;
    ...
    public final String toString() {
        ...
        sb2.append(nc.a("CVC1qiQNJHikW0iU1TIPZA=="));
        sb2.append(arrays);
        sb2.append(nc.a("Ng=="));
        return sb2.toString();
    }
