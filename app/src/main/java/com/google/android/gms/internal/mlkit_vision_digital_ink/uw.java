...
public final class uw implements yw {
    ...
    public ya a(Uri uri) {
        ...
        if (!equals) {
            ...
            rv rvVar = new rv(e, 4);
            int i12 = g2.f14354a;
            return lx.w(lx.w(n5.q(c10, new r0(b(), i, rvVar), executor)).y(new du(ssVar, v2, iVar, uri, 4), executor)).v(IOException.class, new sw(C, objArr == true ? 1 : 0), executor).y(new sw(C, 1), executor);
        }
        ...
        int i13 = g2.f14354a;
        return n5.q(n5.q(c11, new r0(b(), i, c1Var), executor), new r0(b(), i, new r0(this, 18, parse)), executor);
    }
    ...
    public uw(String str, String str2, String str3, String str4, w wVar, String str5, String str6, String str7, int i) {
        this.f15100b = str;
        this.f15101c = str2;
        this.f15102d = str3;
        this.e = str4;
