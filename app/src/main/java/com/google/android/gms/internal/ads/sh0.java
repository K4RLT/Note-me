...
public final class sh0 extends TimerTask {
    ...
    public final void run() {
        ...
        switch (i) {
            ...
            default:
                ...
                int i10 = b.f30913a;
                if (k.f31927d.b()) {
                    ((WebViewProviderBoundaryInterface) b.b(webView).f25315v).removeWebMessageListener("omidJsSessionService");
    ...
    public sh0(wh0 wh0Var, AlertDialog alertDialog, Timer timer, d dVar) {
