...
public final class jj {
    ...
    public jj(mf mfVar) {
        this.f7451b = gl.K();
        this.f7450a = mfVar;
        this.f7452c = ((Boolean) r.e.f17698c.a(sl.f10665b6)).booleanValue();
    }
    ...
    public final synchronized void b(int i) {
        ...
        if (((Boolean) r.e.f17698c.a(sl.f10681c6)).booleanValue()) {
            d(i);
        } else {
            c(i);
        }
    ...
    public final synchronized void c(int i) {
        ...
        a0.k("Logging Event with event code : ".concat(String.valueOf(Integer.toString(i10, 10))));
    }
    ...
    public final synchronized void d(int i) {
        ...
        try {
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        a0.k("Could not close Clearcut output stream.");
                    }
                } catch (IOException unused2) {
                    a0.k("Could not write Clearcut to file.");
                    try {
                        fileOutputStream.close();
            ...
            a0.k("Could not find file for Clearcut");
        }
    }
