...
public final class a2 implements e6 {
    ...
    public a2(g gVar, long j10) {
        ...
        l3Var.f7926c = -1;
        this.f4318z = l3Var;
        this.f4314v = p0.e(j10);
        this.f4315w = p0.d(j10);
        this.f4316x = -1;
        this.f4317y = -1;
        int e = p0.e(j10);
        int d2 = p0.d(j10);
        if (e >= 0 && e <= str.length()) {
            if (d2 >= 0 && d2 <= str.length()) {
                ...
                x.n(i1.c("Do not set reversed range: ", e, d2, " > "));
                throw null;
            }
            a.d(str.length(), a.m("end (", d2, ") offset is outside of text region "));
            throw null;
        }
        a.d(str.length(), a.m("start (", e, ") offset is outside of text region "));
        throw null;
    }
    ...
    */
    ...
    public void a(int i, int i10) {
        ...
        long a10 = db.a(g0.b(this.f4314v, this.f4315w), b10);
        i(p0.e(a10));
        h(p0.d(a10));
        int i11 = this.f4316x;
        if (i11 != -1) {
            long a11 = db.a(g0.b(i11, this.f4317y), b10);
            if (p0.b(a11)) {
                this.f4316x = -1;
                this.f4317y = -1;
            } else {
                this.f4316x = p0.e(a11);
                this.f4317y = p0.d(a11);
            }
        }
    }
    ...
    public p0 d() {
        int i = this.f4316x;
        if (i != -1) {
            return new p0(g0.b(i, this.f4317y));
        }
        return null;
    }
    ...
    public void e(String str, int i, int i10) {
        ...
        if (i >= 0 && i <= l3Var.c()) {
            if (i10 >= 0 && i10 <= l3Var.c()) {
                ...
                x.n(i1.c("Do not set reversed range: ", i, i10, " > "));
                return;
            }
            a.d(l3Var.c(), a.m("end (", i10, ") offset is outside of text region "));
            return;
        }
        a.d(l3Var.c(), a.m("start (", i, ") offset is outside of text region "));
    }
        ...
        if (i >= 0 && i <= l3Var.c()) {
            if (i10 >= 0 && i10 <= l3Var.c()) {
                if (i < i10) {
                    ...
                    x.n(i1.c("Do not set reversed or empty range: ", i, i10, " > "));
                    return;
                }
            }
            a.d(l3Var.c(), a.m("end (", i10, ") offset is outside of text region "));
    ...
    public void h(int i) {
        ...
        if (!z3) {
            a.a("Cannot set selectionEnd to a negative value: " + i);
        }
        this.f4315w = i;
    }
    ...
    public void i(int i) {
        ...
        if (!z3) {
            a.a("Cannot set selectionStart to a negative value: " + i);
        }
        this.f4314v = i;
    }
