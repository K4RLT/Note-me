...
public final class ya extends Thread {
        ...
        try {
            ...
            if (a10 == null) {
                ...
                if (z3) {
                    ...
                    Map map = a10.f12532g;
                    d h3 = gbVar.h(new eb(200, bArr, map, a(map), false));
    ...
    public final void run() {
        if (A) {
            a("start new dispatcher", new Object[0]);
        }
        ...
        while (true) {
            try {
                ...
                c("Ignoring spurious interrupt of CacheDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
}
