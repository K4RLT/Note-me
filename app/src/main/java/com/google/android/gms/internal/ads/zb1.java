    ...
    public zb1(com.google.android.gms.internal.mlkit_vision_digital_ink.o6 o6Var, int i) {
        if (o6Var != null) {
            if (i >= 0) {
                ...
                x.n(a.g(i, "invalid index: "));
                throw null;
            }
        }
        x.n("format options cannot be null");
        throw null;
    }

    public abstract q0 d(q0 q0Var, List list);

    public abstract l e(a0 a0Var, l lVar);

    public abstract int[] f(int i, int[] iArr);

    public abstract int g();

    public abstract void h(t tVar, Object obj);
