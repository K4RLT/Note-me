...
public final class lx0 implements r0, e2, b71, s81, ay, b, n80, qn, xg0, y40, el0, yo0 {
    ...
    public long d(long j10) {
        ...
        return Math.max(0L, Math.min((j10 * e) / 1000000, r0.f10462j - 1));
    }
    ...
    public void mo205l(Object obj) {
        switch (this.f8176u) {
            case 10:
                uq uqVar = (uq) obj;
                a0.k("Getting a new session for JS Engine.");
                uqVar.getClass();
    ...
    public void mo202r(Object obj) {
        ...
        switch (this.f8176u) {
            case 8:
                ...
                new u(h00Var.getContext(), h00Var.A().f20029u, str, cVar).r();
                return;
            case 13:
                ((AtomicInteger) ((b) this.f8177v).f3469c).set(1);
                return;
            case 17:
            ...
            default:
                try {
                    ...
                    int i = a0.f19634b;
                    i.c("Error executing function on offline signal database: ".concat(valueOf));
                    return;
                }
        }
    }
    ...
    public void t(Throwable th) {
        ...
        switch (i) {
            case 8:
                k.C.f16817h.d("DefaultGmsgHandlers.attributionReportingManager", th);
                return;
            case 13:
                ((AtomicInteger) ((b) obj).f3469c).set(-1);
                return;
            case 17:
                return;
            case gl.zzm /* 21 */:
                if (((Boolean) r.e.f17698c.a(sl.f10888p6)).booleanValue()) {
            ...
            case 22:
                int i10 = a0.f19634b;
                i.c("Failed to load media data due to video view load failure.");
                ((yx) obj).c(th);
                return;
            case 24:
                return;
            default:
                ...
                int i11 = a0.f19634b;
                i.c("Failed to get offline signal database: ".concat(valueOf));
                return;
        }
    }
