    ...
    public v91 c(zd1 zd1Var) {
        switch (this.f5108u) {
            case 4:
                ...
                x.n("Wrong type URL in call to Ed25519ProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var.z())));
                return null;
            case 10:
                ...
                x.n("Wrong type URL in call to RsaSsaPkcs1ProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var2.z())));
                return null;
            default:
                ...
                x.n("Wrong type URL in call to RsaSsaPssProtoSerialization.parseParameters: ".concat(String.valueOf(ih1Var3.z())));
                return null;
        }
    }
    ...
    public xy d(yd1 yd1Var) {
        ...
        switch (this.f5108u) {
            case 0:
                ...
                x.n("Wrong type URL in call to EcdsaProtoSerialization.parsePublicKey: ".concat(String.valueOf(str)));
                return null;
            case 2:
                ...
                x.n("Wrong type URL in call to EcdsaProtoSerialization.parsePrivateKey: ".concat(String.valueOf(str2)));
                return null;
            case 6:
                ...
                x.n("Wrong type URL in call to Ed25519ProtoSerialization.parsePublicKey: ".concat(String.valueOf(str3)));
                return null;
            case 8:
                ...
                x.n("Wrong type URL in call to Ed25519ProtoSerialization.parsePrivateKey: ".concat(String.valueOf(str4)));
                return null;
            case 12:
                ...
                x.n("Wrong type URL in call to RsaSsaPkcs1ProtoSerialization.parsePublicKey: ".concat(String.valueOf(str5)));
                return null;
            case 14:
                ...
                x.n("Wrong type URL in call to RsaSsaPkcs1ProtoSerialization.parsePrivateKey: ".concat(String.valueOf(str6)));
                return null;
            case 18:
                ...
                x.n("Wrong type URL in call to RsaSsaPssProtoSerialization.parsePublicKey: ".concat(String.valueOf(str7)));
                return null;
            default:
                ...
                x.n("Wrong type URL in call to RsaSsaPssProtoSerialization.parsePrivateKey: ".concat(String.valueOf(str8)));
                return null;
        }
    }
