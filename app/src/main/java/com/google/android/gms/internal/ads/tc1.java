...
public final class tc1 {
    ...
    public final ad1 b(Class cls, String str) {
        ...
        StringBuilder sb2 = new StringBuilder(a.v(valueOf, name.length() + 53, 23) + obj.length());
        a.t(sb2, "Primitive type ", name, " not supported by key manager of type ", valueOf);
        throw new GeneralSecurityException(a.k(sb2, ", which only supports: ", obj));
    }
