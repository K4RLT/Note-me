...
public final class v00 {
    ...
    public String getClickSignals(String str) {
        if (TextUtils.isEmpty(str)) {
            k9.a0.k("Click string is empty, not proceeding.");
            return "";
        }
        s00 s00Var = this.f11766b;
        of ofVar = s00Var.f10436v;
        if (ofVar == null) {
            k9.a0.k("Signal utils is empty, ignoring.");
            return "";
        }
        lf lfVar = ofVar.f9103b;
        if (lfVar == null) {
            k9.a0.k("Signals object is empty, ignoring.");
            return "";
        }
        if (s00Var.getContext() == null) {
            k9.a0.k("Context is null, ignoring.");
            return "";
        }
    ...
    public String getViewSignalsJson() {
        ...
        if (!((Boolean) g9.r.e.f17698c.a(sl.f10897pf)).booleanValue()) {
            return viewSignals;
        }
        try {
            ...
            k9.a0.l("Error constructing JSON.", e);
            return "";
        }
    }
    ...
    public void notify(String str) {
        if (TextUtils.isEmpty(str)) {
            int i = k9.a0.f19634b;
            l9.i.f("URL is empty, ignoring message");
        } else {
            k9.f0.f19676l.post(new com.google.android.gms.internal.mlkit_vision_digital_ink.ra(this, 12, str));
        }
    }
}
