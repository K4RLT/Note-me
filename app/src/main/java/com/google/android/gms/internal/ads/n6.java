...
public final class n6 implements n2 {
    ...
    public n6(o7 o7Var, int i, y51 y51Var) {
        ...
        this.H = new i3[0];
        this.I = new i3[0];
        this.f8561n = new b2.d2(new lx0(3, this));
    ...
    public static void i(xk0 xk0Var, int i, y6 y6Var) {
        ...
        if ((b10 & 1) == 0) {
            ...
            throw va.a(null, g3.a.f(h3, i10, "Senc sample count ", " is different from fragment sample count", new StringBuilder(String.valueOf(h3).length() + 58 + String.valueOf(i10).length())));
        }
        throw va.b("Overriding TrackEncryptionBox parameters is unsupported.");
    }
    ...
    public static Pair j(long j10, xk0 xk0Var) {
        ...
        while (i < L) {
            ...
            if ((Integer.MIN_VALUE & b10) == 0) {
                ...
                throw va.a(null, "Unhandled indirect reference");
            }
        }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:166:0x08f3, code lost:
        ...
        throw com.google.android.gms.internal.ads.va.b("Atom size less than header length (unsupported).");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:506:0x02c2, code lost:
        ...
        throw com.google.android.gms.internal.ads.va.a(null, "Invalid NAL length");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:591:0x06f3, code lost:
        ...
        r3.E(8);
        r5 = com.google.android.gms.internal.ads.g6.a(r3.b());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:595:0x070a, code lost:
        ...
        a5.a.t(new java.lang.StringBuilder(java.lang.String.valueOf(r5).length() + 35), "Skipping unsupported emsg version: ", r5, "FragmentedMp4Extractor");
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int h(com.google.android.gms.internal.ads.o2 r43, b0.a r44) {
        /*
            Method dump skipped, instructions count: 2828
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.n6.h(com.google.android.gms.internal.ads.o2, b0.a):int");
    }

    public final void l(a3 a3Var, b0.a aVar) {
        this.G.B(a3Var);
        this.J = true;
        aVar.f1139v = this.M;
        a();
