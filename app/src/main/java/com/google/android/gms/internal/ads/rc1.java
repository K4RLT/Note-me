        ...
        while (true) {
            ...
            if (i != 2 && i != 4 && i != 17) {
                if (f10 instanceof nl1) {
                    ...
                    if (!x21.r(str)) {
                        x.p("illegal characters in string");
                        return null;
                    }
                }
                int m10 = am1Var.m();
                ...
                if (f10 instanceof kl1) {
                    ...
                    if (!nl1Var.f8756u.containsKey(str)) {
                        ...
                        x.p("duplicate key: ".concat(String.valueOf(str)));
                        return null;
                    }
                }
                if (f11 != null) {
    ...
    public static void b(bm1 bm1Var, ll1 ll1Var) {
        ...
        if (ll1Var != null && !(ll1Var instanceof ml1)) {
                    ...
                    if (cls != Integer.class && cls != Long.class && cls != Byte.class && cls != Short.class && cls != BigDecimal.class && cls != BigInteger.class && cls != AtomicInteger.class && cls != AtomicLong.class) {
                        if (!obj.equals("-Infinity") && !obj.equals("Infinity") && !obj.equals("NaN")) {
                            if (cls != Float.class && cls != Double.class && !bm1.D.matcher(obj).matches()) {
                                ...
                                x.n(a.l(new StringBuilder(valueOf.length() + 47 + obj.length()), "String created by ", valueOf, " is not a valid JSON number: ", obj));
                                return;
                            }
                        } else if (bm1Var.B != 1) {
            ...
            if (z3) {
                ...
                x.o("Not a JSON Array: ".concat(ll1Var.toString()));
                return;
            }
            ...
            x.n("Couldn't write ".concat(String.valueOf(ll1Var.getClass())));
            return;
        }
        if (bm1Var.C != null) {
            bm1Var.k();
        ...
        if (i10 != 5) {
            if (i10 != 6) {
                ...
                if (i10 != 7) {
                    ...
                    x.o("Unexpected token: ".concat(lr1.a(i)));
                    return null;
                }
                int i13 = am1Var.A;
                if (i13 == 0) {
