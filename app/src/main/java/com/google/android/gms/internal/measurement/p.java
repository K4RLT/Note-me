...
public final class p implements n, Iterable {
    ...
    public p(String str) {
        if (str != null) {
            ...
            q.x.n("StringValue cannot be null.");
            throw null;
        }
    }
    ...
    public final n n(String str, j6.n nVar, ArrayList arrayList) {
        ...
        if ("charAt".equals(str) || "concat".equals(str) || "hasOwnProperty".equals(str) || "indexOf".equals(str) || "lastIndexOf".equals(str) || "match".equals(str) || "replace".equals(str) || "search".equals(str) || "slice".equals(str) || "split".equals(str) || "substring".equals(str) || "toLowerCase".equals(str) || "toLocaleLowerCase".equals(str) || "toString".equals(str) || "toUpperCase".equals(str) || "toLocaleUpperCase".equals(str)) {
            ...
            str3 = "trim";
            if (!str3.equals(str)) {
                q.x.n(str.concat(" is not a String function"));
                return null;
            }
        }
        char c10 = 65535;
        ...
        switch (c10) {
            case 0:
                ...
                return n.f13852m;
            case 1:
                o0.f(0, str6, arrayList);
                return this;
            case 2:
                o0.f(0, "toLocaleLowerCase", arrayList);
                return new p(str9.toLowerCase());
            case 3:
                o0.n(1, str5, arrayList);
                if (!arrayList.isEmpty()) {
                    i10 = (int) o0.a(((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).a().doubleValue());
                } else {
                    i10 = 0;
                }
            ...
            case 4:
                if (!arrayList.isEmpty()) {
                    ...
                    for (int i14 = 0; i14 < arrayList.size(); i14++) {
                        sb2.append(((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(i14)).b());
                    }
                    return new p(sb2.toString());
                }
                return this;
            case 5:
                o0.f(0, "toLowerCase", arrayList);
                return new p(str9.toLowerCase(Locale.ENGLISH));
            case 6:
                o0.n(1, "search", arrayList);
                if (!arrayList.isEmpty()) {
                    str7 = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).b();
                }
            ...
            case 7:
                o0.f(0, "toLocaleUpperCase", arrayList);
                return new p(str9.toUpperCase());
            case '\b':
                o0.n(2, "lastIndexOf", arrayList);
                if (arrayList.size() > 0) {
                    str7 = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).b();
                }
                if (arrayList.size() < 2) {
                    ...
                    doubleValue = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(1)).a().doubleValue();
                }
                if (Double.isNaN(doubleValue)) {
                    a10 = Double.POSITIVE_INFINITY;
                } else {
                    a10 = o0.a(doubleValue);
                }
                return new g(Double.valueOf(str9.lastIndexOf(str7, (int) a10)));
            case '\t':
                o0.f(0, "toUpperCase", arrayList);
                return new p(str9.toUpperCase(Locale.ENGLISH));
            case '\n':
                o0.f(0, "toUpperCase", arrayList);
                return new p(str9.trim());
            case 11:
                o0.n(1, "match", arrayList);
                if (arrayList.size() <= 0) {
                    b10 = "";
                } else {
                    b10 = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).b();
                }
                ...
                return n.i;
            case '\f':
                o0.n(2, "slice", arrayList);
                if (!arrayList.isEmpty()) {
                    d2 = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).a().doubleValue();
                } else {
                    d2 = 0.0d;
                }
                double a11 = o0.a(d2);
                ...
                int i15 = (int) min;
                if (arrayList.size() > 1) {
                    length = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(1)).a().doubleValue();
                } else {
                    length = str9.length();
                }
                double a12 = o0.a(length);
                if (a12 < 0.0d) {
            ...
            case '\r':
                ...
                if (arrayList.isEmpty()) {
                    ...
                    if (arrayList.size() > 1) {
                        j10 = o0.j(((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(1)).a().doubleValue()) & 4294967295L;
                    } else {
                        j10 = 2147483647L;
                    }
                    if (j10 == 0) {
            ...
            case 14:
                o0.n(2, "substring", arrayList);
                if (!arrayList.isEmpty()) {
                    i12 = (int) o0.a(((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).a().doubleValue());
                } else {
                    i12 = 0;
                }
                if (arrayList.size() > 1) {
                    length2 = (int) o0.a(((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(1)).a().doubleValue());
                } else {
                    length2 = str9.length();
                }
            ...
            case 15:
                o0.n(2, "replace", arrayList);
                boolean isEmpty2 = arrayList.isEmpty();
                n nVar3 = n.f13848h;
                if (!isEmpty2) {
                    str7 = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(0)).b();
                    if (arrayList.size() > 1) {
                        nVar3 = ((j6.e) nVar.f18939w).k(nVar, (n) arrayList.get(1));
                    }
                }
                ...
                return this;
            case 16:
                o0.n(2, "indexOf", arrayList);
                if (arrayList.size() <= 0) {
                    nVar2 = nVar;
                } else {
                    nVar2 = nVar;
                    str7 = ((j6.e) nVar2.f18939w).k(nVar2, (n) arrayList.get(0)).b();
                }
                if (arrayList.size() < 2) {
                    doubleValue2 = 0.0d;
                } else {
                    doubleValue2 = ((j6.e) nVar2.f18939w).k(nVar2, (n) arrayList.get(1)).a().doubleValue();
                }
                return new g(Double.valueOf(str9.indexOf(str7, (int) o0.a(doubleValue2))));
            default:
                q.x.n("Command not supported");
                return null;
        }
    }

    public final String toString() {
        return p.a.k("\"", this.f13877u, "\"");
    }
}
