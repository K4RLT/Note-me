...
public class LicenseClient implements ServiceConnection {
    ...
    protected static String licensePubKey = "";
    protected static boolean localCheckEnabled = true;
    protected static ImmediateTaskExecutor mainThreadRunner = null;
    protected static String packageName = "com.daren.scraply";
    ...
    public void handleTrialEnd() {
        ...
        if (j10 <= 0 || j11 >= MIN_TRIAL_END_INTERVAL_MILLIS) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$retryOrThrow$0(final boolean z3, LicenseCheckException licenseCheckException, boolean z9) {
        int i = this.retryNum;
        if (i < 3) {
            this.retryNum = i + 1;
    ...
    private Intent createCloseAppIntentOrExitIfAppInBackground() {
        ...
        if (gracefulShutdownEnabled) {
            ...
            intent.addFlags(DecompressedBytes.DECOMPRESSED_BYTES_INITIAL_CAPACITY);
        }
