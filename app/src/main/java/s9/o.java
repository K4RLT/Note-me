...
public final class o extends WebViewClient {
    ...
    public final wx f25091b;

    /* renamed from: c, reason: collision with root package name */
    public final Object f25092c = new Object();

    /* renamed from: d, reason: collision with root package name */
    public ScheduledFuture f25093d;
    public WebViewClient e;

    /* renamed from: f, reason: collision with root package name */
    public WebView f25094f;

    public o(WebView webView, b bVar, wx wxVar) {
        this.f25094f = webView;
        this.f25090a = bVar;
        this.f25091b = wxVar;
    }

    public static boolean y() {
        if (((Boolean) bn.f4836a.p()).booleanValue()) {
            ...
            if (allStackTraces != null && allStackTraces.containsKey(Thread.currentThread())) {
                ...
                for (StackTraceElement stackTraceElement : allStackTraces.get(Thread.currentThread())) {
                    if (stackTraceElement.getClassName().contains(o.class.getName())) {
                        if (!z3 || !z9) {
                            z3 = true;
                        }
                    } else if (z3) {
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        if (y()) {
            ...
            ScheduledFuture scheduledFuture = this.f25093d;
    ...
    public final void x() {
        synchronized (this.f25092c) {
            try {
                WebView webView = this.f25094f;
                if (webView == null) {
                    return;
                }
                webView.evaluateJavascript(String.format(Locale.getDefault(), (String) g9.e.f17698c.a(sl.f10781ib), this.f25090a.b()), null);
            } catch (Throwable th) {
                throw th;
            }
        }
