...
public abstract class k {
    ...
    public static final b f31927d;
    public static final b e;

    /* renamed from: f, reason: collision with root package name */
    public static final b f31928f;

    /* renamed from: g, reason: collision with root package name */
    public static final j f31929g;

    /* renamed from: h, reason: collision with root package name */
    public static final b f31930h;

    /* JADX WARN: Type inference failed for: r0v54, types: [z5.b, z5.j] */
    static {
        ...
        f31924a = new b("WEB_MESSAGE_ARRAY_BUFFER", "WEB_MESSAGE_ARRAY_BUFFER", 2);
        ...
        f31925b = new b("GET_WEB_VIEW_CLIENT", "GET_WEB_VIEW_CLIENT", 3);
        ...
        f31926c = new b("MULTI_PROCESS", "MULTI_PROCESS_QUERY", 2);
        new b("FORCE_DARK", "FORCE_DARK", 6);
        new b("FORCE_DARK_STRATEGY", "FORCE_DARK_BEHAVIOR", 2);
        f31927d = new b("WEB_MESSAGE_LISTENER", "WEB_MESSAGE_LISTENER", 2);
        e = new b("DOCUMENT_START_SCRIPT", "DOCUMENT_START_SCRIPT:1", 2);
        new b("PROXY_OVERRIDE_REVERSE_BYPASS", "PROXY_OVERRIDE_REVERSE_BYPASS", 2);
        f31928f = new b("GET_VARIATIONS_HEADER", "GET_VARIATIONS_HEADER", 2);
        ...
        f31929g = new b("MULTI_PROFILE", "MULTI_PROFILE", 2);
        ...
        f31930h = new b("MUTE_AUDIO", "MUTE_AUDIO", 2);
