...
public final class y extends SpannableStringBuilder {
    ...
    public y(Class cls, CharSequence charSequence) {
        ...
        m9.a(cls, "watcherClass cannot be null");
        this.f3875u = cls;
    }
    ...
    public final void a() {
        ...
        while (true) {
            ...
            if (i < arrayList.size()) {
                ((x) arrayList.get(i)).f3874v.incrementAndGet();
                i++;
            } else {
                return;
            }
    ...
    public final void e() {
        ...
        while (true) {
            ArrayList arrayList = this.f3876v;
            if (i < arrayList.size()) {
                ((x) arrayList.get(i)).f3874v.decrementAndGet();
                i++;
            } else {
                return;
            }
    ...
    public final CharSequence subSequence(int i, int i10) {
        return new y(this.f3875u, this, i, i10);
    }
    ...
    public y(Class cls, y yVar, int i, int i10) {
        super(yVar, i, i10);
        this.f3876v = new ArrayList();
        m9.a(cls, "watcherClass cannot be null");
        this.f3875u = cls;
